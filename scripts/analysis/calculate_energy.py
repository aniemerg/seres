...
Usage:
    python scripts/analysis/calculate_energy.py <simulation_name>
    python scripts/analysis/calculate_energy.py isru_advanced
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python scripts/analysis/calculate_energy.py <simulation_name>")
        print("Example: python scripts/analysis/calculate_energy.py isru_advanced")
        sys.exit(1)
