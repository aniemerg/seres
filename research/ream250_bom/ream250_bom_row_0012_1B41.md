...
how_to_make:
  ...
  source:
    ...
    evidence_basis: "independent_vendor_spec"
  assumptions:
    - "A future Manufacturing route would need optical glass/filter chemistry and certification steps, not only generic glass cutting."
  uncertainty_notes:
