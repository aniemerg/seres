...
function:
  ...
  assumptions:
    - "The BOM/CAD ISO_K_DN63 designation and annular geometry are interpreted as the flange-interface sealing and centering role for this row."
  uncertainty_notes: []
mass:
  value_kg: 0.011
...
material:
  ...
  source:
    ...
    cited_fact_or_basis: "The official Busch canonical page for legacy number 311ZRA063 identifies the product as a centering ring with outer ring, aluminum, NBR, DN 63 ISO-K."
    evidence_basis: "bom_provided"
  assumptions: []
  uncertainty_notes: []
how_to_make:
