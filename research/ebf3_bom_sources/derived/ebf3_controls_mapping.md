...
Controls leaf items mapped from V1_control_item_table; no leaf recipes yet to preserve fidelity.
...
| CTL-9 | `ebf3_process_monitor_lighting` | Lighting/illumination assembly for process monitoring inside or through the chamber. |
...
| CTL-13 | `ebf3_control_cabinet_harness` | Control cabinet wiring, shield terminations, terminal blocks, mounting hardware, and cabinet integration. |
