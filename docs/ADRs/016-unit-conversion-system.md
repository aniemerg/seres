...
**Related ADRs:** 012 (Process Types), 014 (Energy Model), 013 (Recipe Overrides)

## Context

The knowledge base uses **9 different unit types** across thousands of quantity specifications. With the new flexible rate units introduced in 012 (kg/hr, L/hr, unit/hr) and 014 (kWh/kg, MJ/unit), we need a comprehensive unit conversion system to enable:
...
- 012: Process types and time model (defines rate_unit format)
- 014: Energy model redesign (defines energy units)

## Related Decisions

- **012:** Introduced flexible rate units, this ADR enables them
- **014:** Introduced flexible energy units, this ADR enables them
- **013:** Recipe overrides can use any units, conversion validates them
- **017:** Validation system uses conversion validation rules
