...
1. **Parallel energy changes** - Energy model will follow same pattern (ADR-014)
...
- **ADR-014:** Energy model will follow same structure (type, value, unit, scaling_basis)
- **ADR-013:** Recipe override mechanics (est_time_hr → time_model overrides)
