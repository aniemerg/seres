# 018: Recipe Inputs/Outputs Validation and Tracking
...
- Consistent with 017 validation strategy
...
3. `docs/ADRs/017-validation-and-error-detection.md`
...
- `docs/ADRs/017-validation-and-error-detection.md` - Update with new validation rules
...
- **013:** Recipe Override Mechanics - Defines how recipe steps can override process definitions
- **017:** Validation and Error Detection Strategy - Defines validation framework, levels, and categories
...
- [x] 017 updated with new validation rules
