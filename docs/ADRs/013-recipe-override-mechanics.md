...
**Related ADRs:** 012 (Process Types and Time Model), 014 (Energy Model), 016 (Unit Conversion)
...
**1. Schema validation:**
- time_model override must match TimeModel schema (from 012)
- energy_model override must match EnergyModel schema (from 014)
...
- Process time_model validated per 012
- Recipe time_model override validated per 012
...
- Parallel ADRs: 012 (Time Model), 014 (Energy Model)

## Related Decisions

- **012:** Time model schema - defines what can be overridden
- **014:** Energy model schema - defines energy override structure
- **ADR-015:** Resource accounting and labor harmonization
- **016:** Unit conversion system
- **017:** Validation and error detection
