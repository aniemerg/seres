# Fix Intelligence: recipe_lh2_storage_tank_cryogenic_v0

## Files

- **Recipe:** `kb/recipes/recipe_lh2_storage_tank_cryogenic_v0.yaml`
- **Target item:** `lh2_storage_tank_cryogenic_v0`
  - File: `kb/items/lh2_storage_tank_cryogenic_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_lh2_storage_tank_cryogenic_v0.yaml`
- **BOM available:** No
