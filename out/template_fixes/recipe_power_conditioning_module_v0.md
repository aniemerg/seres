# Fix Intelligence: recipe_power_conditioning_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_conditioning_module_v0.yaml`
- **Target item:** `power_conditioning_module`
  - File: `kb/items/power_conditioning_module.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_power_conditioning_module_v0.yaml`
- **BOM available:** No
