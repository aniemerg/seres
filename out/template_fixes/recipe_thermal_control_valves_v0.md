# Fix Intelligence: recipe_thermal_control_valves_v0

## Files

- **Recipe:** `kb/recipes/recipe_thermal_control_valves_v0.yaml`
- **Target item:** `thermal_control_valves`
  - File: `kb/items/thermal_control_valves.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_thermal_control_valves_v0.yaml`
- **BOM available:** No
