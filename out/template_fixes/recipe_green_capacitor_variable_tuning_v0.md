# Fix Intelligence: recipe_green_capacitor_variable_tuning_v0

## Files

- **Recipe:** `kb/recipes/recipe_green_capacitor_variable_tuning_v0.yaml`
- **Target item:** `green_capacitor_variable_tuning_v0`
  - File: `kb/items/green_capacitor_variable_tuning_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- Step 0 produces: `green_capacitor_variable_tuning_v0` (0.1 kg)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_green_capacitor_variable_tuning_v0.yaml`
- **BOM available:** No
