# Fix Intelligence: recipe_gas_loop_piping_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_loop_piping_set_v0.yaml`
- **Target item:** `gas_loop_piping_set`
  - File: `kb/items/gas_loop_piping_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gas_loop_piping_set_v0.yaml`
- **BOM available:** No
