# Fix Intelligence: recipe_radiator_panel_v0

## Files

- **Recipe:** `kb/recipes/recipe_radiator_panel_v0.yaml`
- **Target item:** `radiator_panel`
  - File: `kb/items/radiator_panel.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_radiator_panel_v0.yaml`
- **BOM available:** No
