# Fix Intelligence: recipe_extraction_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_extraction_unit_v0.yaml`
- **Target item:** `extraction_unit`
  - File: `kb/items/extraction_unit.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_extraction_unit_v0.yaml`
- **BOM available:** No
