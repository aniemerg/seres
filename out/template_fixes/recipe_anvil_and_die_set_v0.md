# Fix Intelligence: recipe_anvil_and_die_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_anvil_and_die_set_v0.yaml`
- **Target item:** `anvil_and_die_set`
  - File: `kb/items/anvil_and_die_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_anvil_and_die_set_v0.yaml`
- **BOM available:** No
