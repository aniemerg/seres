# Fix Intelligence: recipe_busbar_distribution_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_busbar_distribution_system_v0.yaml`
- **Target item:** `busbar_distribution_system_v0`
  - File: `kb/items/busbar_distribution_system_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_busbar_distribution_system_v0.yaml`
- **BOM available:** No
