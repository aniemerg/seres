# Fix Intelligence: recipe_gear_hobbing_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_gear_hobbing_machine_v0.yaml`
- **Target item:** `gear_hobbing_machine_v0`
  - File: `kb/items/gear_hobbing_machine_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- Step 0 produces: `bulk_material_or_parts` (1.0 kg)
- Step 1 produces: `analog_test_bench_neural_circuits_v0` (1.0 unit)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gear_hobbing_machine_v0.yaml`
- **BOM available:** No
