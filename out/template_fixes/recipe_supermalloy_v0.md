# Fix Intelligence: recipe_supermalloy_v0

## Files

- **Recipe:** `kb/recipes/recipe_supermalloy_v0.yaml`
- **Target item:** `supermalloy`
  - File: `kb/items/supermalloy.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_supermalloy_v0.yaml`
- **BOM available:** No
