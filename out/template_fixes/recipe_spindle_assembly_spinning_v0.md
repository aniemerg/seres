# Fix Intelligence: recipe_spindle_assembly_spinning_v0

## Files

- **Recipe:** `kb/recipes/recipe_spindle_assembly_spinning_v0.yaml`
- **Target item:** `spindle_assembly_spinning`
  - File: `kb/items/spindle_assembly_spinning.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_spindle_assembly_spinning_v0.yaml`
- **BOM available:** No
