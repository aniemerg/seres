# Fix Intelligence: recipe_demonstrated_motor_2017_v0

## Files

- **Recipe:** `kb/recipes/recipe_demonstrated_motor_2017_v0.yaml`
- **Target item:** `demonstrated_motor_2017_v0`
  - File: `kb/items/demonstrated_motor_2017_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_demonstrated_motor_2017_v0.yaml`
- **BOM available:** No
