# Fix Intelligence: recipe_structural_frame_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_structural_frame_small_v0.yaml`
- **Target item:** `structural_frame_small_v0`
  - File: `kb/items/structural_frame_small_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_structural_frame_small_v1` → structural_frame_small (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_structural_frame_small_v0.yaml`
- **BOM available:** No
