# Fix Intelligence: recipe_silver_contact_material_v0

## Files

- **Recipe:** `kb/recipes/recipe_silver_contact_material_v0.yaml`
...
- `recipe_silver_contact_material_v1` → silver_contact_material (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_silver_contact_material_v0.yaml`
- **BOM available:** No
