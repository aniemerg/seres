# Fix Intelligence: recipe_heat_pipes_or_loop_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_pipes_or_loop_v0.yaml`
- **Target item:** `heat_pipes_or_loop`
  - File: `kb/items/heat_pipes_or_loop.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heat_pipes_or_loop_v0.yaml`
- **BOM available:** No
