# Fix Intelligence: recipe_coolant_reservoir_v0

## Files

- **Recipe:** `kb/recipes/recipe_coolant_reservoir_v0.yaml`
- **Target item:** `coolant_reservoir`
  - File: `kb/items/coolant_reservoir.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_coolant_reservoir_v0.yaml`
- **BOM available:** No
