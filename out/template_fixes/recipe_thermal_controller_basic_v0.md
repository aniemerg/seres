# Fix Intelligence: recipe_thermal_controller_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_thermal_controller_basic_v0.yaml`
- **Target item:** `thermal_controller_basic`
  - File: `kb/items/thermal_controller_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_thermal_controller_basic_v0.yaml`
- **BOM available:** No
