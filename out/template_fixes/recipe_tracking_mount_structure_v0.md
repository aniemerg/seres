# Fix Intelligence: recipe_tracking_mount_structure_v0

## Files

- **Recipe:** `kb/recipes/recipe_tracking_mount_structure_v0.yaml`
- **Target item:** `tracking_mount_structure`
  - File: `kb/items/tracking_mount_structure.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tracking_mount_structure_v0.yaml`
- **BOM available:** No
