# Fix Intelligence: recipe_steel_frame_heavy_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_frame_heavy_import_v0.yaml`
...
- `recipe_steel_frame_heavy_v0` → steel_frame_heavy (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_steel_frame_heavy_import_v0.yaml`
- **BOM available:** No
