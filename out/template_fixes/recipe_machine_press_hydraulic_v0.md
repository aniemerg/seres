# Fix Intelligence: recipe_machine_press_hydraulic_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_press_hydraulic_v0.yaml`
...
- `recipe_press_hydraulic_v1` → press_hydraulic (6 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_press_hydraulic_v0.yaml`
- **BOM available:** No
