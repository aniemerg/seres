# Fix Intelligence: recipe_kiln_basic_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_kiln_basic_import_v0.yaml`
- **Target item:** `kiln_basic`
  - File: `kb/items/kiln_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- `recipe_kiln_basic_v0` → kiln_basic (5 steps)
...
- Step 0 produces: `steel_shell_thick` (1.0 kg)
- Step 2 produces: `furnace_chamber_equipped` (1.0 unit)

---

### Error 4: recipe_template_missing_step_inputs

**Message:** Step 4 uses template process 'calibration_basic_v0' but doesn't provide step-level input overrides
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_kiln_basic_import_v0.yaml`
- **BOM available:** No
