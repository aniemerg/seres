# Fix Intelligence: recipe_quench_tank_vessel_v0

## Files

- **Recipe:** `kb/recipes/recipe_quench_tank_vessel_v0.yaml`
- **Target item:** `quench_tank_vessel`
  - File: `kb/items/quench_tank_vessel.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_machine_quench_tank_v0` → quench_tank (3 steps)
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_quench_tank_vessel_v0.yaml`
- **BOM available:** No
