# Fix Intelligence: recipe_chemical_bath_heaters_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_heaters_v0.yaml`
...
- `recipe_chemical_bath_heaters_import_v0` → chemical_bath_heaters (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_chemical_bath_heaters_v0.yaml`
- **BOM available:** No
