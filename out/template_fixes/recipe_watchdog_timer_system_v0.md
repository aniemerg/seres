# Fix Intelligence: recipe_watchdog_timer_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_watchdog_timer_system_v0.yaml`
- **Target item:** `watchdog_timer_system_v0`
  - File: `kb/items/watchdog_timer_system_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_watchdog_timer_system_v0.yaml`
- **BOM available:** No
