# Fix Intelligence: recipe_motor_electric_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_motor_electric_medium_v0.yaml`
- **Target item:** `motor_electric_medium`
  - File: `kb/items/motor_electric_medium.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_motor_electric_medium_v0.yaml`
- **BOM available:** No
