# Fix Intelligence: recipe_electrolysis_cell_unit_shell_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrolysis_cell_unit_shell_v0.yaml`
- **Target item:** `electrolysis_cell_unit_shell_v0`
  - File: `kb/items/electrolysis_cell_unit_shell_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_electrolysis_cell_unit_shell_v0.yaml`
- **BOM available:** No
