# Fix Intelligence: recipe_machine_delta_robot_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_delta_robot_v0.yaml`
- **Target item:** `delta_robot_v0`
  - File: `kb/items/delta_robot_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_machine_delta_robot_v0.yaml`
- **BOM available:** No
