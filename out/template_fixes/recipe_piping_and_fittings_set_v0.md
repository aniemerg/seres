# Fix Intelligence: recipe_piping_and_fittings_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_piping_and_fittings_set_v0.yaml`
- **Target item:** `piping_and_fittings_set`
  - File: `kb/items/piping_and_fittings_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_piping_and_fittings_set_v0.yaml`
- **BOM available:** No
