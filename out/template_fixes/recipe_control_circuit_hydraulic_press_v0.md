# Fix Intelligence: recipe_control_circuit_hydraulic_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_control_circuit_hydraulic_press_v0.yaml`
- **Target item:** `control_circuit_hydraulic_press`
  - File: `kb/items/control_circuit_hydraulic_press.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_control_circuit_hydraulic_press_v0.yaml`
- **BOM available:** No
