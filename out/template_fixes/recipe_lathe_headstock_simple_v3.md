# Fix Intelligence: recipe_lathe_headstock_simple_v3

## Files

- **Recipe:** `kb/recipes/recipe_lathe_headstock_simple_v3.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_lathe_headstock_simple_v3.yaml`
- **BOM available:** No
