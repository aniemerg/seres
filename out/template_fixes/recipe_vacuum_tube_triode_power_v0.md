# Fix Intelligence: recipe_vacuum_tube_triode_power_v0

## Files

- **Recipe:** `kb/recipes/recipe_vacuum_tube_triode_power_v0.yaml`
- **Target item:** `vacuum_tube_triode_power`
  - File: `kb/items/vacuum_tube_triode_power.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_vacuum_tube_triode_power_v0.yaml`
- **BOM available:** No
