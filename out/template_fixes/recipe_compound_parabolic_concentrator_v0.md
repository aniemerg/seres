# Fix Intelligence: recipe_compound_parabolic_concentrator_v0

## Files

- **Recipe:** `kb/recipes/recipe_compound_parabolic_concentrator_v0.yaml`
- **Target item:** `compound_parabolic_concentrator_v0`
  - File: `kb/items/compound_parabolic_concentrator_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_compound_parabolic_concentrator_v0.yaml`
- **BOM available:** No
