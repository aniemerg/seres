# Fix Intelligence: recipe_mixer_control_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_mixer_control_basic_v0.yaml`
- **Target item:** `mixer_control_basic`
  - File: `kb/items/mixer_control_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_mixer_control_basic_v0.yaml`
- **BOM available:** No
