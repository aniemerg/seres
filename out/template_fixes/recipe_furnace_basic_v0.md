# Fix Intelligence: recipe_furnace_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_furnace_basic_v0.yaml`
- **Target item:** `furnace_basic`
  - File: `kb/items/furnace_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_furnace_basic_v0.yaml`
- **BOM available:** No
