# Fix Intelligence: recipe_electrical_energy_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrical_energy_basic_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_electrical_energy_basic_v0.yaml`
- **BOM available:** No
