# Fix Intelligence: recipe_epoxy_processing_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_epoxy_processing_unit_v0.yaml`
- **Target item:** `epoxy_processing_unit`
  - File: `kb/items/epoxy_processing_unit.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_epoxy_processing_unit_v0.yaml`
- **BOM available:** No
