# Fix Intelligence: recipe_basic_fabrication_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_basic_fabrication_station_v0.yaml`
- **Target item:** `basic_fabrication_station_v0`
  - File: `kb/items/basic_fabrication_station_v0.yaml`
- **BOM:** `kb/boms/bom_basic_fabrication_station_v0.yaml` ✓
  - Components: 4
- **Steps:** 6 total
...
- `recipe_basic_fabrication_station_v1` → basic_fabrication_station (6 steps)
...
- `steel_frame_heavy` (qty: 1 unit)
- `control_panel_basic` (qty: 1 unit)
- `bearing_set_heavy` (qty: 1 unit)
- `fastener_kit_medium` (qty: 4 unit)
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_basic_fabrication_station_v0.yaml`
