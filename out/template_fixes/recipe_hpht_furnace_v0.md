# Fix Intelligence: recipe_hpht_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_hpht_furnace_v0.yaml`
- **Target item:** `hpht_furnace_v0`
  - File: `kb/items/hpht_furnace_v0.yaml`
- **BOM:** `kb/boms/bom_hpht_furnace_v0.yaml` ✓
  - Components: 9
- **Steps:** 7 total
...
- `fastener_kit_medium` (qty: 4 None)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_hpht_furnace_v0.yaml`
