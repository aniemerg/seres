# Fix Intelligence: recipe_software_source_code_v0

## Files

- **Recipe:** `kb/recipes/recipe_software_source_code_v0.yaml`
- **Target item:** `software_source_code_v0`
  - File: `kb/items/software_source_code_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_software_source_code_v0.yaml`
- **BOM available:** No
