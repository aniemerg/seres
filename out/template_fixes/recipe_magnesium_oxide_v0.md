# Fix Intelligence: recipe_magnesium_oxide_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnesium_oxide_v0.yaml`
- **Target item:** `magnesium_oxide`
  - File: `kb/items/magnesium_oxide.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_magnesium_oxide_v0.yaml`
- **BOM available:** No
