# Fix Intelligence: recipe_shape_memory_wire_sma_v0

## Files

- **Recipe:** `kb/recipes/recipe_shape_memory_wire_sma_v0.yaml`
- **Target item:** `shape_memory_wire_sma`
  - File: `kb/items/shape_memory_wire_sma.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_shape_memory_wire_sma_v0.yaml`
- **BOM available:** No
