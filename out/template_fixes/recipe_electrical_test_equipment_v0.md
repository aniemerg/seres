# Fix Intelligence: recipe_electrical_test_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrical_test_equipment_v0.yaml`
- **Target item:** `electrical_test_equipment`
  - File: `kb/items/electrical_test_equipment.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_electrical_test_equipment_v0.yaml`
- **BOM available:** No
