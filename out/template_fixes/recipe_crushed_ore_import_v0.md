# Fix Intelligence: recipe_crushed_ore_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_crushed_ore_import_v0.yaml`
...
- `recipe_crushed_ore_v0` → crushed_ore (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_crushed_ore_import_v0.yaml`
- **BOM available:** No
