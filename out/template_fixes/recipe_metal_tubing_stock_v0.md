# Fix Intelligence: recipe_metal_tubing_stock_v0

## Files

- **Recipe:** `kb/recipes/recipe_metal_tubing_stock_v0.yaml`
...
- `recipe_metal_tubing_stock_v1` → metal_tubing_stock (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_metal_tubing_stock_v0.yaml`
- **BOM available:** No
