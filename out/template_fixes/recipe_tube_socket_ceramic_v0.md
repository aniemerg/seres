# Fix Intelligence: recipe_tube_socket_ceramic_v0

## Files

- **Recipe:** `kb/recipes/recipe_tube_socket_ceramic_v0.yaml`
- **Target item:** `tube_socket_ceramic_v0`
  - File: `kb/items/tube_socket_ceramic_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_tube_socket_ceramic_v0.yaml`
- **BOM available:** No
