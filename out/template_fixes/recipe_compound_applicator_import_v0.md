# Fix Intelligence: recipe_compound_applicator_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_compound_applicator_import_v0.yaml`
...
- `recipe_compound_applicator_v0` → compound_applicator (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_compound_applicator_import_v0.yaml`
- **BOM available:** No
