# Fix Intelligence: recipe_calibration_standards_v0

## Files

- **Recipe:** `kb/recipes/recipe_calibration_standards_v0.yaml`
- **Target item:** `calibration_standards`
  - File: `kb/items/calibration_standards.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_calibration_standards_v0.yaml`
- **BOM available:** No
