# Fix Intelligence: recipe_cooling_water_jacket_v0

## Files

- **Recipe:** `kb/recipes/recipe_cooling_water_jacket_v0.yaml`
...
- `recipe_cooling_water_jacket_import_v0` → cooling_water_jacket (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cooling_water_jacket_v0.yaml`
- **BOM available:** No
