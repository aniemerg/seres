# Fix Intelligence: recipe_iron_pig_or_ingot_v0

## Files

- **Recipe:** `kb/recipes/recipe_iron_pig_or_ingot_v0.yaml`
- **Target item:** `iron_pig_or_ingot`
  - File: `kb/items/iron_pig_or_ingot.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_iron_pig_or_ingot_v0.yaml`
- **BOM available:** No
