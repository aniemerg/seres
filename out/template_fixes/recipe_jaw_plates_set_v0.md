# Fix Intelligence: recipe_jaw_plates_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_jaw_plates_set_v0.yaml`
- **Target item:** `jaw_plates_set`
  - File: `kb/items/jaw_plates_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_jaw_plates_set_v0.yaml`
- **BOM available:** No
