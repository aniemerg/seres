# Fix Intelligence: recipe_vacuum_pump_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_vacuum_pump_basic_v0.yaml`
- **Target item:** `vacuum_pump_basic`
  - File: `kb/items/vacuum_pump_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_vacuum_pump_basic_v0.yaml`
- **BOM available:** No
