# Fix Intelligence: recipe_control_circuit_motor_drive_v0

## Files

- **Recipe:** `kb/recipes/recipe_control_circuit_motor_drive_v0.yaml`
- **Target item:** `control_circuit_motor_drive`
  - File: `kb/items/control_circuit_motor_drive.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_control_circuit_motor_drive_v0.yaml`
- **BOM available:** No
