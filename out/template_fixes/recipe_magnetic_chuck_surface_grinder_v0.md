# Fix Intelligence: recipe_magnetic_chuck_surface_grinder_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnetic_chuck_surface_grinder_v0.yaml`
- **Target item:** `magnetic_chuck_surface_grinder`
  - File: `kb/items/magnetic_chuck_surface_grinder.yaml`
- **BOM:** None
- **Steps:** 5 total
...
**Message:** Step 3 uses template process 'coil_winding_basic_v0' but doesn't provide step-level input overrides
...
- Step 1 produces: `machined_part_raw` (1.0 kg)
- Step 2 produces: `finished_part_deburred` (1.0 kg)
- Step 3 produces: `motor_coil_wound` (2.0 kg)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_magnetic_chuck_surface_grinder_v0.yaml`
- **BOM available:** No
