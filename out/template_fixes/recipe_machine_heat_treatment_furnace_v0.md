# Fix Intelligence: recipe_machine_heat_treatment_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_heat_treatment_furnace_v0.yaml`
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_heat_treatment_furnace_v0.yaml`
- **BOM available:** No
