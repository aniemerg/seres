# Fix Intelligence: recipe_sensor_suite_general_v1

## Files

- **Recipe:** `kb/recipes/recipe_sensor_suite_general_v1.yaml`
- **Target item:** `sensor_suite_general`
  - File: `kb/items/sensor_suite_general.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_sensor_suite_general_v1.yaml`
- **BOM available:** No
