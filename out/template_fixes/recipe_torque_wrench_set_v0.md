# Fix Intelligence: recipe_torque_wrench_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_torque_wrench_set_v0.yaml`
- **Target item:** `torque_wrench_set`
  - File: `kb/items/torque_wrench_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- Step 2 produces: `torque_wrench_set` (1.0 unit)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_torque_wrench_set_v0.yaml`
- **BOM available:** No
