# Fix Intelligence: recipe_precision_tooling_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_precision_tooling_set_v0.yaml`
- **Target item:** `precision_tooling_set`
  - File: `kb/items/precision_tooling_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_precision_tooling_set_v0.yaml`
- **BOM available:** No
