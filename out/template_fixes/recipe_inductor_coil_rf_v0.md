# Fix Intelligence: recipe_inductor_coil_rf_v0

## Files

- **Recipe:** `kb/recipes/recipe_inductor_coil_rf_v0.yaml`
- **Target item:** `inductor_coil_rf`
  - File: `kb/items/inductor_coil_rf.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_inductor_coil_rf_v0.yaml`
- **BOM available:** No
