# Fix Intelligence: recipe_power_bus_high_current_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_bus_high_current_v0.yaml`
- **Target item:** `power_bus_high_current`
  - File: `kb/items/power_bus_high_current.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_power_bus_high_current_v0.yaml`
- **BOM available:** No
