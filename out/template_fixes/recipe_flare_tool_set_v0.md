# Fix Intelligence: recipe_flare_tool_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_flare_tool_set_v0.yaml`
- **Target item:** `flare_tool_set`
  - File: `kb/items/flare_tool_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_flare_tool_set_v0.yaml`
- **BOM available:** No
