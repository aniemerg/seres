# Fix Intelligence: recipe_circulation_pump_coolant_v0

## Files

- **Recipe:** `kb/recipes/recipe_circulation_pump_coolant_v0.yaml`
- **Target item:** `circulation_pump_coolant`
  - File: `kb/items/circulation_pump_coolant.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_circulation_pump_coolant_v0.yaml`
- **BOM available:** No
