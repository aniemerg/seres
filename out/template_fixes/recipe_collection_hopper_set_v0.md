# Fix Intelligence: recipe_collection_hopper_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_collection_hopper_set_v0.yaml`
- **Target item:** `collection_hopper_set`
  - File: `kb/items/collection_hopper_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_collection_hopper_set_v0.yaml`
- **BOM available:** No
