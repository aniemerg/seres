# Fix Intelligence: recipe_gearbox_reducer_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_gearbox_reducer_small_v0.yaml`
- **Target item:** `gearbox_reducer_small`
  - File: `kb/items/gearbox_reducer_small.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gearbox_reducer_small_v0.yaml`
- **BOM available:** No
