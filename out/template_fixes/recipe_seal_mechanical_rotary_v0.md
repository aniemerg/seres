# Fix Intelligence: recipe_seal_mechanical_rotary_v0

## Files

- **Recipe:** `kb/recipes/recipe_seal_mechanical_rotary_v0.yaml`
- **Target item:** `seal_mechanical_rotary`
  - File: `kb/items/seal_mechanical_rotary.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_seal_mechanical_rotary_v0.yaml`
- **BOM available:** No
