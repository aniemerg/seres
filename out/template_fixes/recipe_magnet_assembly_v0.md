# Fix Intelligence: recipe_magnet_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnet_assembly_v0.yaml`
- **Target item:** `magnet_assembly`
  - File: `kb/items/magnet_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_magnet_assembly_v0.yaml`
- **BOM available:** No
