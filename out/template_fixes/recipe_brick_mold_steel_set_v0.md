# Fix Intelligence: recipe_brick_mold_steel_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_brick_mold_steel_set_v0.yaml`
- **Target item:** `brick_mold_steel_set`
  - File: `kb/items/brick_mold_steel_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_brick_mold_steel_set_v0.yaml`
- **BOM available:** No
