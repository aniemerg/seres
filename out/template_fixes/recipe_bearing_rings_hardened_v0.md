# Fix Intelligence: recipe_bearing_rings_hardened_v0

## Files

- **Recipe:** `kb/recipes/recipe_bearing_rings_hardened_v0.yaml`
- **Target item:** `bearing_rings_hardened_v0`
  - File: `kb/items/bearing_rings_hardened_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- `recipe_bearing_rings_hardened_v1` → bearing_rings_hardened (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_bearing_rings_hardened_v0.yaml`
- **BOM available:** No
