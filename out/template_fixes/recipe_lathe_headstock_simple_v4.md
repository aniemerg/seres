# Fix Intelligence: recipe_lathe_headstock_simple_v4

## Files

- **Recipe:** `kb/recipes/recipe_lathe_headstock_simple_v4.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_lathe_headstock_simple_v4.yaml`
- **BOM available:** No
