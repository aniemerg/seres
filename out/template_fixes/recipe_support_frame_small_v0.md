# Fix Intelligence: recipe_support_frame_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_support_frame_small_v0.yaml`
- **Target item:** `support_frame_small`
  - File: `kb/items/support_frame_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_support_frame_small_v0.yaml`
- **BOM available:** No
