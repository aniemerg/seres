# Fix Intelligence: recipe_tension_roller_set_v1

## Files

- **Recipe:** `kb/recipes/recipe_tension_roller_set_v1.yaml`
...
- `recipe_tension_roller_set_v0` → tension_roller_set (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tension_roller_set_v1.yaml`
- **BOM available:** No
