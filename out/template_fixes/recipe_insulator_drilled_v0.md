# Fix Intelligence: recipe_insulator_drilled_v0

## Files

- **Recipe:** `kb/recipes/recipe_insulator_drilled_v0.yaml`
- **Target item:** `insulator_drilled`
  - File: `kb/items/insulator_drilled.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_insulator_drilled_v0.yaml`
- **BOM available:** No
