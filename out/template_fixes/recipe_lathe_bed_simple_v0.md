# Fix Intelligence: recipe_lathe_bed_simple_v0

## Files

- **Recipe:** `kb/recipes/recipe_lathe_bed_simple_v0.yaml`
- **Target item:** `lathe_bed_simple`
  - File: `kb/items/lathe_bed_simple.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_lathe_bed_simple_v0.yaml`
- **BOM available:** No
