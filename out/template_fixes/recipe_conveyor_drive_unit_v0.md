# Fix Intelligence: recipe_conveyor_drive_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_conveyor_drive_unit_v0.yaml`
...
- `recipe_conveyor_drive_unit_import_v0` → conveyor_drive_unit (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_conveyor_drive_unit_v0.yaml`
- **BOM available:** No
