# Fix Intelligence: recipe_workbench_frame_heavy_v0

## Files

- **Recipe:** `kb/recipes/recipe_workbench_frame_heavy_v0.yaml`
- **Target item:** `workbench_frame_heavy`
  - File: `kb/items/workbench_frame_heavy.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_workbench_frame_heavy_v0.yaml`
- **BOM available:** No
