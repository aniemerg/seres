# Fix Intelligence: recipe_uv_exposure_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_uv_exposure_unit_v0.yaml`
- **Target item:** `uv_exposure_unit`
  - File: `kb/items/uv_exposure_unit.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_uv_exposure_unit_v0.yaml`
- **BOM available:** No
