# Fix Intelligence: recipe_photodiode_selenium_v0

## Files

- **Recipe:** `kb/recipes/recipe_photodiode_selenium_v0.yaml`
- **Target item:** `photodiode_selenium_v0`
  - File: `kb/items/photodiode_selenium_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_photodiode_selenium_v0.yaml`
- **BOM available:** No
