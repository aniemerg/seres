# Fix Intelligence: recipe_pressing_mold_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_pressing_mold_set_v0.yaml`
- **Target item:** `pressing_mold_set`
  - File: `kb/items/pressing_mold_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_pressing_mold_set_v0.yaml`
- **BOM available:** No
