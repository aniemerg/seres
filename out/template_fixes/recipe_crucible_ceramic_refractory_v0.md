# Fix Intelligence: recipe_crucible_ceramic_refractory_v0

## Files

- **Recipe:** `kb/recipes/recipe_crucible_ceramic_refractory_v0.yaml`
- **Target item:** `crucible_ceramic_refractory`
  - File: `kb/items/crucible_ceramic_refractory.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_crucible_ceramic_refractory_v0.yaml`
- **BOM available:** No
