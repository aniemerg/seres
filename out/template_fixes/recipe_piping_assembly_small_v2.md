# Fix Intelligence: recipe_piping_assembly_small_v2

## Files

- **Recipe:** `kb/recipes/recipe_piping_assembly_small_v2.yaml`
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_piping_assembly_small_v2.yaml`
- **BOM available:** No
