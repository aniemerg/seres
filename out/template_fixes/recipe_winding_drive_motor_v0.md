# Fix Intelligence: recipe_winding_drive_motor_v0

## Files

- **Recipe:** `kb/recipes/recipe_winding_drive_motor_v0.yaml`
- **Target item:** `winding_drive_motor`
  - File: `kb/items/winding_drive_motor.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_winding_drive_motor_v0.yaml`
- **BOM available:** No
