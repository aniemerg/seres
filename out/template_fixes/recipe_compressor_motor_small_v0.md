# Fix Intelligence: recipe_compressor_motor_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_compressor_motor_small_v0.yaml`
...
- `recipe_compressor_motor_small_import_v0` → compressor_motor_small (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_compressor_motor_small_v0.yaml`
- **BOM available:** No
