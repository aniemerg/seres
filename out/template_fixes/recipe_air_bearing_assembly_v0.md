# Fix Intelligence: recipe_air_bearing_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_air_bearing_assembly_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_air_bearing_assembly_v0.yaml`
- **BOM available:** No
