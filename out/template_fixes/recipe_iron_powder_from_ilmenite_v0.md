# Fix Intelligence: recipe_iron_powder_from_ilmenite_v0

## Files

- **Recipe:** `kb/recipes/recipe_iron_powder_from_ilmenite_v0.yaml`
...
- `recipe_iron_powder_v0_v0` → iron_powder_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_iron_powder_from_ilmenite_v0.yaml`
- **BOM available:** No
