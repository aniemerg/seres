# Fix Intelligence: recipe_kiln_control_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_kiln_control_unit_v0.yaml`
- **Target item:** `kiln_control_unit`
  - File: `kb/items/kiln_control_unit.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_kiln_control_unit_v0.yaml`
- **BOM available:** No
