# Fix Intelligence: recipe_mixer_motor_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_mixer_motor_small_v0.yaml`
- **Target item:** `mixer_motor_small`
  - File: `kb/items/mixer_motor_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_mixer_motor_small_v0.yaml`
- **BOM available:** No
