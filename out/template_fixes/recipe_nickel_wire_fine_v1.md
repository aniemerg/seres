# Fix Intelligence: recipe_nickel_wire_fine_v1

## Files

- **Recipe:** `kb/recipes/recipe_nickel_wire_fine_v1.yaml`
...
- `recipe_nickel_wire_fine_v0` → nickel_wire_fine (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_nickel_wire_fine_v1.yaml`
- **BOM available:** No
