# Fix Intelligence: recipe_crimping_die_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_crimping_die_set_v0.yaml`
- **Target item:** `crimping_die_set`
  - File: `kb/items/crimping_die_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- Step 0 produces: `crimping_die_set` (1.0 unit)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_crimping_die_set_v0.yaml`
- **BOM available:** No
