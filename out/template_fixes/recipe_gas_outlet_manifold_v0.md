# Fix Intelligence: recipe_gas_outlet_manifold_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_outlet_manifold_v0.yaml`
- **Target item:** `gas_outlet_manifold`
  - File: `kb/items/gas_outlet_manifold.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gas_outlet_manifold_v0.yaml`
- **BOM available:** No
