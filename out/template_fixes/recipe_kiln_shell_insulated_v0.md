# Fix Intelligence: recipe_kiln_shell_insulated_v0

## Files

- **Recipe:** `kb/recipes/recipe_kiln_shell_insulated_v0.yaml`
- **Target item:** `kiln_shell_insulated`
  - File: `kb/items/kiln_shell_insulated.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_kiln_shell_insulated_v0.yaml`
- **BOM available:** No
