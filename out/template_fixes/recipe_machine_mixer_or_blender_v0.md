# Fix Intelligence: recipe_machine_mixer_or_blender_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_mixer_or_blender_v0.yaml`
- **Target item:** `mixer_or_blender`
  - File: `kb/items/mixer_or_blender.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_mixer_or_blender_v0.yaml`
- **BOM available:** No
