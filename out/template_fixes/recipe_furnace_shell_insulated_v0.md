# Fix Intelligence: recipe_furnace_shell_insulated_v0

## Files

- **Recipe:** `kb/recipes/recipe_furnace_shell_insulated_v0.yaml`
- **Target item:** `furnace_shell_insulated`
  - File: `kb/items/furnace_shell_insulated.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_furnace_shell_insulated_v0.yaml`
- **BOM available:** No
