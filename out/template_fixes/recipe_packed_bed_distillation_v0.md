# Fix Intelligence: recipe_packed_bed_distillation_v0

## Files

- **Recipe:** `kb/recipes/recipe_packed_bed_distillation_v0.yaml`
- **Target item:** `packed_bed_distillation_v0`
  - File: `kb/items/packed_bed_distillation_v0.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_packed_bed_distillation_v0.yaml`
- **BOM available:** No
