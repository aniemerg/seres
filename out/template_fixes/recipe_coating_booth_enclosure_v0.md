# Fix Intelligence: recipe_coating_booth_enclosure_v0

## Files

- **Recipe:** `kb/recipes/recipe_coating_booth_enclosure_v0.yaml`
- **Target item:** `coating_booth_enclosure`
  - File: `kb/items/coating_booth_enclosure.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_coating_booth_enclosure_v0.yaml`
- **BOM available:** No
