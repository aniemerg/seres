# Fix Intelligence: recipe_air_bearing_assembly_v1

## Files

- **Recipe:** `kb/recipes/recipe_air_bearing_assembly_v1.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_air_bearing_assembly_v1.yaml`
- **BOM available:** No
