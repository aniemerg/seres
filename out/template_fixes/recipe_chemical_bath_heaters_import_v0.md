# Fix Intelligence: recipe_chemical_bath_heaters_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_heaters_import_v0.yaml`
- **Target item:** `chemical_bath_heaters`
  - File: `kb/items/chemical_bath_heaters.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- `recipe_chemical_bath_heaters_v0` → chemical_bath_heaters (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_chemical_bath_heaters_import_v0.yaml`
- **BOM available:** No
