# Fix Intelligence: recipe_oxygen_sensor_zirconia_v0

## Files

- **Recipe:** `kb/recipes/recipe_oxygen_sensor_zirconia_v0.yaml`
- **Target item:** `oxygen_sensor_zirconia_v0`
  - File: `kb/items/oxygen_sensor_zirconia_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_oxygen_sensor_zirconia_alias_v0` → oxygen_sensor_zirconia (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_oxygen_sensor_zirconia_v0.yaml`
- **BOM available:** No
