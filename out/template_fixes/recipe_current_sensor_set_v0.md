# Fix Intelligence: recipe_current_sensor_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_current_sensor_set_v0.yaml`
- **Target item:** `current_sensor_set`
  - File: `kb/items/current_sensor_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_current_sensor_set_v0.yaml`
- **BOM available:** No
