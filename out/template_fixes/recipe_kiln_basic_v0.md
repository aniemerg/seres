# Fix Intelligence: recipe_kiln_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_kiln_basic_v0.yaml`
...
- `recipe_kiln_basic_import_v0` → kiln_basic (5 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_kiln_basic_v0.yaml`
- **BOM available:** No
