# Fix Intelligence: recipe_electrical_cabinet_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrical_cabinet_v0.yaml`
- **Target item:** `electrical_cabinet`
  - File: `kb/items/electrical_cabinet.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_electrical_cabinet_v0.yaml`
- **BOM available:** No
