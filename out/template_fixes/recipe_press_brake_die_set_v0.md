# Fix Intelligence: recipe_press_brake_die_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_brake_die_set_v0.yaml`
- **Target item:** `press_brake_die_set`
  - File: `kb/items/press_brake_die_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_press_brake_die_set_v0.yaml`
- **BOM available:** No
