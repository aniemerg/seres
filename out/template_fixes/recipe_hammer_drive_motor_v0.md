# Fix Intelligence: recipe_hammer_drive_motor_v0

## Files

- **Recipe:** `kb/recipes/recipe_hammer_drive_motor_v0.yaml`
- **Target item:** `hammer_drive_motor`
  - File: `kb/items/hammer_drive_motor.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_hammer_drive_motor_v0.yaml`
- **BOM available:** No
