# Fix Intelligence: recipe_separator_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_separator_frame_v0.yaml`
- **Target item:** `separator_frame`
  - File: `kb/items/separator_frame.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_separator_frame_v0.yaml`
- **BOM available:** No
