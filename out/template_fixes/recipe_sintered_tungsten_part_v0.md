# Fix Intelligence: recipe_sintered_tungsten_part_v0

## Files

- **Recipe:** `kb/recipes/recipe_sintered_tungsten_part_v0.yaml`
- **Target item:** `sintered_tungsten_part`
  - File: `kb/items/sintered_tungsten_part.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 0 uses template process 'pressing_operations_basic_v0' but doesn't provide step-level input overrides
...
- Step 0 produces: `pressed_component` (9.5 kg)
- Step 1 produces: `sintered_tungsten_part` (0.95 kg)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_sintered_tungsten_part_v0.yaml`
- **BOM available:** No
