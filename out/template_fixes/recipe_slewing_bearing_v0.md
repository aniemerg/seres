# Fix Intelligence: recipe_slewing_bearing_v0

## Files

- **Recipe:** `kb/recipes/recipe_slewing_bearing_v0.yaml`
...
- `recipe_slewing_bearing_import_v0` → slewing_bearing (2 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_slewing_bearing_v0.yaml`
- **BOM available:** No
