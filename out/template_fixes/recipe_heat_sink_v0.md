# Fix Intelligence: recipe_heat_sink_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_sink_v0.yaml`
...
- `recipe_heat_sink_import_v0` → heat_sink (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_heat_sink_v0.yaml`
- **BOM available:** No
