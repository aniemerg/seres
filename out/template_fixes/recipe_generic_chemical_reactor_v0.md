# Fix Intelligence: recipe_generic_chemical_reactor_v0

## Files

- **Recipe:** `kb/recipes/recipe_generic_chemical_reactor_v0.yaml`
- **Target item:** `generic_chemical_reactor_v0`
  - File: `kb/items/generic_chemical_reactor_v0.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_generic_chemical_reactor_v0.yaml`
- **BOM available:** No
