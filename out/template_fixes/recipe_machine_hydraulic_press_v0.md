# Fix Intelligence: recipe_machine_hydraulic_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_hydraulic_press_v0.yaml`
- **Target item:** `hydraulic_press`
  - File: `kb/items/hydraulic_press.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_hydraulic_press_v0` → hydraulic_press (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_hydraulic_press_v0.yaml`
- **BOM available:** No
