# Fix Intelligence: recipe_induction_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_induction_furnace_v0.yaml`
- **Target item:** `induction_furnace_v0`
  - File: `kb/items/induction_furnace_v0.yaml`
- **BOM:** `kb/boms/bom_induction_furnace_v0.yaml` ✓
  - Components: 9
- **Steps:** 7 total
...
- `furnace_shell_refractory` (qty: 1.0 None)
- `heating_element_set_high_temp` (qty: 1.0 None)
- `insulation_pack_high_temp` (qty: 1.0 None)
- `temperature_controller_basic` (qty: 1.0 None)
- `power_conditioning_module` (qty: 1.0 None)
- `cooling_loop_basic` (qty: 1.0 None)
- `power_bus_high_current` (qty: 1.0 None)
- `control_compute_module_imported` (qty: 1.0 None)
- `fastener_kit_medium` (qty: 4.0 None)
...
**Message:** Step 5 uses template process 'electrical_assembly_basic_v0' but doesn't provide step-level input overrides
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_induction_furnace_v0.yaml`
