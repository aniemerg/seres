# Fix Intelligence: recipe_anchor_installation_kit_v0

## Files

- **Recipe:** `kb/recipes/recipe_anchor_installation_kit_v0.yaml`
- **Target item:** `anchor_installation_kit`
  - File: `kb/items/anchor_installation_kit.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_anchor_installation_kit_v0.yaml`
- **BOM available:** No
