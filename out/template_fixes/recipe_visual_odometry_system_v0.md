# Fix Intelligence: recipe_visual_odometry_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_visual_odometry_system_v0.yaml`
- **Target item:** `visual_odometry_system_v0`
  - File: `kb/items/visual_odometry_system_v0.yaml`
- **BOM:** `kb/boms/bom_visual_odometry_system_v0.yaml` ✓
  - Components: 4
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_visual_odometry_system_v0.yaml`
