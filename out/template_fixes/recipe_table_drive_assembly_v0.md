# Fix Intelligence: recipe_table_drive_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_table_drive_assembly_v0.yaml`
- **Target item:** `table_drive_assembly`
  - File: `kb/items/table_drive_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_table_drive_assembly_v0.yaml`
- **BOM available:** No
