# Fix Intelligence: recipe_applicator_plunger_v0

## Files

- **Recipe:** `kb/recipes/recipe_applicator_plunger_v0.yaml`
- **Target item:** `applicator_plunger`
  - File: `kb/items/applicator_plunger.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_applicator_plunger_v0.yaml`
- **BOM available:** No
