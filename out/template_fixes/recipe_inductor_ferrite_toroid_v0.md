# Fix Intelligence: recipe_inductor_ferrite_toroid_v0

## Files

- **Recipe:** `kb/recipes/recipe_inductor_ferrite_toroid_v0.yaml`
- **Target item:** `inductor_ferrite_toroid_v0`
  - File: `kb/items/inductor_ferrite_toroid_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_inductor_ferrite_toroid_v0.yaml`
- **BOM available:** No
