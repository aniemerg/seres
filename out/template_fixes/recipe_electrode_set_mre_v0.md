# Fix Intelligence: recipe_electrode_set_mre_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrode_set_mre_v0.yaml`
- **Target item:** `electrode_set_mre`
  - File: `kb/items/electrode_set_mre.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_electrode_set_mre_v0.yaml`
- **BOM available:** No
