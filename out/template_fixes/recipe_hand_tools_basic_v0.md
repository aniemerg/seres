# Fix Intelligence: recipe_hand_tools_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_hand_tools_basic_v0.yaml`
- **Target item:** `hand_tools_basic`
  - File: `kb/items/hand_tools_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hand_tools_basic_v0.yaml`
- **BOM available:** No
