# Fix Intelligence: recipe_vibration_motor_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_vibration_motor_set_v0.yaml`
- **Target item:** `vibration_motor_set`
  - File: `kb/items/vibration_motor_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_vibration_motor_set_v0.yaml`
- **BOM available:** No
