# Fix Intelligence: recipe_concentrating_mirror_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_concentrating_mirror_set_v0.yaml`
...
- `recipe_concentrating_mirror_set_v1` → concentrating_mirror_set (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_concentrating_mirror_set_v0.yaml`
- **BOM available:** No
