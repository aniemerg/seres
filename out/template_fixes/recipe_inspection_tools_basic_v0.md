# Fix Intelligence: recipe_inspection_tools_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_inspection_tools_basic_v0.yaml`
- **Target item:** `inspection_tools_basic`
  - File: `kb/items/inspection_tools_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_inspection_tools_basic_v0.yaml`
- **BOM available:** No
