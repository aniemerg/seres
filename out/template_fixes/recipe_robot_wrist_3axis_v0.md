# Fix Intelligence: recipe_robot_wrist_3axis_v0

## Files

- **Recipe:** `kb/recipes/recipe_robot_wrist_3axis_v0.yaml`
- **Target item:** `robot_wrist_3axis`
  - File: `kb/items/robot_wrist_3axis.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_robot_wrist_3axis_v0.yaml`
- **BOM available:** No
