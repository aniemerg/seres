# Fix Intelligence: recipe_nitrile_rubber_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_nitrile_rubber_import_v0.yaml`
- **Target item:** `nitrile_rubber`
  - File: `kb/items/nitrile_rubber.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_nitrile_rubber_import_v0.yaml`
- **BOM available:** No
