# Fix Intelligence: recipe_inclinometer_pendulum_v0

## Files

- **Recipe:** `kb/recipes/recipe_inclinometer_pendulum_v0.yaml`
- **Target item:** `inclinometer_pendulum_v0`
  - File: `kb/items/inclinometer_pendulum_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_inclinometer_pendulum_v0.yaml`
- **BOM available:** No
