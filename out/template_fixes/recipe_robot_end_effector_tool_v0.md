# Fix Intelligence: recipe_robot_end_effector_tool_v0

## Files

- **Recipe:** `kb/recipes/recipe_robot_end_effector_tool_v0.yaml`
- **Target item:** `robot_end_effector_tool_v0`
  - File: `kb/items/robot_end_effector_tool_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_robot_end_effector_tool_v0.yaml`
- **BOM available:** No
