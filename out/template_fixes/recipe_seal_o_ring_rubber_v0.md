# Fix Intelligence: recipe_seal_o_ring_rubber_v0

## Files

- **Recipe:** `kb/recipes/recipe_seal_o_ring_rubber_v0.yaml`
- **Target item:** `seal_o_ring_rubber`
  - File: `kb/items/seal_o_ring_rubber.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_seal_o_ring_rubber_v0.yaml`
- **BOM available:** No
