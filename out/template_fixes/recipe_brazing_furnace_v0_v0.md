# Fix Intelligence: recipe_brazing_furnace_v0_v0

## Files

- **Recipe:** `kb/recipes/recipe_brazing_furnace_v0_v0.yaml`
- **Target item:** `brazing_furnace_v0`
  - File: `kb/items/brazing_furnace_v0.yaml`
- **BOM:** None
- **Steps:** 6 total
...
**Message:** Step 4 uses template process 'welding_brazing_basic_v0' but doesn't provide step-level input overrides
...
**Message:** Step 5 uses template process 'machining_finish_basic_v0' but doesn't provide step-level input overrides
...
- Step 2 produces: `machined_part_raw` (1.0 kg)
- Step 3 produces: `assembled_equipment` (1.0 kg)
- Step 4 produces: `welded_assemblies` (1.0 kg)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_brazing_furnace_v0_v0.yaml`
- **BOM available:** No
