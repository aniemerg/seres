# Fix Intelligence: recipe_electric_motor_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_electric_motor_medium_v0.yaml`
- **Target item:** `electric_motor_medium`
  - File: `kb/items/electric_motor_medium.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_electric_motor_medium_v0.yaml`
- **BOM available:** No
