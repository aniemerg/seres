# Fix Intelligence: recipe_steel_frame_heavy_duty_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_frame_heavy_duty_v0.yaml`
- **Target item:** `steel_frame_heavy_duty`
  - File: `kb/items/steel_frame_heavy_duty.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_steel_frame_heavy_duty_v0.yaml`
- **BOM available:** No
