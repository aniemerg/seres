# Fix Intelligence: recipe_sintered_shapes_v0

## Files

- **Recipe:** `kb/recipes/recipe_sintered_shapes_v0.yaml`
- **Target item:** `sintered_shapes`
  - File: `kb/items/sintered_shapes.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_sintered_shapes_v0.yaml`
- **BOM available:** No
