# Fix Intelligence: recipe_machine_spinning_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_spinning_machine_v0.yaml`
- **Target item:** `spinning_machine_v0`
  - File: `kb/items/spinning_machine_v0.yaml`
- **BOM:** `kb/boms/bom_spinning_machine_v0.yaml` ✓
  - Components: 9
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_spinning_machine_v0.yaml`
