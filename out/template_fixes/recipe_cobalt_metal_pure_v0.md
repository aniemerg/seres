# Fix Intelligence: recipe_cobalt_metal_pure_v0

## Files

- **Recipe:** `kb/recipes/recipe_cobalt_metal_pure_v0.yaml`
- **Target item:** `cobalt_metal_pure`
  - File: `kb/items/cobalt_metal_pure.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_cobalt_metal_pure_v0.yaml`
- **BOM available:** No
