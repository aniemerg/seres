# Fix Intelligence: recipe_tank_lid_and_basket_v0

## Files

- **Recipe:** `kb/recipes/recipe_tank_lid_and_basket_v0.yaml`
- **Target item:** `tank_lid_and_basket`
  - File: `kb/items/tank_lid_and_basket.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_tank_lid_and_basket_v0.yaml`
- **BOM available:** No
