# Fix Intelligence: recipe_coded_data_v0

## Files

- **Recipe:** `kb/recipes/recipe_coded_data_v0.yaml`
- **Target item:** `coded_data`
  - File: `kb/items/coded_data.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_coded_data_v0.yaml`
- **BOM available:** No
