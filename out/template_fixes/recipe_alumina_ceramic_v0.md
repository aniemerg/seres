# Fix Intelligence: recipe_alumina_ceramic_v0

## Files

- **Recipe:** `kb/recipes/recipe_alumina_ceramic_v0.yaml`
- **Target item:** `alumina_ceramic_v0`
  - File: `kb/items/alumina_ceramic_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_alumina_ceramic_v0.yaml`
- **BOM available:** No
