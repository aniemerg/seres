# Fix Intelligence: recipe_coolant_system_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_coolant_system_basic_v0.yaml`
- **Target item:** `coolant_system_basic`
  - File: `kb/items/coolant_system_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_coolant_system_basic_v0.yaml`
- **BOM available:** No
