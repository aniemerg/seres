# Fix Intelligence: recipe_encapsulation_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_encapsulation_station_v0.yaml`
- **Target item:** `encapsulation_station`
  - File: `kb/items/encapsulation_station.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_encapsulation_station_v0.yaml`
- **BOM available:** No
