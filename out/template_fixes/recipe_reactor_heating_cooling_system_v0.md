# Fix Intelligence: recipe_reactor_heating_cooling_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_reactor_heating_cooling_system_v0.yaml`
- **Target item:** `reactor_heating_cooling_system_v0`
  - File: `kb/items/reactor_heating_cooling_system_v0.yaml`
- **BOM:** `kb/boms/bom_reactor_heating_cooling_system_v0.yaml` ✓
  - Components: 3
- **Steps:** 7 total
...
- `heating_plate_or_induction_heater` (qty: 1.0 None)
- `cryocooler_active_v0` (qty: 1.0 None)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_reactor_heating_cooling_system_v0.yaml`
