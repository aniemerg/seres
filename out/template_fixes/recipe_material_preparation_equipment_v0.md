# Fix Intelligence: recipe_material_preparation_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_material_preparation_equipment_v0.yaml`
- **Target item:** `material_preparation_equipment`
  - File: `kb/items/material_preparation_equipment.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_material_preparation_equipment_v0.yaml`
- **BOM available:** No
