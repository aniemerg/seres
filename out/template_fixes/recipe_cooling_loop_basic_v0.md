# Fix Intelligence: recipe_cooling_loop_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_cooling_loop_basic_v0.yaml`
- **Target item:** `cooling_loop_basic`
  - File: `kb/items/cooling_loop_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cooling_loop_basic_v0.yaml`
- **BOM available:** No
