# Fix Intelligence: recipe_spring_and_dampener_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_spring_and_dampener_set_v0.yaml`
- **Target item:** `spring_and_dampener_set`
  - File: `kb/items/spring_and_dampener_set.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_spring_and_dampener_set_v0.yaml`
- **BOM available:** No
