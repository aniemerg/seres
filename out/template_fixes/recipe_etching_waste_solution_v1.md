# Fix Intelligence: recipe_etching_waste_solution_v1

## Files

- **Recipe:** `kb/recipes/recipe_etching_waste_solution_v1.yaml`
...
- `recipe_etching_waste_solution_v3` → etching_waste_solution (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_etching_waste_solution_v1.yaml`
- **BOM available:** No
