# Fix Intelligence: recipe_balancing_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_balancing_machine_v0.yaml`
- **Target item:** `balancing_machine`
  - File: `kb/items/balancing_machine.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_balancing_machine_v0.yaml`
- **BOM available:** No
