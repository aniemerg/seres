# Fix Intelligence: recipe_battery_pack_large_nife_v0

## Files

- **Recipe:** `kb/recipes/recipe_battery_pack_large_nife_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_battery_pack_large_nife_v0.yaml`
- **BOM available:** No
