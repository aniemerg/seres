# Fix Intelligence: recipe_shaft_set_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_shaft_set_medium_v0.yaml`
- **Target item:** `shaft_set_medium`
  - File: `kb/items/shaft_set_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_shaft_set_medium_v0.yaml`
- **BOM available:** No
