# Fix Intelligence: recipe_air_ducting_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_air_ducting_system_v0.yaml`
- **Target item:** `air_ducting_system`
  - File: `kb/items/air_ducting_system.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_air_ducting_system_v0.yaml`
- **BOM available:** No
