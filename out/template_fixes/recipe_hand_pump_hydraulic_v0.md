# Fix Intelligence: recipe_hand_pump_hydraulic_v0

## Files

- **Recipe:** `kb/recipes/recipe_hand_pump_hydraulic_v0.yaml`
- **Target item:** `hand_pump_hydraulic`
  - File: `kb/items/hand_pump_hydraulic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hand_pump_hydraulic_v0.yaml`
- **BOM available:** No
