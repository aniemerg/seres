# Fix Intelligence: recipe_piping_and_valves_set_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_piping_and_valves_set_import_v0.yaml`
...
- `recipe_piping_and_valves_set_v0` → piping_and_valves_set (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_piping_and_valves_set_import_v0.yaml`
- **BOM available:** No
