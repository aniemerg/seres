# Fix Intelligence: recipe_inert_gas_manifold_v0

## Files

- **Recipe:** `kb/recipes/recipe_inert_gas_manifold_v0.yaml`
- **Target item:** `inert_gas_manifold`
  - File: `kb/items/inert_gas_manifold.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 3 (process 'leak_testing_v0') requires input 'welded_assemblies' which is not available
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_inert_gas_manifold_v0.yaml`
- **BOM available:** No
