# Fix Intelligence: recipe_electron_gun_assembly_v0_alt

## Files

- **Recipe:** `kb/recipes/recipe_electron_gun_assembly_v0_alt.yaml`
- **Target item:** `electron_gun_assembly_v0`
  - File: `kb/items/electron_gun_assembly_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_electron_gun_assembly_v0` → electron_gun_assembly (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_electron_gun_assembly_v0_alt.yaml`
- **BOM available:** No
