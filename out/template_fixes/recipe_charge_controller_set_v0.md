# Fix Intelligence: recipe_charge_controller_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_charge_controller_set_v0.yaml`
...
- `recipe_charge_controller_set_import_v0` → charge_controller_set (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_charge_controller_set_v0.yaml`
- **BOM available:** No
