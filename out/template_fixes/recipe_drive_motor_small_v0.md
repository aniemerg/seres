# Fix Intelligence: recipe_drive_motor_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_drive_motor_small_v0.yaml`
- **Target item:** `drive_motor_small`
  - File: `kb/items/drive_motor_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_drive_motor_small_v0.yaml`
- **BOM available:** No
