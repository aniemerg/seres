# Fix Intelligence: recipe_chemical_reactor_unit_v1_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_reactor_unit_v1_v0.yaml`
- **Target item:** `chemical_reactor_unit_v1_v0`
  - File: `kb/items/chemical_reactor_unit_v1_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_reactor_unit_v1_v0.yaml`
- **BOM available:** No
