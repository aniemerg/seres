# Fix Intelligence: recipe_loom_or_knitting_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_loom_or_knitting_machine_v0.yaml`
- **Target item:** `loom_or_knitting_machine`
  - File: `kb/items/loom_or_knitting_machine.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_loom_or_knitting_machine_v0.yaml`
- **BOM available:** No
