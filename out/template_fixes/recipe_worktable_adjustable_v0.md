# Fix Intelligence: recipe_worktable_adjustable_v0

## Files

- **Recipe:** `kb/recipes/recipe_worktable_adjustable_v0.yaml`
- **Target item:** `worktable_adjustable`
  - File: `kb/items/worktable_adjustable.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_worktable_adjustable_v0.yaml`
- **BOM available:** No
