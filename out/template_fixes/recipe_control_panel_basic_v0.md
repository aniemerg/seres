# Fix Intelligence: recipe_control_panel_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_control_panel_basic_v0.yaml`
- **Target item:** `control_panel_basic_v0`
  - File: `kb/items/control_panel_basic_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- `recipe_control_panel_basic_additive_v0` → control_panel_basic (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_control_panel_basic_v0.yaml`
- **BOM available:** No
