# Fix Intelligence: recipe_oxygen_sensor_module_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_oxygen_sensor_module_import_v0.yaml`
...
- `recipe_oxygen_sensor_module_v0` → oxygen_sensor_module (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_oxygen_sensor_module_import_v0.yaml`
- **BOM available:** No
