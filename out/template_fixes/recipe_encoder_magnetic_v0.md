# Fix Intelligence: recipe_encoder_magnetic_v0

## Files

- **Recipe:** `kb/recipes/recipe_encoder_magnetic_v0.yaml`
- **Target item:** `encoder_magnetic_v0`
  - File: `kb/items/encoder_magnetic_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_encoder_magnetic_v0.yaml`
- **BOM available:** No
