# Fix Intelligence: recipe_bare_pcb_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_bare_pcb_import_v0.yaml`
- **Target item:** `bare_pcb`
  - File: `kb/items/bare_pcb.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_bare_pcb_import_v0.yaml`
- **BOM available:** No
