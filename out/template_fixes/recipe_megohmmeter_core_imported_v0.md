# Fix Intelligence: recipe_megohmmeter_core_imported_v0

## Files

- **Recipe:** `kb/recipes/recipe_megohmmeter_core_imported_v0.yaml`
- **Target item:** `megohmmeter_core_imported`
  - File: `kb/items/megohmmeter_core_imported.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_megohmmeter_core_imported_v0.yaml`
- **BOM available:** No
