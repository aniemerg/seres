# Fix Intelligence: recipe_press_frame_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_frame_small_v0.yaml`
- **Target item:** `press_frame_small`
  - File: `kb/items/press_frame_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_press_frame_small_v0.yaml`
- **BOM available:** No
