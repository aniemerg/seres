# Fix Intelligence: recipe_drawing_die_set_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_drawing_die_set_basic_v0.yaml`
- **Target item:** `drawing_die_set_basic`
  - File: `kb/items/drawing_die_set_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_drawing_die_set_basic_v0.yaml`
- **BOM available:** No
