# Fix Intelligence: recipe_milling_table_v0

## Files

- **Recipe:** `kb/recipes/recipe_milling_table_v0.yaml`
- **Target item:** `milling_table`
  - File: `kb/items/milling_table.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_milling_table_v0.yaml`
- **BOM available:** No
