# Fix Intelligence: recipe_chamber_shell_sealed_v0

## Files

- **Recipe:** `kb/recipes/recipe_chamber_shell_sealed_v0.yaml`
- **Target item:** `chamber_shell_sealed`
  - File: `kb/items/chamber_shell_sealed.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_chamber_shell_sealed_v0.yaml`
- **BOM available:** No
