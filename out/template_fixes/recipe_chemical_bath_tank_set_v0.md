# Fix Intelligence: recipe_chemical_bath_tank_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_tank_set_v0.yaml`
...
- `recipe_chemical_bath_tank_set_v1` → chemical_bath_tank_set (2 steps)
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_chemical_bath_tank_set_v0.yaml`
- **BOM available:** No
