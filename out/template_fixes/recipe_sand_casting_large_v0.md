# Fix Intelligence: recipe_sand_casting_large_v0

## Files

- **Recipe:** `kb/recipes/recipe_sand_casting_large_v0.yaml`
- **Target item:** `sand_casting_large_v0`
  - File: `kb/items/sand_casting_large_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_sand_casting_large_v0.yaml`
- **BOM available:** No
