# Fix Intelligence: recipe_amari_neural_field_hardware_v0

## Files

- **Recipe:** `kb/recipes/recipe_amari_neural_field_hardware_v0.yaml`
- **Target item:** `amari_neural_field_hardware_v0`
  - File: `kb/items/amari_neural_field_hardware_v0.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_amari_neural_field_hardware_v0.yaml`
- **BOM available:** No
