# Fix Intelligence: recipe_forming_mold_or_applicator_head_v0

## Files

- **Recipe:** `kb/recipes/recipe_forming_mold_or_applicator_head_v0.yaml`
- **Target item:** `forming_mold_or_applicator_head_v0`
  - File: `kb/items/forming_mold_or_applicator_head_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_forming_mold_or_applicator_head_v0.yaml`
- **BOM available:** No
