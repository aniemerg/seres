# Fix Intelligence: recipe_air_lock_chamber_v0

## Files

- **Recipe:** `kb/recipes/recipe_air_lock_chamber_v0.yaml`
- **Target item:** `air_lock_chamber`
  - File: `kb/items/air_lock_chamber.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_air_lock_chamber_v0.yaml`
- **BOM available:** No
