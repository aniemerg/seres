# Fix Intelligence: recipe_alignment_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_alignment_tools_v0.yaml`
- **Target item:** `alignment_tools`
  - File: `kb/items/alignment_tools.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_alignment_tools_v0.yaml`
- **BOM available:** No
