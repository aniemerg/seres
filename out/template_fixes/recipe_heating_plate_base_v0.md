# Fix Intelligence: recipe_heating_plate_base_v0

## Files

- **Recipe:** `kb/recipes/recipe_heating_plate_base_v0.yaml`
- **Target item:** `heating_plate_base`
  - File: `kb/items/heating_plate_base.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_heating_plate_base_v0.yaml`
- **BOM available:** No
