# Fix Intelligence: recipe_printer_control_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_printer_control_module_v0.yaml`
- **Target item:** `printer_control_module`
  - File: `kb/items/printer_control_module.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_printer_control_module_v0.yaml`
- **BOM available:** No
