# Fix Intelligence: recipe_battery_pack_large_nife_v0_alias_v0

## Files

- **Recipe:** `kb/recipes/recipe_battery_pack_large_nife_v0_alias_v0.yaml`
- **Target item:** `battery_pack_large_nife_v0`
  - File: `kb/items/battery_pack_large_nife_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- `recipe_battery_pack_large_nife_import_v0` → battery_pack_large_nife (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_battery_pack_large_nife_v0_alias_v0.yaml`
- **BOM available:** No
