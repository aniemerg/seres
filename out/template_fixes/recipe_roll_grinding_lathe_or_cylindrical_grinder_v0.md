# Fix Intelligence: recipe_roll_grinding_lathe_or_cylindrical_grinder_v0

## Files

- **Recipe:** `kb/recipes/recipe_roll_grinding_lathe_or_cylindrical_grinder_v0.yaml`
- **Target item:** `roll_grinding_lathe_or_cylindrical_grinder_v0`
  - File: `kb/items/roll_grinding_lathe_or_cylindrical_grinder_v0.yaml`
- **BOM:** `kb/boms/bom_roll_grinding_lathe_or_cylindrical_grinder_v0.yaml` ✓
  - Components: 8
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_roll_grinding_lathe_or_cylindrical_grinder_v0.yaml`
