# Fix Intelligence: recipe_wire_copper_insulated_v1

## Files

- **Recipe:** `kb/recipes/recipe_wire_copper_insulated_v1.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_wire_copper_insulated_v1.yaml`
- **BOM available:** No
