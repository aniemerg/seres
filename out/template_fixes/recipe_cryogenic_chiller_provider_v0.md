# Fix Intelligence: recipe_cryogenic_chiller_provider_v0

## Files

- **Recipe:** `kb/recipes/recipe_cryogenic_chiller_provider_v0.yaml`
- **Target item:** `cryogenic_chiller_provider_v0`
  - File: `kb/items/cryogenic_chiller_provider_v0.yaml`
- **BOM:** `kb/boms/bom_cryogenic_chiller_provider_v0.yaml` ✓
  - Components: 1
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_cryogenic_chiller_provider_v0.yaml`
