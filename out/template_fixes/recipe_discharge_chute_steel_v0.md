# Fix Intelligence: recipe_discharge_chute_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_discharge_chute_steel_v0.yaml`
- **Target item:** `discharge_chute_steel`
  - File: `kb/items/discharge_chute_steel.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_discharge_chute_steel_v0.yaml`
- **BOM available:** No
