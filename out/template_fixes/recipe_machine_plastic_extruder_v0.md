# Fix Intelligence: recipe_machine_plastic_extruder_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_plastic_extruder_v0.yaml`
- **Target item:** `plastic_extruder`
  - File: `kb/items/plastic_extruder.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- `recipe_plastic_extruder_v0` → plastic_extruder_v0 (6 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_machine_plastic_extruder_v0.yaml`
- **BOM available:** No
