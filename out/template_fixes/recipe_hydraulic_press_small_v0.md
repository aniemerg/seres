# Fix Intelligence: recipe_hydraulic_press_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_press_small_v0.yaml`
- **Target item:** `hydraulic_press_small`
  - File: `kb/items/hydraulic_press_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hydraulic_press_small_v0.yaml`
- **BOM available:** No
