# Fix Intelligence: recipe_converter_housing_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_converter_housing_assembly_v0.yaml`
- **Target item:** `converter_housing_assembly`
  - File: `kb/items/converter_housing_assembly.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_converter_housing_assembly_v0.yaml`
- **BOM available:** No
