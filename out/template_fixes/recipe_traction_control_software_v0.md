# Fix Intelligence: recipe_traction_control_software_v0

## Files

- **Recipe:** `kb/recipes/recipe_traction_control_software_v0.yaml`
- **Target item:** `traction_control_software`
  - File: `kb/items/traction_control_software.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_traction_control_software_v0.yaml`
- **BOM available:** No
