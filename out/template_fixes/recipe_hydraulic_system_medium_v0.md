# Fix Intelligence: recipe_hydraulic_system_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_system_medium_v0.yaml`
- **Target item:** `hydraulic_system_medium`
  - File: `kb/items/hydraulic_system_medium.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hydraulic_system_medium_v0.yaml`
- **BOM available:** No
