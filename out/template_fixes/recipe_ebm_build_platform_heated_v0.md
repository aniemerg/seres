# Fix Intelligence: recipe_ebm_build_platform_heated_v0

## Files

- **Recipe:** `kb/recipes/recipe_ebm_build_platform_heated_v0.yaml`
- **Target item:** `ebm_build_platform_heated_v0`
  - File: `kb/items/ebm_build_platform_heated_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_ebm_build_platform_heated_v0.yaml`
- **BOM available:** No
