# Fix Intelligence: recipe_assembly_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_assembly_station_v0.yaml`
- **Target item:** `assembly_station`
  - File: `kb/items/assembly_station.yaml`
- **BOM:** `kb/boms/bom_assembly_station.yaml` ✓
  - Components: 6
- **Steps:** 3 total
...
- `recipe_machine_assembly_station_v0` → assembly_station_v0 (3 steps)
...
- `tool_station_frame` (qty: 1.0 None)
- `tool_set_general` (qty: 1.0 None)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_assembly_station_v0.yaml`
