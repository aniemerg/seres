# Fix Intelligence: recipe_machine_frame_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_frame_medium_v0.yaml`
- **Target item:** `machine_frame_medium`
  - File: `kb/items/machine_frame_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_machine_frame_medium_v0.yaml`
- **BOM available:** No
