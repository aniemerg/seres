# Fix Intelligence: recipe_sand_casting_flask_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_sand_casting_flask_set_v0.yaml`
- **Target item:** `sand_casting_flask_set`
  - File: `kb/items/sand_casting_flask_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_sand_casting_flask_set_v0.yaml`
- **BOM available:** No
