# Fix Intelligence: recipe_molding_press_unversioned_v0

## Files

- **Recipe:** `kb/recipes/recipe_molding_press_unversioned_v0.yaml`
- **Target item:** `molding_press`
  - File: `kb/items/molding_press.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_molding_press_unversioned_v0.yaml`
- **BOM available:** No
