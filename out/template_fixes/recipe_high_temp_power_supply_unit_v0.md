# Fix Intelligence: recipe_high_temp_power_supply_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_high_temp_power_supply_unit_v0.yaml`
- **Target item:** `high_temp_power_supply_unit`
  - File: `kb/items/high_temp_power_supply_unit.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_high_temp_power_supply_unit_v0.yaml`
- **BOM available:** No
