# Fix Intelligence: recipe_screen_deck_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_screen_deck_basic_v0.yaml`
- **Target item:** `screen_deck_basic`
  - File: `kb/items/screen_deck_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_screen_deck_basic_v0.yaml`
- **BOM available:** No
