# Fix Intelligence: recipe_nickel_anode_plate_v0

## Files

- **Recipe:** `kb/recipes/recipe_nickel_anode_plate_v0.yaml`
- **Target item:** `nickel_anode_plate`
  - File: `kb/items/nickel_anode_plate.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_nickel_anode_plate_v0.yaml`
- **BOM available:** No
