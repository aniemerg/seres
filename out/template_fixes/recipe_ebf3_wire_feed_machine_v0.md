# Fix Intelligence: recipe_ebf3_wire_feed_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_ebf3_wire_feed_machine_v0.yaml`
- **Target item:** `ebf3_wire_feed_machine_v0`
  - File: `kb/items/ebf3_wire_feed_machine_v0.yaml`
- **BOM:** `kb/boms/bom_ebf3_wire_feed_machine_v0.yaml` ✓
  - Components: 6
- **Steps:** 6 total
...
- `electron_gun_assembly` (qty: 1 None)
- `wire_feed_system_basic` (qty: 1 None)
- `control_panel_basic` (qty: 1 None)
- `power_output_terminals` (qty: 1 None)
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_ebf3_wire_feed_machine_v0.yaml`
