# Fix Intelligence: recipe_cyclone_separator_body_v0

## Files

- **Recipe:** `kb/recipes/recipe_cyclone_separator_body_v0.yaml`
- **Target item:** `cyclone_separator_body`
  - File: `kb/items/cyclone_separator_body.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cyclone_separator_body_v0.yaml`
- **BOM available:** No
