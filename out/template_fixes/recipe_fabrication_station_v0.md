# Fix Intelligence: recipe_fabrication_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_fabrication_station_v0.yaml`
- **Target item:** `fabrication_station`
  - File: `kb/items/fabrication_station.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_fabrication_station_v0.yaml`
- **BOM available:** No
