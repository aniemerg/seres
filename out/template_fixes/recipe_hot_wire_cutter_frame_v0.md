# Fix Intelligence: recipe_hot_wire_cutter_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_hot_wire_cutter_frame_v0.yaml`
- **Target item:** `hot_wire_cutter_frame`
  - File: `kb/items/hot_wire_cutter_frame.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hot_wire_cutter_frame_v0.yaml`
- **BOM available:** No
