# Fix Intelligence: recipe_protective_cover_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_protective_cover_set_v0.yaml`
- **Target item:** `protective_cover_set`
  - File: `kb/items/protective_cover_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 1 (process 'sheet_metal_forming_v0') requires input 'steel_plate_or_sheet' which is not available
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_protective_cover_set_v0.yaml`
- **BOM available:** No
