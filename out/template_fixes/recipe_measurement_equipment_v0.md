# Fix Intelligence: recipe_measurement_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_measurement_equipment_v0.yaml`
- **Target item:** `measurement_equipment`
  - File: `kb/items/measurement_equipment.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_measurement_equipment_v0.yaml`
- **BOM available:** No
