# Fix Intelligence: recipe_3d_printed_motor_ironpla_v0

## Files

- **Recipe:** `kb/recipes/recipe_3d_printed_motor_ironpla_v0.yaml`
...
- `recipe_3d_print_motor_ironpla_v0` → 3d_printed_motor_ironpla_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_3d_printed_motor_ironpla_v0.yaml`
- **BOM available:** No
