# Fix Intelligence: recipe_press_platen_set_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_platen_set_small_v0.yaml`
- **Target item:** `press_platen_set_small`
  - File: `kb/items/press_platen_set_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_press_platen_set_small_v0.yaml`
- **BOM available:** No
