# Fix Intelligence: recipe_refractory_installation_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_refractory_installation_tools_v0.yaml`
- **Target item:** `refractory_installation_tools`
  - File: `kb/items/refractory_installation_tools.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_refractory_installation_tools_v0.yaml`
- **BOM available:** No
