# Fix Intelligence: recipe_battery_cell_casing_metal_v0

## Files

- **Recipe:** `kb/recipes/recipe_battery_cell_casing_metal_v0.yaml`
- **Target item:** `battery_cell_casing_metal`
  - File: `kb/items/battery_cell_casing_metal.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_battery_cell_casing_metal_v0.yaml`
- **BOM available:** No
