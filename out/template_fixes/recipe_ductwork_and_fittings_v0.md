# Fix Intelligence: recipe_ductwork_and_fittings_v0

## Files

- **Recipe:** `kb/recipes/recipe_ductwork_and_fittings_v0.yaml`
- **Target item:** `ductwork_and_fittings`
  - File: `kb/items/ductwork_and_fittings.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_ductwork_and_fittings_v0.yaml`
- **BOM available:** No
