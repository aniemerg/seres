# Fix Intelligence: recipe_sulfur_elemental_v0

## Files

- **Recipe:** `kb/recipes/recipe_sulfur_elemental_v0.yaml`
- **Target item:** `sulfur_elemental`
  - File: `kb/items/sulfur_elemental.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_sulfur_elemental_v0.yaml`
- **BOM available:** No
