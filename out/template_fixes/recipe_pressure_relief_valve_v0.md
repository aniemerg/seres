# Fix Intelligence: recipe_pressure_relief_valve_v0

## Files

- **Recipe:** `kb/recipes/recipe_pressure_relief_valve_v0.yaml`
- **Target item:** `pressure_relief_valve`
  - File: `kb/items/pressure_relief_valve.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_pressure_relief_valve_v0.yaml`
- **BOM available:** No
