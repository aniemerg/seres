# Fix Intelligence: recipe_press_platen_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_platen_steel_v0.yaml`
- **Target item:** `press_platen_steel`
  - File: `kb/items/press_platen_steel.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_press_platen_steel_v0.yaml`
- **BOM available:** No
