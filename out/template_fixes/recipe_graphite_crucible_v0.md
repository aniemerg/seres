# Fix Intelligence: recipe_graphite_crucible_v0

## Files

- **Recipe:** `kb/recipes/recipe_graphite_crucible_v0.yaml`
- **Target item:** `graphite_crucible_v0`
  - File: `kb/items/graphite_crucible_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_graphite_crucible_v0.yaml`
- **BOM available:** No
