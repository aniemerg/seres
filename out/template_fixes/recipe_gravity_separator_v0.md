# Fix Intelligence: recipe_gravity_separator_v0

## Files

- **Recipe:** `kb/recipes/recipe_gravity_separator_v0.yaml`
- **Target item:** `gravity_separator`
  - File: `kb/items/gravity_separator.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gravity_separator_v0.yaml`
- **BOM available:** No
