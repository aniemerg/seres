# Fix Intelligence: recipe_storage_enclosure_v0

## Files

- **Recipe:** `kb/recipes/recipe_storage_enclosure_v0.yaml`
- **Target item:** `storage_enclosure`
  - File: `kb/items/storage_enclosure.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_storage_enclosure_v0.yaml`
- **BOM available:** No
