# Fix Intelligence: recipe_formation_power_modules_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_formation_power_modules_import_v0.yaml`
...
- `recipe_formation_power_modules_v0` → formation_power_modules (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_formation_power_modules_import_v0.yaml`
- **BOM available:** No
