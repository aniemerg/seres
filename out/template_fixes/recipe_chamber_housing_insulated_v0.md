# Fix Intelligence: recipe_chamber_housing_insulated_v0

## Files

- **Recipe:** `kb/recipes/recipe_chamber_housing_insulated_v0.yaml`
- **Target item:** `chamber_housing_insulated`
  - File: `kb/items/chamber_housing_insulated.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chamber_housing_insulated_v0.yaml`
- **BOM available:** No
