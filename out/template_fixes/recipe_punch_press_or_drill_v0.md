# Fix Intelligence: recipe_punch_press_or_drill_v0

## Files

- **Recipe:** `kb/recipes/recipe_punch_press_or_drill_v0.yaml`
- **Target item:** `punch_press_or_drill`
  - File: `kb/items/punch_press_or_drill.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_punch_press_or_drill_v0.yaml`
- **BOM available:** No
