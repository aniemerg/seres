# Fix Intelligence: recipe_atomization_unit_v0_v0

## Files

- **Recipe:** `kb/recipes/recipe_atomization_unit_v0_v0.yaml`
- **Target item:** `atomization_unit_v0_v0`
  - File: `kb/items/atomization_unit_v0_v0.yaml`
- **BOM:** `kb/boms/bom_atomization_unit_v0_v0.yaml` ✓
  - Components: 4
- **Steps:** 3 total
...
- `atomization_unit_module_v0` (qty: 1.0 None)
- `gas_inlet_manifold_v0` (qty: 1.0 None)
- `structural_frame_small_v0` (qty: 2.0 None)
- `general_purpose_fastener_v0` (qty: 4.0 None)

Suggested fix:
```yaml
- process_id: assembly_basic_v0
  inputs:
  - item_id: atomization_unit_module_v0
    qty: 1.0
    unit: None
  - item_id: gas_inlet_manifold_v0
    qty: 1.0
    unit: None
  - item_id: structural_frame_small_v0
    qty: 2.0
    unit: None
  - item_id: general_purpose_fastener_v0
    qty: 4.0
    unit: None
```
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_atomization_unit_v0_v0.yaml`
