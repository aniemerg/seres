# Fix Intelligence: recipe_core_memory_drive_circuit_v0

## Files

- **Recipe:** `kb/recipes/recipe_core_memory_drive_circuit_v0.yaml`
- **Target item:** `core_memory_drive_circuit_v0`
  - File: `kb/items/core_memory_drive_circuit_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
**Message:** Step 3 uses template process 'calibration_and_test_basic_v0' but doesn't provide step-level input overrides
...
- Step 1 produces: `enclosure_electrical_medium` (1.0 kg)
- Step 2 produces: `wired_electrical_system` (1.0 unit)
- Step 3 produces: `device_calibrated` (1.0 unit)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_core_memory_drive_circuit_v0.yaml`
- **BOM available:** No
