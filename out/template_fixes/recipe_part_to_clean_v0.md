# Fix Intelligence: recipe_part_to_clean_v0

## Files

- **Recipe:** `kb/recipes/recipe_part_to_clean_v0.yaml`
...
- `recipe_part_to_clean_import_v0` → part_to_clean (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_part_to_clean_v0.yaml`
- **BOM available:** No
