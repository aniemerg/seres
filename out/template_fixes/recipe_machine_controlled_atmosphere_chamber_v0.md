# Fix Intelligence: recipe_machine_controlled_atmosphere_chamber_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_controlled_atmosphere_chamber_v0.yaml`
- **Target item:** `controlled_atmosphere_chamber`
  - File: `kb/items/controlled_atmosphere_chamber.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_controlled_atmosphere_chamber_v0.yaml`
- **BOM available:** No
