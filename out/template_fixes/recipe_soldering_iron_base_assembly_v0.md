# Fix Intelligence: recipe_soldering_iron_base_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_soldering_iron_base_assembly_v0.yaml`
- **Target item:** `soldering_iron_base_assembly`
  - File: `kb/items/soldering_iron_base_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_soldering_iron_base_assembly_v0.yaml`
- **BOM available:** No
