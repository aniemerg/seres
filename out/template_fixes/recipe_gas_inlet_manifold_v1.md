# Fix Intelligence: recipe_gas_inlet_manifold_v1

## Files

- **Recipe:** `kb/recipes/recipe_gas_inlet_manifold_v1.yaml`
- **Target item:** `gas_inlet_manifold`
  - File: `kb/items/gas_inlet_manifold.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- `recipe_gas_inlet_manifold_v0` → gas_inlet_manifold_v0 (2 steps)
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_gas_inlet_manifold_v1.yaml`
- **BOM available:** No
