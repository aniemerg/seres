# Fix Intelligence: recipe_raw_metal_block_v0

## Files

- **Recipe:** `kb/recipes/recipe_raw_metal_block_v0.yaml`
- **Target item:** `raw_metal_block`
  - File: `kb/items/raw_metal_block.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_raw_metal_block_v0.yaml`
- **BOM available:** No
