# Fix Intelligence: recipe_lubrication_pack_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_lubrication_pack_basic_v0.yaml`
- **Target item:** `lubrication_pack_basic`
  - File: `kb/items/lubrication_pack_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_lubrication_pack_basic_v0.yaml`
- **BOM available:** No
