# Fix Intelligence: recipe_ceramic_tube_body_v0

## Files

- **Recipe:** `kb/recipes/recipe_ceramic_tube_body_v0.yaml`
- **Target item:** `ceramic_tube_body`
  - File: `kb/items/ceramic_tube_body.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_ceramic_tube_body_v0.yaml`
- **BOM available:** No
