# Fix Intelligence: recipe_installed_belt_drive_v0

## Files

- **Recipe:** `kb/recipes/recipe_installed_belt_drive_v0.yaml`
- **Target item:** `installed_belt_drive`
  - File: `kb/items/installed_belt_drive.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_installed_belt_drive_v0.yaml`
- **BOM available:** No
