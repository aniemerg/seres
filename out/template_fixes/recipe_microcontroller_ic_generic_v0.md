# Fix Intelligence: recipe_microcontroller_ic_generic_v0

## Files

- **Recipe:** `kb/recipes/recipe_microcontroller_ic_generic_v0.yaml`
- **Target item:** `microcontroller_ic_generic`
  - File: `kb/items/microcontroller_ic_generic.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_microcontroller_ic_generic_v0.yaml`
- **BOM available:** No
