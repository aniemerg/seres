# Fix Intelligence: recipe_electronic_assembly_v2

## Files

- **Recipe:** `kb/recipes/recipe_electronic_assembly_v2.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_electronic_assembly_v2.yaml`
- **BOM available:** No
