# Fix Intelligence: recipe_impeller_assembly_welded_v0

## Files

- **Recipe:** `kb/recipes/recipe_impeller_assembly_welded_v0.yaml`
- **Target item:** `impeller_assembly_welded`
  - File: `kb/items/impeller_assembly_welded.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_impeller_assembly_welded_v0.yaml`
- **BOM available:** No
