# Fix Intelligence: recipe_steel_shell_thick_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_shell_thick_import_v0.yaml`
...
- `recipe_steel_shell_thick_v0` → steel_shell_thick (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_steel_shell_thick_import_v0.yaml`
- **BOM available:** No
