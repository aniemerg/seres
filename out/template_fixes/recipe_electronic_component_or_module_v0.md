# Fix Intelligence: recipe_electronic_component_or_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_electronic_component_or_module_v0.yaml`
- **Target item:** `electronic_component_or_module`
  - File: `kb/items/electronic_component_or_module.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_electronic_component_or_module_v0.yaml`
- **BOM available:** No
