# Fix Intelligence: recipe_coil_winding_machine_v1

## Files

- **Recipe:** `kb/recipes/recipe_coil_winding_machine_v1.yaml`
- **Target item:** `coil_winding_machine`
  - File: `kb/items/coil_winding_machine.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- `recipe_coil_winding_machine_v0` → coil_winding_machine_v0 (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_coil_winding_machine_v1.yaml`
- **BOM available:** No
