# Fix Intelligence: recipe_machine_fiber_drawing_tower_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_fiber_drawing_tower_v0.yaml`
- **Target item:** `fiber_drawing_tower`
  - File: `kb/items/fiber_drawing_tower.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- Step 4 produces: `machine_frame_small` (1.0 kg)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_machine_fiber_drawing_tower_v0.yaml`
- **BOM available:** No
