# Fix Intelligence: recipe_table_top_t_slot_v0

## Files

- **Recipe:** `kb/recipes/recipe_table_top_t_slot_v0.yaml`
- **Target item:** `table_top_t_slot`
  - File: `kb/items/table_top_t_slot.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_table_top_t_slot_v0.yaml`
- **BOM available:** No
