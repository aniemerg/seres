# Fix Intelligence: recipe_machine_power_hammer_or_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_power_hammer_or_press_v0.yaml`
- **Target item:** `power_hammer_or_press_v0`
  - File: `kb/items/power_hammer_or_press_v0.yaml`
- **BOM:** `kb/boms/bom_power_hammer_or_press_v0.yaml` ✓
  - Components: 8
- **Steps:** 3 total
...
- `recipe_power_hammer_or_press_v0` → power_hammer_or_press (6 steps)
...
- `hammer_frame_basic` (qty: 1 None)
- `hammer_head_basic` (qty: 1 None)
- `hammer_drive_motor` (qty: 1 None)
- `anvil_block_basic` (qty: 1 None)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_power_hammer_or_press_v0.yaml`
