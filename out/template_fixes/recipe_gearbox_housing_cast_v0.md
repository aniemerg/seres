# Fix Intelligence: recipe_gearbox_housing_cast_v0

## Files

- **Recipe:** `kb/recipes/recipe_gearbox_housing_cast_v0.yaml`
- **Target item:** `gearbox_housing_cast`
  - File: `kb/items/gearbox_housing_cast.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gearbox_housing_cast_v0.yaml`
- **BOM available:** No
