# Fix Intelligence: recipe_bearing_race_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_bearing_race_set_v0.yaml`
- **Target item:** `bearing_race_set`
  - File: `kb/items/bearing_race_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_bearing_race_set_v0.yaml`
- **BOM available:** No
