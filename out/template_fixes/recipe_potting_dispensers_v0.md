# Fix Intelligence: recipe_potting_dispensers_v0

## Files

- **Recipe:** `kb/recipes/recipe_potting_dispensers_v0.yaml`
- **Target item:** `potting_dispensers`
  - File: `kb/items/potting_dispensers.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_potting_dispensers_v0.yaml`
- **BOM available:** No
