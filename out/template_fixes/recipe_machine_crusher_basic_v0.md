# Fix Intelligence: recipe_machine_crusher_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_crusher_basic_v0.yaml`
- **Target item:** `crusher_basic`
  - File: `kb/items/crusher_basic.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_machine_crusher_basic_v0.yaml`
- **BOM available:** No
