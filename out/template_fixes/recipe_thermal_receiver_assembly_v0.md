# Fix Intelligence: recipe_thermal_receiver_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_thermal_receiver_assembly_v0.yaml`
- **Target item:** `thermal_receiver_assembly`
  - File: `kb/items/thermal_receiver_assembly.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_thermal_receiver_assembly_v0.yaml`
- **BOM available:** No
