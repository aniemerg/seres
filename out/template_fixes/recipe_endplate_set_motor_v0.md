# Fix Intelligence: recipe_endplate_set_motor_v0

## Files

- **Recipe:** `kb/recipes/recipe_endplate_set_motor_v0.yaml`
- **Target item:** `endplate_set_motor`
  - File: `kb/items/endplate_set_motor.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_endplate_set_motor_v0.yaml`
- **BOM available:** No
