# Fix Intelligence: recipe_hydraulic_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_press_v0.yaml`
...
- `recipe_machine_hydraulic_press_v0` → hydraulic_press (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hydraulic_press_v0.yaml`
- **BOM available:** No
