# Fix Intelligence: recipe_rock_crusher_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_rock_crusher_basic_v0.yaml`
- **Target item:** `rock_crusher_basic`
  - File: `kb/items/rock_crusher_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_rock_crusher_basic_v0.yaml`
- **BOM available:** No
