# Fix Intelligence: recipe_part_support_frame_welded_v0

## Files

- **Recipe:** `kb/recipes/recipe_part_support_frame_welded_v0.yaml`
- **Target item:** `support_frame_welded`
  - File: `kb/items/support_frame_welded.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_part_support_frame_welded_v0.yaml`
- **BOM available:** No
