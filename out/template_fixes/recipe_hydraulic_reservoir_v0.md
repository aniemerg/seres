# Fix Intelligence: recipe_hydraulic_reservoir_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_reservoir_v0.yaml`
- **Target item:** `hydraulic_reservoir_basic`
  - File: `kb/items/hydraulic_reservoir_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hydraulic_reservoir_v0.yaml`
- **BOM available:** No
