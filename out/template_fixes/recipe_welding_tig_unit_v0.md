# Fix Intelligence: recipe_welding_tig_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_welding_tig_unit_v0.yaml`
- **Target item:** `welding_tig_unit_v0`
  - File: `kb/items/welding_tig_unit_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_welding_tig_unit_v0.yaml`
- **BOM available:** No
