# Fix Intelligence: recipe_steel_ingot_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_ingot_v0.yaml`
- **Target item:** `steel_ingot`
  - File: `kb/items/steel_ingot.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_steel_ingot_v0.yaml`
- **BOM available:** No
