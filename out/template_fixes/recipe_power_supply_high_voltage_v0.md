# Fix Intelligence: recipe_power_supply_high_voltage_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_supply_high_voltage_v0.yaml`
- **Target item:** `power_supply_high_voltage`
  - File: `kb/items/power_supply_high_voltage.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_power_supply_high_voltage_v0.yaml`
- **BOM available:** No
