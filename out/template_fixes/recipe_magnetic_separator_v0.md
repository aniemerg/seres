# Fix Intelligence: recipe_magnetic_separator_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnetic_separator_v0.yaml`
- **Target item:** `magnetic_separator`
  - File: `kb/items/magnetic_separator.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_magnetic_separator_v0.yaml`
- **BOM available:** No
