# Fix Intelligence: recipe_carbon_anode_from_material_v0

## Files

- **Recipe:** `kb/recipes/recipe_carbon_anode_from_material_v0.yaml`
...
- `recipe_carbon_anode_v0` → carbon_anode (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_carbon_anode_from_material_v0.yaml`
- **BOM available:** No
