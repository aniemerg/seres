# Fix Intelligence: recipe_mold_platen_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_mold_platen_assembly_v0.yaml`
- **Target item:** `mold_platen_assembly_v0`
  - File: `kb/items/mold_platen_assembly_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_mold_platen_assembly_v0.yaml`
- **BOM available:** No
