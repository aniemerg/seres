# Fix Intelligence: recipe_heated_platen_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_heated_platen_set_v0.yaml`
- **Target item:** `heated_platen_set`
  - File: `kb/items/heated_platen_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heated_platen_set_v0.yaml`
- **BOM available:** No
