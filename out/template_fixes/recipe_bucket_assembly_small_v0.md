# Fix Intelligence: recipe_bucket_assembly_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_bucket_assembly_small_v0.yaml`
- **Target item:** `bucket_assembly_small`
  - File: `kb/items/bucket_assembly_small.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_bucket_assembly_small_v0.yaml`
- **BOM available:** No
