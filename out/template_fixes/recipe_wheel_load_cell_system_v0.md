# Fix Intelligence: recipe_wheel_load_cell_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_wheel_load_cell_system_v0.yaml`
...
- `recipe_wheel_load_cell_system_v0_v0` → wheel_load_cell_system_v0 (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_wheel_load_cell_system_v0.yaml`
- **BOM available:** No
