# Fix Intelligence: recipe_structural_frame_large_v0

## Files

- **Recipe:** `kb/recipes/recipe_structural_frame_large_v0.yaml`
- **Target item:** `structural_frame_large`
  - File: `kb/items/structural_frame_large.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_structural_frame_large_v0.yaml`
- **BOM available:** No
