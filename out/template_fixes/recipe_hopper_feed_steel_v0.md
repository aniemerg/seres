# Fix Intelligence: recipe_hopper_feed_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_hopper_feed_steel_v0.yaml`
- **Target item:** `hopper_feed_steel`
  - File: `kb/items/hopper_feed_steel.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hopper_feed_steel_v0.yaml`
- **BOM available:** No
