# Fix Intelligence: recipe_machine_distillation_column_simple_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_distillation_column_simple_v0.yaml`
- **Target item:** `distillation_column_simple_v0`
  - File: `kb/items/distillation_column_simple_v0.yaml`
- **BOM:** `kb/boms/bom_distillation_column_simple_v0.yaml` ✓
  - Components: 1
- **Steps:** 6 total
...
- `distillation_column_module_v0` (qty: 1.0 unit)
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_distillation_column_simple_v0.yaml`
