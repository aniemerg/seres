# Fix Intelligence: recipe_insulation_pack_high_temp_v0

## Files

- **Recipe:** `kb/recipes/recipe_insulation_pack_high_temp_v0.yaml`
- **Target item:** `insulation_pack_high_temp`
  - File: `kb/items/insulation_pack_high_temp.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- Step 0 produces: `sintered_shapes` (1.0 kg)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_insulation_pack_high_temp_v0.yaml`
- **BOM available:** No
