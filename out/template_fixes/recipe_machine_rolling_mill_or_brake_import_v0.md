# Fix Intelligence: recipe_machine_rolling_mill_or_brake_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_rolling_mill_or_brake_import_v0.yaml`
- **Target item:** `rolling_mill_or_brake`
  - File: `kb/items/rolling_mill_or_brake.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- `recipe_rolling_mill_or_brake_v0` → rolling_mill_or_brake (7 steps)
- `recipe_machine_rolling_mill_or_brake_v0` → rolling_mill_or_brake (7 steps)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_machine_rolling_mill_or_brake_import_v0.yaml`
- **BOM available:** No
