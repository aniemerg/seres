# Fix Intelligence: recipe_wire_drawing_die_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_wire_drawing_die_set_v0.yaml`
- **Target item:** `wire_drawing_die_set`
  - File: `kb/items/wire_drawing_die_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_wire_drawing_die_set_v0.yaml`
- **BOM available:** No
