# Fix Intelligence: recipe_layer_thickness_control_v0

## Files

- **Recipe:** `kb/recipes/recipe_layer_thickness_control_v0.yaml`
- **Target item:** `layer_thickness_control_v0`
  - File: `kb/items/layer_thickness_control_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_layer_thickness_control_v0.yaml`
- **BOM available:** No
