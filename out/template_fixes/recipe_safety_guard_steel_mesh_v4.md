# Fix Intelligence: recipe_safety_guard_steel_mesh_v4

## Files

- **Recipe:** `kb/recipes/recipe_safety_guard_steel_mesh_v4.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_safety_guard_steel_mesh_v4.yaml`
- **BOM available:** No
