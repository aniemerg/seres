# Fix Intelligence: recipe_iron_metal_pure_from_ilmenite_v0

## Files

- **Recipe:** `kb/recipes/recipe_iron_metal_pure_from_ilmenite_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_iron_metal_pure_from_ilmenite_v0.yaml`
- **BOM available:** No
