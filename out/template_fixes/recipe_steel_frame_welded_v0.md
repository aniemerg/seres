# Fix Intelligence: recipe_steel_frame_welded_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_frame_welded_v0.yaml`
- **Target item:** `steel_frame_welded`
  - File: `kb/items/steel_frame_welded.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_steel_frame_welded_v0.yaml`
- **BOM available:** No
