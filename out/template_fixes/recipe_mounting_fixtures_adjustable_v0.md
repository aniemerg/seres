# Fix Intelligence: recipe_mounting_fixtures_adjustable_v0

## Files

- **Recipe:** `kb/recipes/recipe_mounting_fixtures_adjustable_v0.yaml`
- **Target item:** `mounting_fixtures_adjustable`
  - File: `kb/items/mounting_fixtures_adjustable.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_mounting_fixtures_adjustable_v0.yaml`
- **BOM available:** No
