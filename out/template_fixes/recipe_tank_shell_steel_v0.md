# Fix Intelligence: recipe_tank_shell_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_tank_shell_steel_v0.yaml`
- **Target item:** `tank_shell_steel`
  - File: `kb/items/tank_shell_steel.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_tank_shell_steel_v0.yaml`
- **BOM available:** No
