# Fix Intelligence: recipe_steel_billet_or_slab_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_billet_or_slab_v0.yaml`
...
- `recipe_steel_billet_or_slab_import_v0` → steel_billet_or_slab (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_steel_billet_or_slab_v0.yaml`
- **BOM available:** No
