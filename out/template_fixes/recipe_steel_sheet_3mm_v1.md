# Fix Intelligence: recipe_steel_sheet_3mm_v1

## Files

- **Recipe:** `kb/recipes/recipe_steel_sheet_3mm_v1.yaml`
...
- `recipe_steel_sheet_3mm_v0` → steel_sheet_3mm (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_steel_sheet_3mm_v1.yaml`
- **BOM available:** No
