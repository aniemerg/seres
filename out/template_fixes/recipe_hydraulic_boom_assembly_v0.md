# Fix Intelligence: recipe_hydraulic_boom_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_boom_assembly_v0.yaml`
- **Target item:** `hydraulic_boom_assembly`
  - File: `kb/items/hydraulic_boom_assembly.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hydraulic_boom_assembly_v0.yaml`
- **BOM available:** No
