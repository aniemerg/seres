# Fix Intelligence: recipe_heat_transport_loop_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_transport_loop_assembly_v0.yaml`
- **Target item:** `heat_transport_loop_assembly`
  - File: `kb/items/heat_transport_loop_assembly.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heat_transport_loop_assembly_v0.yaml`
- **BOM available:** No
