# Fix Intelligence: recipe_compressor_pump_small_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_compressor_pump_small_import_v0.yaml`
- **Target item:** `compressor_pump_small`
  - File: `kb/items/compressor_pump_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_compressor_pump_small_v0` → compressor_pump_small (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_compressor_pump_small_import_v0.yaml`
- **BOM available:** No
