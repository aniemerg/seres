# Fix Intelligence: recipe_drawing_rollers_precision_v0

## Files

- **Recipe:** `kb/recipes/recipe_drawing_rollers_precision_v0.yaml`
- **Target item:** `drawing_rollers_precision`
  - File: `kb/items/drawing_rollers_precision.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_drawing_rollers_precision_v0.yaml`
- **BOM available:** No
