# Fix Intelligence: recipe_lathe_leadscrew_and_feed_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_lathe_leadscrew_and_feed_system_v0.yaml`
- **Target item:** `lathe_leadscrew_and_feed_system`
  - File: `kb/items/lathe_leadscrew_and_feed_system.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_lathe_leadscrew_and_feed_system_v0.yaml`
- **BOM available:** No
