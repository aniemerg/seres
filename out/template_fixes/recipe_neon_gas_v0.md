# Fix Intelligence: recipe_neon_gas_v0

## Files

- **Recipe:** `kb/recipes/recipe_neon_gas_v0.yaml`
- **Target item:** `neon_gas`
  - File: `kb/items/neon_gas.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_neon_gas_v0.yaml`
- **BOM available:** No
