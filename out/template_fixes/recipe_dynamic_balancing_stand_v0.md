# Fix Intelligence: recipe_dynamic_balancing_stand_v0

## Files

- **Recipe:** `kb/recipes/recipe_dynamic_balancing_stand_v0.yaml`
...
- `recipe_dynamic_balancing_stand_v0_alt_v0` → dynamic_balancing_stand_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_dynamic_balancing_stand_v0.yaml`
