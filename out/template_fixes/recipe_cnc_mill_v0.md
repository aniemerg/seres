# Fix Intelligence: recipe_cnc_mill_v0

## Files

- **Recipe:** `kb/recipes/recipe_cnc_mill_v0.yaml`
- **Target item:** `cnc_mill`
  - File: `kb/items/cnc_mill.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- `recipe_cnc_mill_v0_seed_v0` → cnc_mill_v0 (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_cnc_mill_v0.yaml`
- **BOM available:** No
