# Fix Intelligence: recipe_rotor_shaft_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_rotor_shaft_medium_v0.yaml`
- **Target item:** `rotor_shaft_medium`
  - File: `kb/items/rotor_shaft_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_rotor_shaft_medium_v0.yaml`
- **BOM available:** No
