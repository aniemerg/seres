# Fix Intelligence: recipe_exhaust_gas_handling_v0

## Files

- **Recipe:** `kb/recipes/recipe_exhaust_gas_handling_v0.yaml`
- **Target item:** `exhaust_gas_handling`
  - File: `kb/items/exhaust_gas_handling.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_exhaust_gas_handling_v0.yaml`
- **BOM available:** No
