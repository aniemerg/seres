# Fix Intelligence: recipe_capacitor_variable_tuning_v0

## Files

- **Recipe:** `kb/recipes/recipe_capacitor_variable_tuning_v0.yaml`
- **Target item:** `capacitor_variable_tuning_v0`
  - File: `kb/items/capacitor_variable_tuning_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_capacitor_variable_tuning_v0.yaml`
- **BOM available:** No
