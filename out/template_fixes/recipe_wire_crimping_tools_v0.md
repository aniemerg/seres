# Fix Intelligence: recipe_wire_crimping_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_wire_crimping_tools_v0.yaml`
- **Target item:** `wire_crimping_tools`
  - File: `kb/items/wire_crimping_tools.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_wire_crimping_tools_v0.yaml`
- **BOM available:** No
