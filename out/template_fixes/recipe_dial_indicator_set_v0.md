# Fix Intelligence: recipe_dial_indicator_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_dial_indicator_set_v0.yaml`
- **Target item:** `dial_indicator_set`
  - File: `kb/items/dial_indicator_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_dial_indicator_set_v0.yaml`
- **BOM available:** No
