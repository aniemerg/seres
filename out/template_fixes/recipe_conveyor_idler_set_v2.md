# Fix Intelligence: recipe_conveyor_idler_set_v2

## Files

- **Recipe:** `kb/recipes/recipe_conveyor_idler_set_v2.yaml`
...
- `recipe_conveyor_idler_set_v0` → conveyor_idler_set (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_conveyor_idler_set_v2.yaml`
- **BOM available:** No
