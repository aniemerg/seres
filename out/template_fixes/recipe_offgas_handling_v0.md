# Fix Intelligence: recipe_offgas_handling_v0

## Files

- **Recipe:** `kb/recipes/recipe_offgas_handling_v0.yaml`
- **Target item:** `offgas_handling`
  - File: `kb/items/offgas_handling.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_offgas_handling_v0.yaml`
- **BOM available:** No
