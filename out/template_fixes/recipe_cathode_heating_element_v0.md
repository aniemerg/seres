# Fix Intelligence: recipe_cathode_heating_element_v0

## Files

- **Recipe:** `kb/recipes/recipe_cathode_heating_element_v0.yaml`
- **Target item:** `cathode_heating_element`
  - File: `kb/items/cathode_heating_element.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_cathode_heating_element_v0.yaml`
- **BOM available:** No
