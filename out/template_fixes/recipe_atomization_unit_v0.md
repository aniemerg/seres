# Fix Intelligence: recipe_atomization_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_atomization_unit_v0.yaml`
- **Target item:** `atomization_unit_v0`
  - File: `kb/items/atomization_unit_v0.yaml`
- **BOM:** `kb/boms/bom_atomization_unit_v0.yaml` ✓
  - Components: 4
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_atomization_unit_v0.yaml`
