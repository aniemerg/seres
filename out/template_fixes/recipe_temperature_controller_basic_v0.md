# Fix Intelligence: recipe_temperature_controller_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_temperature_controller_basic_v0.yaml`
- **Target item:** `temperature_controller_basic`
  - File: `kb/items/temperature_controller_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- `recipe_temperature_controller_basic_v1` → temperature_controller_basic (5 steps)
...
**Message:** Step 4 (process 'electronics_assembly_v0') requires input 'pcb_populated' which is not available
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_temperature_controller_basic_v0.yaml`
- **BOM available:** No
