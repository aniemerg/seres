# Fix Intelligence: recipe_piping_and_fittings_thermal_v0

## Files

- **Recipe:** `kb/recipes/recipe_piping_and_fittings_thermal_v0.yaml`
- **Target item:** `piping_and_fittings_thermal`
  - File: `kb/items/piping_and_fittings_thermal.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_piping_and_fittings_thermal_v0.yaml`
- **BOM available:** No
