# Fix Intelligence: recipe_chemical_reactor_unit_v1_v1

## Files

- **Recipe:** `kb/recipes/recipe_chemical_reactor_unit_v1_v1.yaml`
- **Target item:** `chemical_reactor_unit_v1`
  - File: `kb/items/chemical_reactor_unit_v1.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_chemical_reactor_unit_v0` → chemical_reactor_unit_v0 (1 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_reactor_unit_v1_v1.yaml`
- **BOM available:** No
