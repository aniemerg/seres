# Fix Intelligence: recipe_distillation_column_module_v0_v0

## Files

- **Recipe:** `kb/recipes/recipe_distillation_column_module_v0_v0.yaml`
- **Target item:** `distillation_column_module_v0`
  - File: `kb/items/distillation_column_module_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_distillation_column_module_v0_v0.yaml`
- **BOM available:** No
