# Fix Intelligence: recipe_grease_bearing_high_temp_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_grease_bearing_high_temp_import_v0.yaml`
...
- `recipe_grease_bearing_high_temp_v0` → grease_bearing_high_temp (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_grease_bearing_high_temp_import_v0.yaml`
- **BOM available:** No
