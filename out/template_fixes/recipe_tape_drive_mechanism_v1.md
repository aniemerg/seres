# Fix Intelligence: recipe_tape_drive_mechanism_v1

## Files

- **Recipe:** `kb/recipes/recipe_tape_drive_mechanism_v1.yaml`
...
- `recipe_tape_drive_mechanism_v0` → tape_drive_mechanism (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_tape_drive_mechanism_v1.yaml`
- **BOM available:** No
