# Fix Intelligence: recipe_motor_electric_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_motor_electric_small_v0.yaml`
- **Target item:** `motor_electric_small`
  - File: `kb/items/motor_electric_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_motor_electric_small_v0.yaml`
- **BOM available:** No
