# Fix Intelligence: recipe_machine_powder_mixer_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_powder_mixer_v0.yaml`
- **Target item:** `powder_mixer`
  - File: `kb/items/powder_mixer.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_machine_powder_mixer_v0.yaml`
- **BOM available:** No
