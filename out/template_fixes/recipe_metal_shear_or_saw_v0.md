# Fix Intelligence: recipe_metal_shear_or_saw_v0

## Files

- **Recipe:** `kb/recipes/recipe_metal_shear_or_saw_v0.yaml`
- **Target item:** `metal_shear_or_saw`
  - File: `kb/items/metal_shear_or_saw.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_metal_shear_or_saw_v0.yaml`
- **BOM available:** No
