# Fix Intelligence: recipe_furnace_shell_refractory_v0

## Files

- **Recipe:** `kb/recipes/recipe_furnace_shell_refractory_v0.yaml`
- **Target item:** `furnace_shell_refractory`
  - File: `kb/items/furnace_shell_refractory.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_furnace_shell_refractory_v0.yaml`
- **BOM available:** No
