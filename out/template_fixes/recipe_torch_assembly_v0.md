# Fix Intelligence: recipe_torch_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_torch_assembly_v0.yaml`
- **Target item:** `torch_assembly`
  - File: `kb/items/torch_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_torch_assembly_v0.yaml`
- **BOM available:** No
