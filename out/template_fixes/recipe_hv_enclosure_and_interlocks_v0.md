# Fix Intelligence: recipe_hv_enclosure_and_interlocks_v0

## Files

- **Recipe:** `kb/recipes/recipe_hv_enclosure_and_interlocks_v0.yaml`
- **Target item:** `hv_enclosure_and_interlocks`
  - File: `kb/items/hv_enclosure_and_interlocks.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_hv_enclosure_and_interlocks_v0.yaml`
- **BOM available:** No
