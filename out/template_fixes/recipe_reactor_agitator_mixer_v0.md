# Fix Intelligence: recipe_reactor_agitator_mixer_v0

## Files

- **Recipe:** `kb/recipes/recipe_reactor_agitator_mixer_v0.yaml`
- **Target item:** `reactor_agitator_mixer_v0`
  - File: `kb/items/reactor_agitator_mixer_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_reactor_agitator_mixer_v0.yaml`
- **BOM available:** No
