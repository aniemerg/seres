# Fix Intelligence: recipe_carbonyl_safety_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_carbonyl_safety_system_v0.yaml`
- **Target item:** `carbonyl_safety_system_v0`
  - File: `kb/items/carbonyl_safety_system_v0.yaml`
- **BOM:** `kb/boms/bom_carbonyl_safety_system_v0.yaml` ✓
  - Components: 3
- **Steps:** 4 total
...
- `gasket_sheet_part_v0` (qty: 1.0 unit)
- `gas_inlet_manifold_v0` (qty: 1.0 unit)
- `valve_body_cast_rough_v0` (qty: 1.0 unit)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_carbonyl_safety_system_v0.yaml`
