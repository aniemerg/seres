# Fix Intelligence: recipe_assembled_cable_harness_v0

## Files

- **Recipe:** `kb/recipes/recipe_assembled_cable_harness_v0.yaml`
- **Target item:** `assembled_cable_harness`
  - File: `kb/items/assembled_cable_harness.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_assembled_cable_harness_v0.yaml`
- **BOM available:** No
