# Fix Intelligence: recipe_scara_robot_v0

## Files

- **Recipe:** `kb/recipes/recipe_scara_robot_v0.yaml`
- **Target item:** `scara_robot_v0`
  - File: `kb/items/scara_robot_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_scara_robot_v0.yaml`
- **BOM available:** No
