# Fix Intelligence: recipe_machine_hot_wire_cutter_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_hot_wire_cutter_v0.yaml`
- **Target item:** `hot_wire_cutter_v0`
  - File: `kb/items/hot_wire_cutter_v0.yaml`
- **BOM:** `kb/boms/bom_hot_wire_cutter_v0.yaml` ✓
  - Components: 6
- **Steps:** 3 total
...
- `recipe_hot_wire_cutter_v0` → hot_wire_cutter (4 steps)
...
- `hot_wire_cutter_frame` (qty: 1 None)
- `hot_wire_power_supply` (qty: 1 None)
- `hot_wire_cutting_wire` (qty: 1 None)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_hot_wire_cutter_v0.yaml`
