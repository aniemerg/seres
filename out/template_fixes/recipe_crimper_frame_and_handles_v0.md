# Fix Intelligence: recipe_crimper_frame_and_handles_v0

## Files

- **Recipe:** `kb/recipes/recipe_crimper_frame_and_handles_v0.yaml`
- **Target item:** `crimper_frame_and_handles`
  - File: `kb/items/crimper_frame_and_handles.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_crimper_frame_and_handles_v0.yaml`
- **BOM available:** No
