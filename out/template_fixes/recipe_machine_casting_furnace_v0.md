# Fix Intelligence: recipe_machine_casting_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_casting_furnace_v0.yaml`
- **Target item:** `casting_furnace_v0`
  - File: `kb/items/casting_furnace_v0.yaml`
- **BOM:** `kb/boms/bom_casting_furnace_v0.yaml` ✓
  - Components: 9
- **Steps:** 1 total
...
- `casting_furnace_shell` (qty: 1 None)
- `burner_or_heater_casting` (qty: 1 None)
...
- process_id: assembly_basic_v0
  inputs:
  - item_id: casting_furnace_shell
    qty: 1
    unit: None
  - item_id: burner_or_heater_casting
    qty: 1
    unit: None
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_machine_casting_furnace_v0.yaml`
