# Fix Intelligence: recipe_press_ram_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_ram_set_v0.yaml`
- **Target item:** `press_ram_set`
  - File: `kb/items/press_ram_set.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_press_ram_set_v0.yaml`
- **BOM available:** No
