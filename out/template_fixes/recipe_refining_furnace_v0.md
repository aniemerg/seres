# Fix Intelligence: recipe_refining_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_refining_furnace_v0.yaml`
- **Target item:** `refining_furnace_v0`
  - File: `kb/items/refining_furnace_v0.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- `recipe_refining_furnace_v1` → refining_furnace (7 steps)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_refining_furnace_v0.yaml`
- **BOM available:** No
