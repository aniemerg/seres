# Fix Intelligence: recipe_grinding_wheels_v0

## Files

- **Recipe:** `kb/recipes/recipe_grinding_wheels_v0.yaml`
- **Target item:** `grinding_wheels`
  - File: `kb/items/grinding_wheels.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_grinding_wheels_v0.yaml`
- **BOM available:** No
