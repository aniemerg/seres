# Fix Intelligence: recipe_gas_distribution_manifold_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_distribution_manifold_v0.yaml`
- **Target item:** `gas_distribution_manifold`
  - File: `kb/items/gas_distribution_manifold.yaml`
- **BOM:** None
- **Steps:** 5 total
...
**Message:** Step 0 (process 'plumbing_and_pneumatics_v0') requires input 'piping_components' which is not available
...
- Step 0 produces: `plumbing_system_assembly` (1.0 unit)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gas_distribution_manifold_v0.yaml`
- **BOM available:** No
