# Fix Intelligence: recipe_pcb_drilling_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_pcb_drilling_station_v0.yaml`
- **Target item:** `pcb_drilling_station`
  - File: `kb/items/pcb_drilling_station.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pcb_drilling_station_v0.yaml`
- **BOM available:** No
