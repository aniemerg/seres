# Fix Intelligence: recipe_gas_blower_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_blower_basic_v0.yaml`
- **Target item:** `gas_blower_basic`
  - File: `kb/items/gas_blower_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gas_blower_basic_v0.yaml`
- **BOM available:** No
