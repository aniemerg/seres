# Fix Intelligence: recipe_solar_radiation_v0

## Files

- **Recipe:** `kb/recipes/recipe_solar_radiation_v0.yaml`
- **Target item:** `solar_radiation`
  - File: `kb/items/solar_radiation.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_solar_radiation_v0.yaml`
- **BOM available:** No
