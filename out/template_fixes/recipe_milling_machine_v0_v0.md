# Fix Intelligence: recipe_milling_machine_v0_v0

## Files

- **Recipe:** `kb/recipes/recipe_milling_machine_v0_v0.yaml`
- **Target item:** `milling_machine_v0`
  - File: `kb/items/milling_machine_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_milling_machine_v0_v0.yaml`
- **BOM available:** No
