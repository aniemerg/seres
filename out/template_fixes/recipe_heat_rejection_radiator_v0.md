# Fix Intelligence: recipe_heat_rejection_radiator_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_rejection_radiator_v0.yaml`
- **Target item:** `heat_rejection_radiator`
  - File: `kb/items/heat_rejection_radiator.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heat_rejection_radiator_v0.yaml`
- **BOM available:** No
