# Fix Intelligence: recipe_cargo_platform_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_cargo_platform_assembly_v0.yaml`
- **Target item:** `cargo_platform_assembly`
  - File: `kb/items/cargo_platform_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_cargo_platform_assembly_v0.yaml`
- **BOM available:** No
