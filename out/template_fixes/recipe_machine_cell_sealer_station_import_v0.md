# Fix Intelligence: recipe_machine_cell_sealer_station_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_cell_sealer_station_import_v0.yaml`
...
- `recipe_machine_cell_sealer_station_v0` → cell_sealer_station (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_cell_sealer_station_import_v0.yaml`
- **BOM available:** No
