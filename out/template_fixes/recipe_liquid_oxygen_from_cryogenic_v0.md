# Fix Intelligence: recipe_liquid_oxygen_from_cryogenic_v0

## Files

- **Recipe:** `kb/recipes/recipe_liquid_oxygen_from_cryogenic_v0.yaml`
...
- `recipe_liquid_oxygen_v0` → liquid_oxygen_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_liquid_oxygen_from_cryogenic_v0.yaml`
- **BOM available:** No
