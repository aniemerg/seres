# Fix Intelligence: recipe_crucible_refractory_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_crucible_refractory_import_v0.yaml`
...
- `recipe_crucible_refractory_v0` → crucible_refractory (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_crucible_refractory_import_v0.yaml`
- **BOM available:** No
