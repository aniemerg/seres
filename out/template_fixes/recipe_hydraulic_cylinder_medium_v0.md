# Fix Intelligence: recipe_hydraulic_cylinder_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_cylinder_medium_v0.yaml`
- **Target item:** `hydraulic_cylinder_medium`
  - File: `kb/items/hydraulic_cylinder_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hydraulic_cylinder_medium_v0.yaml`
- **BOM available:** No
