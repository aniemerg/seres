# Fix Intelligence: recipe_waste_heat_v0

## Files

- **Recipe:** `kb/recipes/recipe_waste_heat_v0.yaml`
- **Target item:** `waste_heat`
  - File: `kb/items/waste_heat.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_waste_heat_v0.yaml`
- **BOM available:** No
