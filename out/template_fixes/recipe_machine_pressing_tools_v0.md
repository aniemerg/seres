# Fix Intelligence: recipe_machine_pressing_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_pressing_tools_v0.yaml`
- **Target item:** `pressing_tools`
  - File: `kb/items/pressing_tools.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_machine_pressing_tools_v0.yaml`
- **BOM available:** No
