# Fix Intelligence: recipe_agitation_system_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_agitation_system_basic_v0.yaml`
- **Target item:** `agitation_system_basic`
  - File: `kb/items/agitation_system_basic.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 2 (process 'sheet_metal_fabrication_v0') requires input 'sheet_metal_or_structural_steel' which is not available
...
- Step 2 produces: `formed_sheet_metal_parts` (9.5 kg)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_agitation_system_basic_v0.yaml`
- **BOM available:** No
