# Fix Intelligence: recipe_machine_annealing_oven_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_annealing_oven_small_v0.yaml`
- **Target item:** `annealing_oven_small`
  - File: `kb/items/annealing_oven_small.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_annealing_oven_small_v0.yaml`
- **BOM available:** No
