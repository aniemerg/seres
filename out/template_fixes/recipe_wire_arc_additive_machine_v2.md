# Fix Intelligence: recipe_wire_arc_additive_machine_v2

## Files

- **Recipe:** `kb/recipes/recipe_wire_arc_additive_machine_v2.yaml`
...
- `recipe_wire_arc_additive_machine_v1` → wire_arc_additive_machine (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_wire_arc_additive_machine_v2.yaml`
- **BOM available:** No
