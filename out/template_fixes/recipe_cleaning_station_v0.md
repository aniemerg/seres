# Fix Intelligence: recipe_cleaning_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_cleaning_station_v0.yaml`
...
- `recipe_cleaning_station_basic_v0` → cleaning_station_basic_v0 (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cleaning_station_v0.yaml`
- **BOM available:** No
