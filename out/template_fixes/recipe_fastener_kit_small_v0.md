# Fix Intelligence: recipe_fastener_kit_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_fastener_kit_small_v0.yaml`
- **Target item:** `fastener_kit_small`
  - File: `kb/items/fastener_kit_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_fastener_kit_small_v0.yaml`
- **BOM available:** No
