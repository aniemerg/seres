# Fix Intelligence: recipe_furnace_high_temp_v0

## Files

- **Recipe:** `kb/recipes/recipe_furnace_high_temp_v0.yaml`
- **Target item:** `furnace_high_temp`
  - File: `kb/items/furnace_high_temp.yaml`
- **BOM:** None
- **Steps:** 6 total
...
**Message:** Step 3 (process 'hydraulic_system_integration_v0') requires input 'hydraulic_control_valve_set' which is not available
...
- Step 3 produces: `hydraulic_system_medium` (1.0 kg)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_furnace_high_temp_v0.yaml`
- **BOM available:** No
