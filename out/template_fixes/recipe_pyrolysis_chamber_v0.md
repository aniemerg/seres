# Fix Intelligence: recipe_pyrolysis_chamber_v0

## Files

- **Recipe:** `kb/recipes/recipe_pyrolysis_chamber_v0.yaml`
- **Target item:** `pyrolysis_chamber`
  - File: `kb/items/pyrolysis_chamber.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_pyrolysis_chamber_v0.yaml`
- **BOM available:** No
