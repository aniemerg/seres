# Fix Intelligence: recipe_lidar_time_of_flight_core_v0

## Files

- **Recipe:** `kb/recipes/recipe_lidar_time_of_flight_core_v0.yaml`
- **Target item:** `lidar_time_of_flight_core_v0`
  - File: `kb/items/lidar_time_of_flight_core_v0.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_lidar_time_of_flight_core_v0.yaml`
- **BOM available:** No
