# Fix Intelligence: recipe_wire_copper_insulated_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_wire_copper_insulated_import_v0.yaml`
- **Target item:** `wire_copper_insulated_v0`
  - File: `kb/items/wire_copper_insulated_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- `recipe_wire_copper_insulated_import_v1` → wire_copper_insulated (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_wire_copper_insulated_import_v0.yaml`
- **BOM available:** No
