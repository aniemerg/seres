# Fix Intelligence: recipe_gantry_axes_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_gantry_axes_set_v0.yaml`
- **Target item:** `gantry_axes_set`
  - File: `kb/items/gantry_axes_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gantry_axes_set_v0.yaml`
- **BOM available:** No
