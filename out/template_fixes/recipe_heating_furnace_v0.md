# Fix Intelligence: recipe_heating_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_heating_furnace_v0.yaml`
- **Target item:** `heating_furnace`
  - File: `kb/items/heating_furnace.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heating_furnace_v0.yaml`
- **BOM available:** No
