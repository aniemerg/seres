# Fix Intelligence: recipe_power_bus_v0_v0_alt_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_bus_v0_v0_alt_v0.yaml`
- **Target item:** `power_bus_v0`
  - File: `kb/items/power_bus_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_power_bus_v0_v0` → power_bus (3 steps)
- `recipe_power_bus_v0` → power_bus_v0 (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_power_bus_v0_v0_alt_v0.yaml`
- **BOM available:** No
