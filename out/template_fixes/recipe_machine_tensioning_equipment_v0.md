# Fix Intelligence: recipe_machine_tensioning_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_tensioning_equipment_v0.yaml`
- **Target item:** `tensioning_equipment`
  - File: `kb/items/tensioning_equipment.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_machine_tensioning_equipment_v0.yaml`
- **BOM available:** No
