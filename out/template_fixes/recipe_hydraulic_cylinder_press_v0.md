# Fix Intelligence: recipe_hydraulic_cylinder_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_cylinder_press_v0.yaml`
- **Target item:** `hydraulic_cylinder_press`
  - File: `kb/items/hydraulic_cylinder_press.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hydraulic_cylinder_press_v0.yaml`
- **BOM available:** No
