# Fix Intelligence: recipe_forge_or_induction_heater_v0

## Files

- **Recipe:** `kb/recipes/recipe_forge_or_induction_heater_v0.yaml`
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_forge_or_induction_heater_v0.yaml`
