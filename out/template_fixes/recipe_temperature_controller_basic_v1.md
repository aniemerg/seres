# Fix Intelligence: recipe_temperature_controller_basic_v1

## Files

- **Recipe:** `kb/recipes/recipe_temperature_controller_basic_v1.yaml`
...
- `recipe_temperature_controller_basic_v0` → temperature_controller_basic (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_temperature_controller_basic_v1.yaml`
- **BOM available:** No
