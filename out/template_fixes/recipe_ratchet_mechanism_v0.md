# Fix Intelligence: recipe_ratchet_mechanism_v0

## Files

- **Recipe:** `kb/recipes/recipe_ratchet_mechanism_v0.yaml`
- **Target item:** `ratchet_mechanism`
  - File: `kb/items/ratchet_mechanism.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_ratchet_mechanism_v0.yaml`
- **BOM available:** No
