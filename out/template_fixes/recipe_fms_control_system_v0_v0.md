# Fix Intelligence: recipe_fms_control_system_v0_v0

## Files

- **Recipe:** `kb/recipes/recipe_fms_control_system_v0_v0.yaml`
- **Target item:** `fms_control_system_v0_v0`
  - File: `kb/items/fms_control_system_v0_v0.yaml`
- **BOM:** `kb/boms/bom_fms_control_system_v0_v0.yaml` ✓
  - Components: 3
- **Steps:** 2 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_fms_control_system_v0_v0.yaml`
