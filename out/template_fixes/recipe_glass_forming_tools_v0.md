# Fix Intelligence: recipe_glass_forming_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_glass_forming_tools_v0.yaml`
- **Target item:** `glass_forming_tools`
  - File: `kb/items/glass_forming_tools.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_glass_forming_tools_v0.yaml`
- **BOM available:** No
