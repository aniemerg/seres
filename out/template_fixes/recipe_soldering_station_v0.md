# Fix Intelligence: recipe_soldering_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_soldering_station_v0.yaml`
- **Target item:** `soldering_station`
  - File: `kb/items/soldering_station.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_soldering_station_v0.yaml`
- **BOM available:** No
