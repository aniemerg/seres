# Fix Intelligence: recipe_oscilloscope_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_oscilloscope_basic_v0.yaml`
- **Target item:** `oscilloscope_basic`
  - File: `kb/items/oscilloscope_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
#### Problem: Item `display_screen_small` not found
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_oscilloscope_basic_v0.yaml`
- **BOM available:** No
