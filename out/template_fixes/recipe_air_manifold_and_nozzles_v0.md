# Fix Intelligence: recipe_air_manifold_and_nozzles_v0

## Files

- **Recipe:** `kb/recipes/recipe_air_manifold_and_nozzles_v0.yaml`
- **Target item:** `air_manifold_and_nozzles`
  - File: `kb/items/air_manifold_and_nozzles.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_air_manifold_and_nozzles_v0.yaml`
- **BOM available:** No
