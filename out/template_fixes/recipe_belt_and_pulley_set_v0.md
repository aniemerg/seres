# Fix Intelligence: recipe_belt_and_pulley_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_belt_and_pulley_set_v0.yaml`
...
- `recipe_belt_and_pulley_set_v1` → belt_and_pulley_set (5 steps)
...
**Message:** Step 4 (process 'silicone_rubber_vulcanization_v0') requires input 'silicone_polymer' which is not available
...
- Step 4 produces: `silicone_rubber` (1.0 kg)
- Step 5 produces: `molded_rubber_or_plastic_piece_v0` (1.0 unit)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_belt_and_pulley_set_v0.yaml`
- **BOM available:** No
