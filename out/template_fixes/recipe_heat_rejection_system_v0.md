# Fix Intelligence: recipe_heat_rejection_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_rejection_system_v0.yaml`
- **Target item:** `heat_rejection_system`
  - File: `kb/items/heat_rejection_system.yaml`
- **BOM:** None
- **Steps:** 6 total
...
**Message:** Step 3 (process 'heat_rejection_system_assembly_v0') requires input 'radiator_panel' which is not available

**Location:** Step 3
**Process:** `heat_rejection_system_assembly_v0`
  - File: `kb/processes/heat_rejection_system_assembly_v0.yaml`
...
- Step 3 produces: `heat_rejection_system` (1.0 unit)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_heat_rejection_system_v0.yaml`
- **BOM available:** No
