# Fix Intelligence: recipe_shear_blade_or_saw_band_v0

## Files

- **Recipe:** `kb/recipes/recipe_shear_blade_or_saw_band_v0.yaml`
- **Target item:** `shear_blade_or_saw_band`
  - File: `kb/items/shear_blade_or_saw_band.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_shear_blade_or_saw_band_v0.yaml`
- **BOM available:** No
