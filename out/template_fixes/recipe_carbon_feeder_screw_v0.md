# Fix Intelligence: recipe_carbon_feeder_screw_v0

## Files

- **Recipe:** `kb/recipes/recipe_carbon_feeder_screw_v0.yaml`
- **Target item:** `carbon_feeder_screw`
  - File: `kb/items/carbon_feeder_screw.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_carbon_feeder_screw_v0.yaml`
- **BOM available:** No
