# Fix Intelligence: recipe_power_storage_pack_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_storage_pack_v0.yaml`
- **Target item:** `power_storage_pack`
  - File: `kb/items/power_storage_pack.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_power_storage_pack_v0.yaml`
- **BOM available:** No
