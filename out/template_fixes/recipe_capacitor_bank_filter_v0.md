# Fix Intelligence: recipe_capacitor_bank_filter_v0

## Files

- **Recipe:** `kb/recipes/recipe_capacitor_bank_filter_v0.yaml`
- **Target item:** `capacitor_bank_filter_v0`
  - File: `kb/items/capacitor_bank_filter_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- `recipe_capacitor_bank_filter_v1` → capacitor_bank_filter (3 steps)
...
**Message:** Step 3 (process 'import_receiving_basic_v0') requires input 'bulk_material_or_parts' which is not available
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_capacitor_bank_filter_v0.yaml`
- **BOM available:** No
