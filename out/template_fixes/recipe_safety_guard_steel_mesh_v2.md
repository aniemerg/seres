# Fix Intelligence: recipe_safety_guard_steel_mesh_v2

## Files

- **Recipe:** `kb/recipes/recipe_safety_guard_steel_mesh_v2.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_safety_guard_steel_mesh_v2.yaml`
- **BOM available:** No
