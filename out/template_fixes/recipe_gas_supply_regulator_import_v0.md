# Fix Intelligence: recipe_gas_supply_regulator_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_supply_regulator_import_v0.yaml`
...
- `recipe_gas_supply_regulator_v0` → gas_supply_regulator (4 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gas_supply_regulator_import_v0.yaml`
- **BOM available:** No
