# Fix Intelligence: recipe_machine_stamping_press_basic_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_stamping_press_basic_import_v0.yaml`
- **Target item:** `stamping_press_basic`
  - File: `kb/items/stamping_press_basic.yaml`
- **BOM:** None
- **Steps:** 7 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_stamping_press_basic_import_v0.yaml`
- **BOM available:** No
