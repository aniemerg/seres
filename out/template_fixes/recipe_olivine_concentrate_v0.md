# Fix Intelligence: recipe_olivine_concentrate_v0

## Files

- **Recipe:** `kb/recipes/recipe_olivine_concentrate_v0.yaml`
...
- `recipe_olivine_concentrate_v1` → olivine_concentrate (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_olivine_concentrate_v0.yaml`
- **BOM available:** No
