# Fix Intelligence: recipe_magnetic_base_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnetic_base_set_v0.yaml`
- **Target item:** `magnetic_base_set`
  - File: `kb/items/magnetic_base_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_magnetic_base_set_v0.yaml`
- **BOM available:** No
