# Fix Intelligence: recipe_lathe_headstock_simple_v2

## Files

- **Recipe:** `kb/recipes/recipe_lathe_headstock_simple_v2.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_lathe_headstock_simple_v2.yaml`
- **BOM available:** No
