# Fix Intelligence: recipe_ceramic_tube_socket_v0

## Files

- **Recipe:** `kb/recipes/recipe_ceramic_tube_socket_v0.yaml`
- **Target item:** `ceramic_tube_socket`
  - File: `kb/items/ceramic_tube_socket.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_ceramic_tube_socket_v0.yaml`
- **BOM available:** No
