# Fix Intelligence: recipe_gas_scrubbing_unit_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_scrubbing_unit_frame_v0.yaml`
- **Target item:** `gas_scrubbing_unit_frame_v0`
  - File: `kb/items/gas_scrubbing_unit_frame_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_gas_scrubbing_unit_frame_v0.yaml`
- **BOM available:** No
