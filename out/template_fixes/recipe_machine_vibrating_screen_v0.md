# Fix Intelligence: recipe_machine_vibrating_screen_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_vibrating_screen_v0.yaml`
- **Target item:** `vibrating_screen_v0`
  - File: `kb/items/vibrating_screen_v0.yaml`
- **BOM:** `kb/boms/bom_vibrating_screen_v0.yaml` ✓
  - Components: 7
- **Steps:** 3 total
...
- `screen_deck_basic` (qty: 1 None)
- `vibrator_motor_small` (qty: 1 None)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_vibrating_screen_v0.yaml`
