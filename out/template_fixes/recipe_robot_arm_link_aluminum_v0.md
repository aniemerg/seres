# Fix Intelligence: recipe_robot_arm_link_aluminum_v0

## Files

- **Recipe:** `kb/recipes/recipe_robot_arm_link_aluminum_v0.yaml`
- **Target item:** `robot_arm_link_aluminum`
  - File: `kb/items/robot_arm_link_aluminum.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_robot_arm_link_aluminum_v0.yaml`
- **BOM available:** No
