# Fix Intelligence: recipe_machine_ebm_machine_lunar_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_ebm_machine_lunar_v0.yaml`
- **Target item:** `ebm_machine_lunar_v0`
  - File: `kb/items/ebm_machine_lunar_v0.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_ebm_machine_lunar_v0.yaml`
- **BOM available:** No
