# Fix Intelligence: recipe_wet_material_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_wet_material_import_v0.yaml`
- **Target item:** `wet_material`
  - File: `kb/items/wet_material.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_wet_material_import_v0.yaml`
- **BOM available:** No
