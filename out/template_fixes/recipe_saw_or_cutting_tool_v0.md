# Fix Intelligence: recipe_saw_or_cutting_tool_v0

## Files

- **Recipe:** `kb/recipes/recipe_saw_or_cutting_tool_v0.yaml`
- **Target item:** `saw_or_cutting_tool`
  - File: `kb/items/saw_or_cutting_tool.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_saw_or_cutting_tool_v0.yaml`
- **BOM available:** No
