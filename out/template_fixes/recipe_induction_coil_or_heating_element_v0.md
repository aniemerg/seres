# Fix Intelligence: recipe_induction_coil_or_heating_element_v0

## Files

- **Recipe:** `kb/recipes/recipe_induction_coil_or_heating_element_v0.yaml`
- **Target item:** `induction_coil_or_heating_element`
  - File: `kb/items/induction_coil_or_heating_element.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_induction_coil_or_heating_element_v0.yaml`
- **BOM available:** No
