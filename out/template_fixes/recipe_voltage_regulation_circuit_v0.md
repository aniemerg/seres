# Fix Intelligence: recipe_voltage_regulation_circuit_v0

## Files

- **Recipe:** `kb/recipes/recipe_voltage_regulation_circuit_v0.yaml`
- **Target item:** `voltage_regulation_circuit_v0`
  - File: `kb/items/voltage_regulation_circuit_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_voltage_regulation_circuit_alias_v0` → voltage_regulation_circuit (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_voltage_regulation_circuit_v0.yaml`
- **BOM available:** No
