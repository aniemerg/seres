# Fix Intelligence: recipe_nife_alloy_casting_v0

## Files

- **Recipe:** `kb/recipes/recipe_nife_alloy_casting_v0.yaml`
- **Target item:** `nife_alloy_casting`
  - File: `kb/items/nife_alloy_casting.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_nife_alloy_casting_v0.yaml`
- **BOM available:** No
