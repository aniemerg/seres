# Fix Intelligence: recipe_molding_press_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_molding_press_basic_v0.yaml`
- **Target item:** `molding_press_basic`
  - File: `kb/items/molding_press_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_molding_press_basic_v0.yaml`
- **BOM available:** No
