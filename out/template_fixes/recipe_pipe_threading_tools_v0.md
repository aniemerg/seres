# Fix Intelligence: recipe_pipe_threading_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_pipe_threading_tools_v0.yaml`
- **Target item:** `pipe_threading_tools`
  - File: `kb/items/pipe_threading_tools.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_pipe_threading_tools_v0.yaml`
- **BOM available:** No
