# Fix Intelligence: recipe_substrate_part_or_wire_v0

## Files

- **Recipe:** `kb/recipes/recipe_substrate_part_or_wire_v0.yaml`
- **Target item:** `substrate_part_or_wire`
  - File: `kb/items/substrate_part_or_wire.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_substrate_part_or_wire_v0.yaml`
- **BOM available:** No
