# Fix Intelligence: recipe_nut_hex_medium_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_nut_hex_medium_steel_v0.yaml`
- **Target item:** `nut_hex_medium_steel`
  - File: `kb/items/nut_hex_medium_steel.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_nut_hex_medium_steel_v0.yaml`
- **BOM available:** No
