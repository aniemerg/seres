# Fix Intelligence: recipe_machine_reduction_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_reduction_furnace_v0.yaml`
- **Target item:** `reduction_furnace_v0`
  - File: `kb/items/reduction_furnace_v0.yaml`
- **BOM:** `kb/boms/bom_reduction_furnace_v0.yaml` ✓
  - Components: 11
- **Steps:** 1 total
...
- `reduction_furnace_shell` (qty: 1 None)
...
- process_id: assembly_basic_v0
  inputs:
  - item_id: reduction_furnace_shell
    qty: 1
    unit: None
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_machine_reduction_furnace_v0.yaml`
