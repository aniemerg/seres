# Fix Intelligence: recipe_analog_test_bench_neural_v0

## Files

- **Recipe:** `kb/recipes/recipe_analog_test_bench_neural_v0.yaml`
...
- `recipe_analog_test_bench_neural_v0_v0` → analog_test_bench_neural_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_analog_test_bench_neural_v0.yaml`
- **BOM available:** No
