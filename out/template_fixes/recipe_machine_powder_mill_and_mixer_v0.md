# Fix Intelligence: recipe_machine_powder_mill_and_mixer_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_powder_mill_and_mixer_v0.yaml`
- **Target item:** `powder_mill_and_mixer`
  - File: `kb/items/powder_mill_and_mixer.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_powder_mill_and_mixer_v0.yaml`
- **BOM available:** No
