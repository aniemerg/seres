# Fix Intelligence: recipe_micrometer_mechanical_v0

## Files

- **Recipe:** `kb/recipes/recipe_micrometer_mechanical_v0.yaml`
- **Target item:** `micrometer_mechanical_v0`
  - File: `kb/items/micrometer_mechanical_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_micrometer_mechanical_v0.yaml`
- **BOM available:** No
