# Fix Intelligence: recipe_electronic_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_electronic_assembly_v0.yaml`
...
- `recipe_electronic_assembly_v1` → electronic_assembly (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_electronic_assembly_v0.yaml`
- **BOM available:** No
