# Fix Intelligence: recipe_hand_tools_mechanical_v0

## Files

- **Recipe:** `kb/recipes/recipe_hand_tools_mechanical_v0.yaml`
- **Target item:** `hand_tools_mechanical`
  - File: `kb/items/hand_tools_mechanical.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_hand_tools_mechanical_v0.yaml`
- **BOM available:** No
