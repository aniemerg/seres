# Fix Intelligence: recipe_offgas_manifold_v0

## Files

- **Recipe:** `kb/recipes/recipe_offgas_manifold_v0.yaml`
- **Target item:** `offgas_manifold`
  - File: `kb/items/offgas_manifold.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_offgas_manifold_v0.yaml`
- **BOM available:** No
