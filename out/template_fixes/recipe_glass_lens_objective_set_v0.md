# Fix Intelligence: recipe_glass_lens_objective_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_glass_lens_objective_set_v0.yaml`
- **Target item:** `glass_lens_objective_set`
  - File: `kb/items/glass_lens_objective_set.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_glass_lens_objective_set_v0.yaml`
- **BOM available:** No
