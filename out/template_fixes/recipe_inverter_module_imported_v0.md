# Fix Intelligence: recipe_inverter_module_imported_v0

## Files

- **Recipe:** `kb/recipes/recipe_inverter_module_imported_v0.yaml`
- **Target item:** `inverter_module_imported`
  - File: `kb/items/inverter_module_imported.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_inverter_module_imported_v0.yaml`
- **BOM available:** No
