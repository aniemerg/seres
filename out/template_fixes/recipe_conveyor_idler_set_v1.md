# Fix Intelligence: recipe_conveyor_idler_set_v1

## Files

- **Recipe:** `kb/recipes/recipe_conveyor_idler_set_v1.yaml`
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_conveyor_idler_set_v1.yaml`
- **BOM available:** No
