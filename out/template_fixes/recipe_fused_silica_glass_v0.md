# Fix Intelligence: recipe_fused_silica_glass_v0

## Files

- **Recipe:** `kb/recipes/recipe_fused_silica_glass_v0.yaml`
- **Target item:** `fused_silica_glass`
  - File: `kb/items/fused_silica_glass.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_fused_silica_glass_v0.yaml`
- **BOM available:** No
