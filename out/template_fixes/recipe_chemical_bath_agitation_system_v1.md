# Fix Intelligence: recipe_chemical_bath_agitation_system_v1

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_agitation_system_v1.yaml`
...
- `recipe_chemical_bath_agitation_system_import_v0` → chemical_bath_agitation_system (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_bath_agitation_system_v1.yaml`
- **BOM available:** No
