# Fix Intelligence: recipe_lab_bench_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_lab_bench_unit_v0.yaml`
- **Target item:** `lab_bench_unit_v0`
  - File: `kb/items/lab_bench_unit_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_lab_bench_unit_v0.yaml`
- **BOM available:** No
