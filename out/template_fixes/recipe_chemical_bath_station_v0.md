# Fix Intelligence: recipe_chemical_bath_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_station_v0.yaml`
- **Target item:** `chemical_bath_station`
  - File: `kb/items/chemical_bath_station.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_bath_station_v0.yaml`
- **BOM available:** No
