# Fix Intelligence: recipe_electrical_energy_thermionic_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrical_energy_thermionic_v0.yaml`
...
- `recipe_electrical_energy_v0` → electrical_energy (3 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_electrical_energy_thermionic_v0.yaml`
- **BOM available:** No
