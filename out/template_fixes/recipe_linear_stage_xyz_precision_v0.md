# Fix Intelligence: recipe_linear_stage_xyz_precision_v0

## Files

- **Recipe:** `kb/recipes/recipe_linear_stage_xyz_precision_v0.yaml`
- **Target item:** `linear_stage_xyz_precision`
  - File: `kb/items/linear_stage_xyz_precision.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_linear_stage_xyz_precision_v0.yaml`
- **BOM available:** No
