# Fix Intelligence: recipe_machine_mixing_station_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_mixing_station_v0.yaml`
- **Target item:** `mixing_station`
  - File: `kb/items/mixing_station.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_mixing_station_v0.yaml`
- **BOM available:** No
