# Fix Intelligence: recipe_caliper_vernier_v0

## Files

- **Recipe:** `kb/recipes/recipe_caliper_vernier_v0.yaml`
- **Target item:** `caliper_vernier_v0`
  - File: `kb/items/caliper_vernier_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_caliper_vernier_v0.yaml`
- **BOM available:** No
