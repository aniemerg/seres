# Fix Intelligence: recipe_rolling_mill_or_brake_v0

## Files

- **Recipe:** `kb/recipes/recipe_rolling_mill_or_brake_v0.yaml`
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_rolling_mill_or_brake_v0.yaml`
- **BOM available:** No
