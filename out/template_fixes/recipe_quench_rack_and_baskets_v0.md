# Fix Intelligence: recipe_quench_rack_and_baskets_v0

## Files

- **Recipe:** `kb/recipes/recipe_quench_rack_and_baskets_v0.yaml`
- **Target item:** `quench_rack_and_baskets`
  - File: `kb/items/quench_rack_and_baskets.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_quench_rack_and_baskets_v0.yaml`
- **BOM available:** No
