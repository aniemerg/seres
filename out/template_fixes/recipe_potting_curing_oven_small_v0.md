# Fix Intelligence: recipe_potting_curing_oven_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_potting_curing_oven_small_v0.yaml`
- **Target item:** `potting_curing_oven_small`
  - File: `kb/items/potting_curing_oven_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_potting_curing_oven_small_v0.yaml`
- **BOM available:** No
