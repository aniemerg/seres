# Fix Intelligence: recipe_binder_simple_v0

## Files

- **Recipe:** `kb/recipes/recipe_binder_simple_v0.yaml`
- **Target item:** `binder_simple`
  - File: `kb/items/binder_simple.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_binder_simple_v0.yaml`
- **BOM available:** No
