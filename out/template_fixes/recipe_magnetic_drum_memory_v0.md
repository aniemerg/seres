# Fix Intelligence: recipe_magnetic_drum_memory_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnetic_drum_memory_v0.yaml`
- **Target item:** `magnetic_drum_memory_v0`
  - File: `kb/items/magnetic_drum_memory_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_magnetic_drum_memory_v0.yaml`
- **BOM available:** No
