# Fix Intelligence: recipe_steel_stock_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_stock_v0.yaml`
- **Target item:** `steel_stock`
  - File: `kb/items/steel_stock.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_steel_stock_v0.yaml`
- **BOM available:** No
