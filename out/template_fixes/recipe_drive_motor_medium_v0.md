# Fix Intelligence: recipe_drive_motor_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_drive_motor_medium_v0.yaml`
...
- `recipe_drive_motor_medium_v1` → drive_motor_medium (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_drive_motor_medium_v0.yaml`
- **BOM available:** No
