# Fix Intelligence: recipe_ball_screw_assembly_v1

## Files

- **Recipe:** `kb/recipes/recipe_ball_screw_assembly_v1.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_ball_screw_assembly_v1.yaml`
- **BOM available:** No
