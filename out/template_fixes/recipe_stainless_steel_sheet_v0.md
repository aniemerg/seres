# Fix Intelligence: recipe_stainless_steel_sheet_v0

## Files

- **Recipe:** `kb/recipes/recipe_stainless_steel_sheet_v0.yaml`
...
- `recipe_stainless_steel_sheet_v1` → stainless_steel_sheet (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_stainless_steel_sheet_v0.yaml`
- **BOM available:** No
