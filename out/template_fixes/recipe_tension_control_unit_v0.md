# Fix Intelligence: recipe_tension_control_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_tension_control_unit_v0.yaml`
- **Target item:** `tension_control_unit`
  - File: `kb/items/tension_control_unit.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 2 (process 'sensor_integration_v0') requires input 'sensor_suite_general' which is not available
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_tension_control_unit_v0.yaml`
- **BOM available:** No
