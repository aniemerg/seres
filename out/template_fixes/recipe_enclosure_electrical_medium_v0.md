# Fix Intelligence: recipe_enclosure_electrical_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_enclosure_electrical_medium_v0.yaml`
- **Target item:** `enclosure_electrical_medium`
  - File: `kb/items/enclosure_electrical_medium.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_enclosure_electrical_medium_v0.yaml`
- **BOM available:** No
