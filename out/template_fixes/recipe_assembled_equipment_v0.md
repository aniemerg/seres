# Fix Intelligence: recipe_assembled_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_assembled_equipment_v0.yaml`
- **Target item:** `assembled_equipment`
  - File: `kb/items/assembled_equipment.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_assembled_equipment_v0.yaml`
- **BOM available:** No
