# Fix Intelligence: recipe_agitation_pump_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_agitation_pump_small_v0.yaml`
- **Target item:** `agitation_pump_small`
  - File: `kb/items/agitation_pump_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_agitation_pump_small_v0.yaml`
- **BOM available:** No
