# Fix Intelligence: recipe_tapping_hole_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_tapping_hole_assembly_v0.yaml`
- **Target item:** `tapping_hole_assembly`
  - File: `kb/items/tapping_hole_assembly.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_tapping_hole_assembly_v0.yaml`
- **BOM available:** No
