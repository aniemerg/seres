# Fix Intelligence: recipe_motion_gantry_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_motion_gantry_basic_v0.yaml`
- **Target item:** `motion_gantry_basic`
  - File: `kb/items/motion_gantry_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_motion_gantry_basic_v0.yaml`
- **BOM available:** No
