# Fix Intelligence: recipe_gearbox_reducer_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_gearbox_reducer_medium_v0.yaml`
- **Target item:** `gearbox_reducer_medium`
  - File: `kb/items/gearbox_reducer_medium.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gearbox_reducer_medium_v0.yaml`
- **BOM available:** No
