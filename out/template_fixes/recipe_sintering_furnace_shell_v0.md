# Fix Intelligence: recipe_sintering_furnace_shell_v0

## Files

- **Recipe:** `kb/recipes/recipe_sintering_furnace_shell_v0.yaml`
- **Target item:** `sintering_furnace_shell`
  - File: `kb/items/sintering_furnace_shell.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_sintering_furnace_shell_v0.yaml`
- **BOM available:** No
