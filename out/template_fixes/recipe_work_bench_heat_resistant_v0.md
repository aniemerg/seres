# Fix Intelligence: recipe_work_bench_heat_resistant_v0

## Files

- **Recipe:** `kb/recipes/recipe_work_bench_heat_resistant_v0.yaml`
- **Target item:** `work_bench_heat_resistant`
  - File: `kb/items/work_bench_heat_resistant.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_work_bench_heat_resistant_v0.yaml`
- **BOM available:** No
