# Fix Intelligence: recipe_hydraulic_valve_manifold_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_valve_manifold_basic_v0.yaml`
- **Target item:** `hydraulic_valve_manifold_basic`
  - File: `kb/items/hydraulic_valve_manifold_basic.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_hydraulic_valve_manifold_basic_v0.yaml`
- **BOM available:** No
