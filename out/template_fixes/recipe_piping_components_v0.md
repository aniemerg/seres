# Fix Intelligence: recipe_piping_components_v0

## Files

- **Recipe:** `kb/recipes/recipe_piping_components_v0.yaml`
- **Target item:** `piping_components`
  - File: `kb/items/piping_components.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_piping_components_v0.yaml`
- **BOM available:** No
