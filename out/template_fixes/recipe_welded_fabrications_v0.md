# Fix Intelligence: recipe_welded_fabrications_v0

## Files

- **Recipe:** `kb/recipes/recipe_welded_fabrications_v0.yaml`
- **Target item:** `welded_fabrications`
  - File: `kb/items/welded_fabrications.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_welded_fabrications_v0.yaml`
- **BOM available:** No
