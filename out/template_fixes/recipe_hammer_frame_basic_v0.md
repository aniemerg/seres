# Fix Intelligence: recipe_hammer_frame_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_hammer_frame_basic_v0.yaml`
- **Target item:** `hammer_frame_basic`
  - File: `kb/items/hammer_frame_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hammer_frame_basic_v0.yaml`
- **BOM available:** No
