# Fix Intelligence: recipe_radiator_panel_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_radiator_panel_set_v0.yaml`
- **Target item:** `radiator_panel_set`
  - File: `kb/items/radiator_panel_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_radiator_panel_set_v0.yaml`
- **BOM available:** No
