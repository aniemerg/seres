# Fix Intelligence: recipe_metal_casting_finished_v0

## Files

- **Recipe:** `kb/recipes/recipe_metal_casting_finished_v0.yaml`
- **Target item:** `metal_casting_finished`
  - File: `kb/items/metal_casting_finished.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_metal_casting_finished_v0.yaml`
- **BOM available:** No
