# Fix Intelligence: recipe_computer_workstation_v0

## Files

- **Recipe:** `kb/recipes/recipe_computer_workstation_v0.yaml`
- **Target item:** `computer_workstation`
  - File: `kb/items/computer_workstation.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_computer_workstation_v0.yaml`
- **BOM available:** No
