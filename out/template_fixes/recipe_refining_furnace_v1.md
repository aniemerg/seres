# Fix Intelligence: recipe_refining_furnace_v1

## Files

- **Recipe:** `kb/recipes/recipe_refining_furnace_v1.yaml`
- **Target item:** `refining_furnace`
  - File: `kb/items/refining_furnace.yaml`
- **BOM:** `kb/boms/bom_refining_furnace.yaml` ✓
  - Components: 4
- **Steps:** 7 total
...
- `recipe_refining_furnace_v0` → refining_furnace_v0 (7 steps)
...
- `furnace_shell_insulated` (qty: 1.0 unit)
- `refractory_lining_set` (qty: 1.0 unit)
- `heating_element_set_basic` (qty: 1.0 unit)
- `temperature_controller_basic` (qty: 1.0 unit)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_refining_furnace_v1.yaml`
