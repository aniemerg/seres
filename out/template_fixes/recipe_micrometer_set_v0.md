# Fix Intelligence: recipe_micrometer_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_micrometer_set_v0.yaml`
- **Target item:** `micrometer_set`
  - File: `kb/items/micrometer_set.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_micrometer_set_v0.yaml`
- **BOM available:** No
