# Fix Intelligence: recipe_machine_vacuum_chamber_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_vacuum_chamber_v0.yaml`
- **Target item:** `vacuum_chamber`
  - File: `kb/items/vacuum_chamber.yaml`
- **BOM:** None
- **Steps:** 8 total
...
**Message:** Step 5 (process 'plumbing_and_pneumatics_v0') requires input 'piping_components' which is not available
...
**Message:** Step 6 uses template process 'wiring_and_electronics_integration_v0' but doesn't provide step-level input overrides
...
- Step 5 produces: `plumbing_system_assembly` (1.0 unit)
...
- Step 4 produces: `sealed_component` (1.0 unit)
- Step 5 produces: `plumbing_system_assembly` (1.0 unit)
- Step 6 produces: `wired_electrical_system` (1.0 unit)
...
- **Total errors:** 8
- **Recipe file:** `kb/recipes/recipe_machine_vacuum_chamber_v0.yaml`
- **BOM available:** No
