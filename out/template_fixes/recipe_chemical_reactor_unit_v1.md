# Fix Intelligence: recipe_chemical_reactor_unit_v1

## Files

- **Recipe:** `kb/recipes/recipe_chemical_reactor_unit_v1.yaml`
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_reactor_unit_v1.yaml`
- **BOM available:** No
