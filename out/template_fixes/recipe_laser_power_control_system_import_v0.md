# Fix Intelligence: recipe_laser_power_control_system_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_laser_power_control_system_import_v0.yaml`
- **Target item:** `laser_power_control_system_v0`
  - File: `kb/items/laser_power_control_system_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_laser_power_control_system_v0` → laser_power_control_system_v0 (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_laser_power_control_system_import_v0.yaml`
- **BOM available:** No
