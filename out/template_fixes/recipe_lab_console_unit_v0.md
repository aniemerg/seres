# Fix Intelligence: recipe_lab_console_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_lab_console_unit_v0.yaml`
- **Target item:** `lab_console_unit_v0`
  - File: `kb/items/lab_console_unit_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_lab_console_unit_v0.yaml`
- **BOM available:** No
