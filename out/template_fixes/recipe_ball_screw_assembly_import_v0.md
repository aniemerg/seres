# Fix Intelligence: recipe_ball_screw_assembly_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_ball_screw_assembly_import_v0.yaml`
...
- `recipe_ball_screw_assembly_v0` → ball_screw_assembly (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_ball_screw_assembly_import_v0.yaml`
- **BOM available:** No
