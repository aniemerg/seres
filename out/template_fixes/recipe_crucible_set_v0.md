# Fix Intelligence: recipe_crucible_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_crucible_set_v0.yaml`
- **Target item:** `crucible_set`
  - File: `kb/items/crucible_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_crucible_set_v0.yaml`
- **BOM available:** No
