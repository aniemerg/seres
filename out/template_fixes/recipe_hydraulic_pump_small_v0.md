# Fix Intelligence: recipe_hydraulic_pump_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_pump_small_v0.yaml`
- **Target item:** `hydraulic_pump_small`
  - File: `kb/items/hydraulic_pump_small.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hydraulic_pump_small_v0.yaml`
- **BOM available:** No
