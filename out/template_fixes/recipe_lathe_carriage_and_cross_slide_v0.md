# Fix Intelligence: recipe_lathe_carriage_and_cross_slide_v0

## Files

- **Recipe:** `kb/recipes/recipe_lathe_carriage_and_cross_slide_v0.yaml`
- **Target item:** `lathe_carriage_and_cross_slide`
  - File: `kb/items/lathe_carriage_and_cross_slide.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_lathe_carriage_and_cross_slide_v0.yaml`
- **BOM available:** No
