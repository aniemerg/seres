# Fix Intelligence: recipe_machine_solar_tracking_optional_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_solar_tracking_optional_v0.yaml`
- **Target item:** `solar_tracking_optional`
  - File: `kb/items/solar_tracking_optional.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_solar_tracking_optional_v0.yaml`
- **BOM available:** No
