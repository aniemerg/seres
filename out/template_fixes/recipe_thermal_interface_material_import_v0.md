# Fix Intelligence: recipe_thermal_interface_material_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_thermal_interface_material_import_v0.yaml`
...
- `recipe_thermal_interface_material_v0` → thermal_interface_material (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_thermal_interface_material_import_v0.yaml`
- **BOM available:** No
