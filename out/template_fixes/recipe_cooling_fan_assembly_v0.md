# Fix Intelligence: recipe_cooling_fan_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_cooling_fan_assembly_v0.yaml`
- **Target item:** `cooling_fan_assembly`
  - File: `kb/items/cooling_fan_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_cooling_fan_assembly_v0.yaml`
- **BOM available:** No
