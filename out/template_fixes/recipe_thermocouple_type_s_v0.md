# Fix Intelligence: recipe_thermocouple_type_s_v0

## Files

- **Recipe:** `kb/recipes/recipe_thermocouple_type_s_v0.yaml`
- **Target item:** `thermocouple_type_s_v0`
  - File: `kb/items/thermocouple_type_s_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_thermocouple_type_s_v0.yaml`
- **BOM available:** No
