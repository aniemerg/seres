# Fix Intelligence: recipe_microstructure_analysis_system_v0_v1

## Files

- **Recipe:** `kb/recipes/recipe_microstructure_analysis_system_v0_v1.yaml`
...
- `recipe_microstructure_analysis_system_v0_v0` → microstructure_analysis_system_v0 (4 steps)

## Errors (4 found)

### Error 1: recipe_step_input_not_satisfied

**Message:** Step 0 (process 'machine_assembly_basic_v0') requires input 'optical_microscope_v0' which is not available
...
#### Problem: Item `optical_microscope_v0` not found

This item doesn't exist in the KB.

#### Problem: Item `computer_workstation` not found

This item doesn't exist in the KB.

#### Problem: Item `lab` not found
...
- Step 0 produces: `microstructure_analysis_system_v0` (1.0 unit)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_microstructure_analysis_system_v0_v1.yaml`
- **BOM available:** No
