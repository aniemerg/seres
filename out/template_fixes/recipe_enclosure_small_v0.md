# Fix Intelligence: recipe_enclosure_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_enclosure_small_v0.yaml`
...
- `recipe_enclosure_small_additive_v0` → enclosure_small (3 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_enclosure_small_v0.yaml`
- **BOM available:** No
