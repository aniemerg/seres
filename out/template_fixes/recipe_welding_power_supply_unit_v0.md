# Fix Intelligence: recipe_welding_power_supply_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_welding_power_supply_unit_v0.yaml`
- **Target item:** `welding_power_supply_unit`
  - File: `kb/items/welding_power_supply_unit.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_welding_power_supply_unit_v0.yaml`
- **BOM available:** No
