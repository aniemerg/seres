# Fix Intelligence: recipe_rolling_elements_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_rolling_elements_set_v0.yaml`
- **Target item:** `rolling_elements_set`
  - File: `kb/items/rolling_elements_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_rolling_elements_set_v0.yaml`
- **BOM available:** No
