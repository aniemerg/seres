# Fix Intelligence: recipe_solar_tracking_mechanism_dual_axis_v0

## Files

- **Recipe:** `kb/recipes/recipe_solar_tracking_mechanism_dual_axis_v0.yaml`
- **Target item:** `solar_tracking_mechanism_dual_axis_v0`
  - File: `kb/items/solar_tracking_mechanism_dual_axis_v0.yaml`
- **BOM:** None
- **Steps:** 7 total
...
**Message:** Step 4 (process 'sensor_calibration_v0') requires input 'sensor_suite_general' which is not available
...
- Step 4 produces: `sensor_suite_general` (1.0 unit)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_solar_tracking_mechanism_dual_axis_v0.yaml`
- **BOM available:** No
