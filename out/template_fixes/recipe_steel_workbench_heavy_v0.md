# Fix Intelligence: recipe_steel_workbench_heavy_v0

## Files

- **Recipe:** `kb/recipes/recipe_steel_workbench_heavy_v0.yaml`
- **Target item:** `steel_workbench_heavy`
  - File: `kb/items/steel_workbench_heavy.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_steel_workbench_heavy_v0.yaml`
- **BOM available:** No
