# Fix Intelligence: recipe_straightedge_precision_v0

## Files

- **Recipe:** `kb/recipes/recipe_straightedge_precision_v0.yaml`
- **Target item:** `straightedge_precision`
  - File: `kb/items/straightedge_precision.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_straightedge_precision_v0.yaml`
- **BOM available:** No
