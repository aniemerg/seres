# Fix Intelligence: recipe_anorthite_ore_v0

## Files

- **Recipe:** `kb/recipes/recipe_anorthite_ore_v0.yaml`
- **Target item:** `anorthite_ore`
  - File: `kb/items/anorthite_ore.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_anorthite_ore_v0.yaml`
- **BOM available:** No
