# Fix Intelligence: recipe_ground_clamp_and_cables_v0

## Files

- **Recipe:** `kb/recipes/recipe_ground_clamp_and_cables_v0.yaml`
- **Target item:** `ground_clamp_and_cables`
  - File: `kb/items/ground_clamp_and_cables.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_ground_clamp_and_cables_v0.yaml`
- **BOM available:** No
