# Fix Intelligence: recipe_vibrator_motor_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_vibrator_motor_small_v0.yaml`
- **Target item:** `vibrator_motor_small`
  - File: `kb/items/vibrator_motor_small.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_vibrator_motor_small_v0.yaml`
- **BOM available:** No
