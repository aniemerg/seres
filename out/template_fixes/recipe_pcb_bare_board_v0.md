# Fix Intelligence: recipe_pcb_bare_board_v0

## Files

- **Recipe:** `kb/recipes/recipe_pcb_bare_board_v0.yaml`
- **Target item:** `pcb_bare_board`
  - File: `kb/items/pcb_bare_board.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_pcb_bare_board_v0.yaml`
- **BOM available:** No
