# Fix Intelligence: recipe_oxygen_sensor_module_v1

## Files

- **Recipe:** `kb/recipes/recipe_oxygen_sensor_module_v1.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_oxygen_sensor_module_v1.yaml`
- **BOM available:** No
