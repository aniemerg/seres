# Fix Intelligence: recipe_circuit_board_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_circuit_board_tools_v0.yaml`
- **Target item:** `circuit_board_tools_v0`
  - File: `kb/items/circuit_board_tools_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_circuit_board_tools_v0.yaml`
- **BOM available:** No
