# Fix Intelligence: recipe_metal_sheet_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_metal_sheet_import_v0.yaml`
...
- `recipe_metal_sheet_v0` → metal_sheet (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_metal_sheet_import_v0.yaml`
- **BOM available:** No
