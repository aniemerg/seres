# Fix Intelligence: recipe_hydraulic_cylinder_large_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_cylinder_large_v0.yaml`
- **Target item:** `hydraulic_cylinder_large`
  - File: `kb/items/hydraulic_cylinder_large.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_hydraulic_cylinder_large_v0.yaml`
- **BOM available:** No
