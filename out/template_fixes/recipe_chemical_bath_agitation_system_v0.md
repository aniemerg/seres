# Fix Intelligence: recipe_chemical_bath_agitation_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_agitation_system_v0.yaml`
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_bath_agitation_system_v0.yaml`
- **BOM available:** No
