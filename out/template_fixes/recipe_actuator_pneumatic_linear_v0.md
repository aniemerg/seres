# Fix Intelligence: recipe_actuator_pneumatic_linear_v0

## Files

- **Recipe:** `kb/recipes/recipe_actuator_pneumatic_linear_v0.yaml`
- **Target item:** `actuator_pneumatic_linear`
  - File: `kb/items/actuator_pneumatic_linear.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_actuator_pneumatic_linear_v0.yaml`
- **BOM available:** No
