# Fix Intelligence: recipe_pcb_fab_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_pcb_fab_equipment_v0.yaml`
- **Target item:** `pcb_fab_equipment`
  - File: `kb/items/pcb_fab_equipment.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pcb_fab_equipment_v0.yaml`
- **BOM available:** No
