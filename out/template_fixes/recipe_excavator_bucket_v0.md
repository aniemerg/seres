# Fix Intelligence: recipe_excavator_bucket_v0

## Files

- **Recipe:** `kb/recipes/recipe_excavator_bucket_v0.yaml`
- **Target item:** `excavator_bucket`
  - File: `kb/items/excavator_bucket.yaml`
- **BOM:** None
- **Steps:** 5 total
...
**Message:** Step 3 (process 'heat_treat_basic_v0') requires input 'machined_part_raw' which is not available
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_excavator_bucket_v0.yaml`
- **BOM available:** No
