# Fix Intelligence: recipe_ball_screw_assembly_v2

## Files

- **Recipe:** `kb/recipes/recipe_ball_screw_assembly_v2.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_ball_screw_assembly_v2.yaml`
- **BOM available:** No
