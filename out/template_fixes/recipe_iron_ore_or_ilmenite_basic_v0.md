# Fix Intelligence: recipe_iron_ore_or_ilmenite_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_iron_ore_or_ilmenite_basic_v0.yaml`
...
- `recipe_ilmenite_from_regolith_v0` → iron_ore_or_ilmenite (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_iron_ore_or_ilmenite_basic_v0.yaml`
- **BOM available:** No
