# Fix Intelligence: recipe_tension_roller_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_tension_roller_set_v0.yaml`
- **Target item:** `tension_roller_set`
  - File: `kb/items/tension_roller_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_tension_roller_set_v1` → tension_roller_set (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tension_roller_set_v0.yaml`
- **BOM available:** No
