# Fix Intelligence: recipe_wheel_set_industrial_v0

## Files

- **Recipe:** `kb/recipes/recipe_wheel_set_industrial_v0.yaml`
- **Target item:** `wheel_set_industrial`
  - File: `kb/items/wheel_set_industrial.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_wheel_set_industrial_v0.yaml`
- **BOM available:** No
