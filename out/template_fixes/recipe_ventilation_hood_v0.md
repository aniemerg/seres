# Fix Intelligence: recipe_ventilation_hood_v0

## Files

- **Recipe:** `kb/recipes/recipe_ventilation_hood_v0.yaml`
- **Target item:** `ventilation_hood`
  - File: `kb/items/ventilation_hood.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_ventilation_hood_v0.yaml`
- **BOM available:** No
