# Fix Intelligence: recipe_truss_node_connector_set_v1

## Files

- **Recipe:** `kb/recipes/recipe_truss_node_connector_set_v1.yaml`
- **Target item:** `truss_node_connector_set`
  - File: `kb/items/truss_node_connector_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- `recipe_truss_node_connector_set_v0` → truss_node_connector_set_v0 (4 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_truss_node_connector_set_v1.yaml`
- **BOM available:** No
