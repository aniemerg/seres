# Fix Intelligence: recipe_shear_frame_and_bed_v0

## Files

- **Recipe:** `kb/recipes/recipe_shear_frame_and_bed_v0.yaml`
- **Target item:** `shear_frame_and_bed`
  - File: `kb/items/shear_frame_and_bed.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_shear_frame_and_bed_v0.yaml`
- **BOM available:** No
