# Fix Intelligence: recipe_insulation_panel_high_temp_v0

## Files

- **Recipe:** `kb/recipes/recipe_insulation_panel_high_temp_v0.yaml`
- **Target item:** `insulation_panel_high_temp_v0`
  - File: `kb/items/insulation_panel_high_temp_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_insulation_panel_high_temp_v1` → insulation_panel_high_temp (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_insulation_panel_high_temp_v0.yaml`
- **BOM available:** No
