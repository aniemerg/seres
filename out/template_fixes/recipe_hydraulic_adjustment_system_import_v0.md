# Fix Intelligence: recipe_hydraulic_adjustment_system_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_adjustment_system_import_v0.yaml`
...
- `recipe_hydraulic_adjustment_system_v0` → hydraulic_adjustment_system (5 steps)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_hydraulic_adjustment_system_import_v0.yaml`
- **BOM available:** No
