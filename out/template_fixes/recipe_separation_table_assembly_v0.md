# Fix Intelligence: recipe_separation_table_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_separation_table_assembly_v0.yaml`
- **Target item:** `separation_table_assembly`
  - File: `kb/items/separation_table_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_separation_table_assembly_v0.yaml`
- **BOM available:** No
