# Fix Intelligence: recipe_anvil_block_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_anvil_block_basic_v0.yaml`
- **Target item:** `anvil_block_basic`
  - File: `kb/items/anvil_block_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_anvil_block_basic_v0.yaml`
- **BOM available:** No
