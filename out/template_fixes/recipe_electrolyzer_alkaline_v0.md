# Fix Intelligence: recipe_electrolyzer_alkaline_v0

## Files

- **Recipe:** `kb/recipes/recipe_electrolyzer_alkaline_v0.yaml`
- **Target item:** `electrolyzer_alkaline_v0`
  - File: `kb/items/electrolyzer_alkaline_v0.yaml`
- **BOM:** `kb/boms/bom_electrolyzer_alkaline_v0.yaml` ✓
  - Components: 4
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_electrolyzer_alkaline_v0.yaml`
