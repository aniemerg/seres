# Fix Intelligence: recipe_light_source_bright_v0

## Files

- **Recipe:** `kb/recipes/recipe_light_source_bright_v0.yaml`
- **Target item:** `light_source_bright`
  - File: `kb/items/light_source_bright.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_light_source_bright_v0.yaml`
- **BOM available:** No
