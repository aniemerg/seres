# Fix Intelligence: recipe_flywheel_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_flywheel_medium_v0.yaml`
- **Target item:** `flywheel_medium`
  - File: `kb/items/flywheel_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_flywheel_medium_v0.yaml`
- **BOM available:** No
