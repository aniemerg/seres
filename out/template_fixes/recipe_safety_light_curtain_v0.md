# Fix Intelligence: recipe_safety_light_curtain_v0

## Files

- **Recipe:** `kb/recipes/recipe_safety_light_curtain_v0.yaml`
- **Target item:** `safety_light_curtain`
  - File: `kb/items/safety_light_curtain.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_safety_light_curtain_v0.yaml`
- **BOM available:** No
