# Fix Intelligence: recipe_rms_reconfigurable_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_rms_reconfigurable_system_v0.yaml`
- **Target item:** `rms_reconfigurable_system_v0`
  - File: `kb/items/rms_reconfigurable_system_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_rms_reconfigurable_system_v0.yaml`
- **BOM available:** No
