# Fix Intelligence: recipe_toggle_mechanism_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_toggle_mechanism_set_v0.yaml`
- **Target item:** `toggle_mechanism_set`
  - File: `kb/items/toggle_mechanism_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_toggle_mechanism_set_v0.yaml`
- **BOM available:** No
