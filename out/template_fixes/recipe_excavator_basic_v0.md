# Fix Intelligence: recipe_excavator_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_excavator_basic_v0.yaml`
- **Target item:** `excavator_basic`
  - File: `kb/items/excavator_basic.yaml`
- **BOM:** None
- **Steps:** 6 total
...
**Message:** Step 5 uses template process 'load_testing_and_commissioning_v0' but doesn't provide step-level input overrides
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_excavator_basic_v0.yaml`
- **BOM available:** No
