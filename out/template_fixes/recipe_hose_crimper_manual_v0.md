# Fix Intelligence: recipe_hose_crimper_manual_v0

## Files

- **Recipe:** `kb/recipes/recipe_hose_crimper_manual_v0.yaml`
- **Target item:** `hose_crimper_manual`
  - File: `kb/items/hose_crimper_manual.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_hose_crimper_manual_v0.yaml`
- **BOM available:** No
