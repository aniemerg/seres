# Fix Intelligence: recipe_machine_milling_machine_general_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_milling_machine_general_v0.yaml`
- **Target item:** `milling_machine_general_v0`
  - File: `kb/items/milling_machine_general_v0.yaml`
- **BOM:** `kb/boms/bom_milling_machine_general_v0.yaml` ✓
  - Components: 10
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_milling_machine_general_v0.yaml`
