# Fix Intelligence: recipe_temperature_controller_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_temperature_controller_module_v0.yaml`
- **Target item:** `temperature_controller_module`
  - File: `kb/items/temperature_controller_module.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_temperature_controller_module_v0.yaml`
- **BOM available:** No
