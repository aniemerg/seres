# Fix Intelligence: recipe_wire_copper_insulated_v0

## Files

- **Recipe:** `kb/recipes/recipe_wire_copper_insulated_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_wire_copper_insulated_v0.yaml`
- **BOM available:** No
