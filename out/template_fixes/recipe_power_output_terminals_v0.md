# Fix Intelligence: recipe_power_output_terminals_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_output_terminals_v0.yaml`
- **Target item:** `power_output_terminals`
  - File: `kb/items/power_output_terminals.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_power_output_terminals_v0.yaml`
- **BOM available:** No
