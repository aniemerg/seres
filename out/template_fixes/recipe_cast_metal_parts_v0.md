# Fix Intelligence: recipe_cast_metal_parts_v0

## Files

- **Recipe:** `kb/recipes/recipe_cast_metal_parts_v0.yaml`
- **Target item:** `cast_metal_parts`
  - File: `kb/items/cast_metal_parts.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_cast_metal_parts_v0.yaml`
- **BOM available:** No
