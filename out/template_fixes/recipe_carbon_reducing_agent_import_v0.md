# Fix Intelligence: recipe_carbon_reducing_agent_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_carbon_reducing_agent_import_v0.yaml`
...
- `recipe_carbon_reducing_agent_v0` → carbon_reducing_agent (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_carbon_reducing_agent_import_v0.yaml`
- **BOM available:** No
