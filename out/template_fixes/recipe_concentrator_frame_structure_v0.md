# Fix Intelligence: recipe_concentrator_frame_structure_v0

## Files

- **Recipe:** `kb/recipes/recipe_concentrator_frame_structure_v0.yaml`
- **Target item:** `concentrator_frame_structure`
  - File: `kb/items/concentrator_frame_structure.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_concentrator_frame_structure_v0.yaml`
- **BOM available:** No
