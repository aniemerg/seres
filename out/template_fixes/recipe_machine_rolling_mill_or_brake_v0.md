# Fix Intelligence: recipe_machine_rolling_mill_or_brake_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_rolling_mill_or_brake_v0.yaml`
...
- `recipe_machine_rolling_mill_or_brake_import_v0` → rolling_mill_or_brake (7 steps)
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_machine_rolling_mill_or_brake_v0.yaml`
- **BOM available:** No
