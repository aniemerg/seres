# Fix Intelligence: recipe_caliper_set_precision_v0

## Files

- **Recipe:** `kb/recipes/recipe_caliper_set_precision_v0.yaml`
- **Target item:** `caliper_set_precision`
  - File: `kb/items/caliper_set_precision.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_caliper_set_precision_v0.yaml`
- **BOM available:** No
