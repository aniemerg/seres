# Fix Intelligence: recipe_copper_clad_laminate_v0

## Files

- **Recipe:** `kb/recipes/recipe_copper_clad_laminate_v0.yaml`
...
- `recipe_copper_clad_laminate_v0_alt` → copper_clad_laminate (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_copper_clad_laminate_v0.yaml`
- **BOM available:** No
