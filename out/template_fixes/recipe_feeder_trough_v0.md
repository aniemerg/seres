# Fix Intelligence: recipe_feeder_trough_v0

## Files

- **Recipe:** `kb/recipes/recipe_feeder_trough_v0.yaml`
- **Target item:** `feeder_trough`
  - File: `kb/items/feeder_trough.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_feeder_trough_v0.yaml`
- **BOM available:** No
