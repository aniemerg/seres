# Fix Intelligence: recipe_fixturing_workbench_v0

## Files

- **Recipe:** `kb/recipes/recipe_fixturing_workbench_v0.yaml`
- **Target item:** `fixturing_workbench`
  - File: `kb/items/fixturing_workbench.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_fixturing_workbench_v0.yaml`
- **BOM available:** No
