# Fix Intelligence: recipe_helium_3_gas_v0

## Files

- **Recipe:** `kb/recipes/recipe_helium_3_gas_v0.yaml`
- **Target item:** `helium_3_gas`
  - File: `kb/items/helium_3_gas.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_helium_3_gas_v0.yaml`
- **BOM available:** No
