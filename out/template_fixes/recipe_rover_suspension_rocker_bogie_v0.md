# Fix Intelligence: recipe_rover_suspension_rocker_bogie_v0

## Files

- **Recipe:** `kb/recipes/recipe_rover_suspension_rocker_bogie_v0.yaml`
- **Target item:** `rover_suspension_rocker_bogie_v0`
  - File: `kb/items/rover_suspension_rocker_bogie_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_rover_suspension_rocker_bogie_v0.yaml`
- **BOM available:** No
