# Fix Intelligence: recipe_sensor_wired_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_sensor_wired_assembly_v0.yaml`
- **Target item:** `sensor_wired_assembly`
  - File: `kb/items/sensor_wired_assembly.yaml`
- **BOM:** None
- **Steps:** 3 total
...
**Message:** Step 1 (process 'strain_gauge_bonding_process_v0') requires input 'strain_gauge_foil_v0' which is not available
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_sensor_wired_assembly_v0.yaml`
- **BOM available:** No
