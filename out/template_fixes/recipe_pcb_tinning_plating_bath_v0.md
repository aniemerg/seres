# Fix Intelligence: recipe_pcb_tinning_plating_bath_v0

## Files

- **Recipe:** `kb/recipes/recipe_pcb_tinning_plating_bath_v0.yaml`
- **Target item:** `pcb_tinning_plating_bath`
  - File: `kb/items/pcb_tinning_plating_bath.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pcb_tinning_plating_bath_v0.yaml`
- **BOM available:** No
