# Fix Intelligence: recipe_vacuum_tube_subassembly_v0_target_v0

## Files

- **Recipe:** `kb/recipes/recipe_vacuum_tube_subassembly_v0_target_v0.yaml`
...
- `recipe_vacuum_tube_subassembly_v0` → vacuum_tube_subassembly (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_vacuum_tube_subassembly_v0_target_v0.yaml`
- **BOM available:** No
