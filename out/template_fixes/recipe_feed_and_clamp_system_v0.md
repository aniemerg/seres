# Fix Intelligence: recipe_feed_and_clamp_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_feed_and_clamp_system_v0.yaml`
- **Target item:** `feed_and_clamp_system`
  - File: `kb/items/feed_and_clamp_system.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_feed_and_clamp_system_v0.yaml`
- **BOM available:** No
