# Fix Intelligence: recipe_base_metal_parts_v1

## Files

- **Recipe:** `kb/recipes/recipe_base_metal_parts_v1.yaml`
...
- `recipe_base_metal_parts_v0` → base_metal_parts (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_base_metal_parts_v1.yaml`
- **BOM available:** No
