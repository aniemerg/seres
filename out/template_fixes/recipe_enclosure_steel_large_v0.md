# Fix Intelligence: recipe_enclosure_steel_large_v0

## Files

- **Recipe:** `kb/recipes/recipe_enclosure_steel_large_v0.yaml`
- **Target item:** `enclosure_steel_large`
  - File: `kb/items/enclosure_steel_large.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_enclosure_steel_large_v0.yaml`
- **BOM available:** No
