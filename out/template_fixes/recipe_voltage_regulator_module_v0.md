# Fix Intelligence: recipe_voltage_regulator_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_voltage_regulator_module_v0.yaml`
- **Target item:** `voltage_regulator_module`
  - File: `kb/items/voltage_regulator_module.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_voltage_regulator_module_v0.yaml`
- **BOM available:** No
