# Fix Intelligence: recipe_component_to_seal_v0

## Files

- **Recipe:** `kb/recipes/recipe_component_to_seal_v0.yaml`
...
- `recipe_component_to_seal_import_v0` → component_to_seal (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_component_to_seal_v0.yaml`
- **BOM available:** No
