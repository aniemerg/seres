# Fix Intelligence: recipe_machine_press_brake_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_press_brake_import_v0.yaml`
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_press_brake_import_v0.yaml`
- **BOM available:** No
