# Fix Intelligence: recipe_magnet_wire_copper_v1

## Files

- **Recipe:** `kb/recipes/recipe_magnet_wire_copper_v1.yaml`
...
- `recipe_magnet_wire_copper_v0` → magnet_wire_copper (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_magnet_wire_copper_v1.yaml`
- **BOM available:** No
