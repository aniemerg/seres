# Fix Intelligence: recipe_gas_handling_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_gas_handling_system_v0.yaml`
- **Target item:** `gas_handling_system`
  - File: `kb/items/gas_handling_system.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gas_handling_system_v0.yaml`
- **BOM available:** No
