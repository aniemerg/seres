# Fix Intelligence: recipe_dust_collection_hood_v0

## Files

- **Recipe:** `kb/recipes/recipe_dust_collection_hood_v0.yaml`
- **Target item:** `dust_collection_hood`
  - File: `kb/items/dust_collection_hood.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_dust_collection_hood_v0.yaml`
- **BOM available:** No
