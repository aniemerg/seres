# Fix Intelligence: recipe_conveyor_belt_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_conveyor_belt_small_v0.yaml`
- **Target item:** `conveyor_belt_small`
  - File: `kb/items/conveyor_belt_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_conveyor_belt_small_v0.yaml`
- **BOM available:** No
