# Fix Intelligence: recipe_molding_press_platen_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_molding_press_platen_set_v0.yaml`
- **Target item:** `molding_press_platen_set`
  - File: `kb/items/molding_press_platen_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_molding_press_platen_set_v0.yaml`
- **BOM available:** No
