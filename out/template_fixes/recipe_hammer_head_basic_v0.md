# Fix Intelligence: recipe_hammer_head_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_hammer_head_basic_v0.yaml`
- **Target item:** `hammer_head_basic`
  - File: `kb/items/hammer_head_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hammer_head_basic_v0.yaml`
- **BOM available:** No
