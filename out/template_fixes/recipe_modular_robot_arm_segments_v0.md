# Fix Intelligence: recipe_modular_robot_arm_segments_v0

## Files

- **Recipe:** `kb/recipes/recipe_modular_robot_arm_segments_v0.yaml`
- **Target item:** `modular_robot_arm_segments_v0`
  - File: `kb/items/modular_robot_arm_segments_v0.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_modular_robot_arm_segments_v0.yaml`
- **BOM available:** No
