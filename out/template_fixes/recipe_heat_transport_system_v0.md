# Fix Intelligence: recipe_heat_transport_system_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_transport_system_v0.yaml`
- **Target item:** `heat_transport_system`
  - File: `kb/items/heat_transport_system.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heat_transport_system_v0.yaml`
- **BOM available:** No
