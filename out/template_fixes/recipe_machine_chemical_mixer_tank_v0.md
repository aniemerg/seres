# Fix Intelligence: recipe_machine_chemical_mixer_tank_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_chemical_mixer_tank_v0.yaml`
...
- `recipe_machine_chemical_mixer_tank_import_v0` → chemical_mixer_tank (3 steps)
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_machine_chemical_mixer_tank_v0.yaml`
- **BOM available:** No
