# Fix Intelligence: recipe_control_compute_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_control_compute_module_v0.yaml`
- **Target item:** `control_compute_module_imported`
  - File: `kb/items/control_compute_module_imported.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_control_compute_module_v0.yaml`
- **BOM available:** No
