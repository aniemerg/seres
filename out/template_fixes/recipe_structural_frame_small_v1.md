# Fix Intelligence: recipe_structural_frame_small_v1

## Files

- **Recipe:** `kb/recipes/recipe_structural_frame_small_v1.yaml`
- **Target item:** `structural_frame_small`
  - File: `kb/items/structural_frame_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_structural_frame_small_v0` → structural_frame_small_v0 (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_structural_frame_small_v1.yaml`
- **BOM available:** No
