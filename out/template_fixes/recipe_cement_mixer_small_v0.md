# Fix Intelligence: recipe_cement_mixer_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_cement_mixer_small_v0.yaml`
...
- `recipe_machine_cement_mixer_small_v0` → cement_mixer_small (3 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cement_mixer_small_v0.yaml`
- **BOM available:** No
