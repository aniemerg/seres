# Fix Intelligence: recipe_cooling_chamber_controlled_v0

## Files

- **Recipe:** `kb/recipes/recipe_cooling_chamber_controlled_v0.yaml`
- **Target item:** `cooling_chamber_controlled`
  - File: `kb/items/cooling_chamber_controlled.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cooling_chamber_controlled_v0.yaml`
- **BOM available:** No
