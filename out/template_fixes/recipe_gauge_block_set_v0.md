# Fix Intelligence: recipe_gauge_block_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_gauge_block_set_v0.yaml`
- **Target item:** `gauge_block_set`
  - File: `kb/items/gauge_block_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_gauge_block_set_v0.yaml`
- **BOM available:** No
