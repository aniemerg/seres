# Fix Intelligence: recipe_ammonium_chloride_v0

## Files

- **Recipe:** `kb/recipes/recipe_ammonium_chloride_v0.yaml`
- **Target item:** `ammonium_chloride`
  - File: `kb/items/ammonium_chloride.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_ammonium_chloride_v0.yaml`
- **BOM available:** No
