# Fix Intelligence: recipe_formed_sheet_metal_parts_v0

## Files

- **Recipe:** `kb/recipes/recipe_formed_sheet_metal_parts_v0.yaml`
- **Target item:** `formed_sheet_metal_parts`
  - File: `kb/items/formed_sheet_metal_parts.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_formed_sheet_metal_parts_v0.yaml`
- **BOM available:** No
