# Fix Intelligence: recipe_drive_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_drive_assembly_v0.yaml`
- **Target item:** `drive_assembly`
  - File: `kb/items/drive_assembly.yaml`
- **BOM:** None
- **Steps:** 5 total
...
**Message:** Step 2 (process 'grinding_and_finishing_v0') requires input 'rough_part' which is not available
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_drive_assembly_v0.yaml`
- **BOM available:** No
