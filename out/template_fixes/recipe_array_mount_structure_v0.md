# Fix Intelligence: recipe_array_mount_structure_v0

## Files

- **Recipe:** `kb/recipes/recipe_array_mount_structure_v0.yaml`
- **Target item:** `array_mount_structure`
  - File: `kb/items/array_mount_structure.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_array_mount_structure_v0.yaml`
- **BOM available:** No
