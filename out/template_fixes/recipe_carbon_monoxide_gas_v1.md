# Fix Intelligence: recipe_carbon_monoxide_gas_v1

## Files

- **Recipe:** `kb/recipes/recipe_carbon_monoxide_gas_v1.yaml`
- **Target item:** `carbon_monoxide_gas`
  - File: `kb/items/carbon_monoxide_gas.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- `recipe_carbon_monoxide_gas_v0` → carbon_monoxide_gas_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_carbon_monoxide_gas_v1.yaml`
- **BOM available:** No
