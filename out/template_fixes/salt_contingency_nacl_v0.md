# Fix Intelligence: salt_contingency_nacl_v0

## Files

- **Recipe:** `kb/recipes/salt_contingency_nacl_v0.yaml`
...
- `salt_contingency_nacl_import_v0` → salt_contingency_nacl (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/salt_contingency_nacl_v0.yaml`
- **BOM available:** No
