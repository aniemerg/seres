# Fix Intelligence: recipe_tracking_control_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_tracking_control_unit_v0.yaml`
- **Target item:** `tracking_control_unit`
  - File: `kb/items/tracking_control_unit.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tracking_control_unit_v0.yaml`
- **BOM available:** No
