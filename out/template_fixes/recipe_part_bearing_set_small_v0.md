# Fix Intelligence: recipe_part_bearing_set_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_part_bearing_set_small_v0.yaml`
- **Target item:** `bearing_set_small`
  - File: `kb/items/bearing_set_small.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_part_bearing_set_small_v0.yaml`
- **BOM available:** No
