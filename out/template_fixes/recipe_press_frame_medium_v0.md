# Fix Intelligence: recipe_press_frame_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_press_frame_medium_v0.yaml`
- **Target item:** `press_frame_medium`
  - File: `kb/items/press_frame_medium.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_press_frame_medium_v0.yaml`
- **BOM available:** No
