# Fix Intelligence: recipe_tube_sealing_torch_v0

## Files

- **Recipe:** `kb/recipes/recipe_tube_sealing_torch_v0.yaml`
- **Target item:** `tube_sealing_torch`
  - File: `kb/items/tube_sealing_torch.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_tube_sealing_torch_v0.yaml`
- **BOM available:** No
