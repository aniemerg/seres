# Fix Intelligence: recipe_refractory_trowel_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_refractory_trowel_set_v0.yaml`
- **Target item:** `refractory_trowel_set`
  - File: `kb/items/refractory_trowel_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_refractory_trowel_set_v0.yaml`
- **BOM available:** No
