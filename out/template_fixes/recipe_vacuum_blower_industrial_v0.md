# Fix Intelligence: recipe_vacuum_blower_industrial_v0

## Files

- **Recipe:** `kb/recipes/recipe_vacuum_blower_industrial_v0.yaml`
- **Target item:** `vacuum_blower_industrial`
  - File: `kb/items/vacuum_blower_industrial.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_vacuum_blower_industrial_v0.yaml`
- **BOM available:** No
