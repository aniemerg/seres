# Fix Intelligence: recipe_burner_or_heater_casting_v0

## Files

- **Recipe:** `kb/recipes/recipe_burner_or_heater_casting_v0.yaml`
- **Target item:** `burner_or_heater_casting`
  - File: `kb/items/burner_or_heater_casting.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_burner_or_heater_casting_v0.yaml`
- **BOM available:** No
