# Fix Intelligence: recipe_magnetic_concentrate_v0

## Files

- **Recipe:** `kb/recipes/recipe_magnetic_concentrate_v0.yaml`
- **Target item:** `magnetic_concentrate`
  - File: `kb/items/magnetic_concentrate.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_magnetic_concentrate_v0.yaml`
- **BOM available:** No
