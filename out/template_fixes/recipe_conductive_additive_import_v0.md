# Fix Intelligence: recipe_conductive_additive_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_conductive_additive_import_v0.yaml`
...
- `recipe_conductive_additive_v0` → conductive_additive (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_conductive_additive_import_v0.yaml`
- **BOM available:** No
