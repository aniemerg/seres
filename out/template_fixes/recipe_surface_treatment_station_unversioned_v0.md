# Fix Intelligence: recipe_surface_treatment_station_unversioned_v0

## Files

- **Recipe:** `kb/recipes/recipe_surface_treatment_station_unversioned_v0.yaml`
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_surface_treatment_station_unversioned_v0.yaml`
- **BOM available:** No
