# Fix Intelligence: recipe_capacitor_bank_power_v0

## Files

- **Recipe:** `kb/recipes/recipe_capacitor_bank_power_v0.yaml`
- **Target item:** `capacitor_bank_power`
  - File: `kb/items/capacitor_bank_power.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 2 (process 'assembly_basic_v0') requires input 'capacitor_bank_filter_v0' which is not available
...
- process_id: assembly_basic_v0
  inputs:
  - item_id: capacitor_bank_filter_v0
    qty: 1.0
    unit: unit
```
...
#### Problem: Item `capacitor_bank_filter_v0` not found
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_capacitor_bank_power_v0.yaml`
- **BOM available:** No
