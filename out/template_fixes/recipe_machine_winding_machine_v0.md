# Fix Intelligence: recipe_machine_winding_machine_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_winding_machine_v0.yaml`
- **Target item:** `winding_machine`
  - File: `kb/items/winding_machine.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_winding_machine_v0.yaml`
- **BOM available:** No
