# Fix Intelligence: recipe_tool_station_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_tool_station_frame_v0.yaml`
- **Target item:** `tool_station_frame`
  - File: `kb/items/tool_station_frame.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tool_station_frame_v0.yaml`
- **BOM available:** No
