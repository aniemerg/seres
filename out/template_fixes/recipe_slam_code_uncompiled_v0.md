# Fix Intelligence: recipe_slam_code_uncompiled_v0

## Files

- **Recipe:** `kb/recipes/recipe_slam_code_uncompiled_v0.yaml`
- **Target item:** `slam_code_uncompiled`
  - File: `kb/items/slam_code_uncompiled.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_slam_code_uncompiled_v0.yaml`
- **BOM available:** No
