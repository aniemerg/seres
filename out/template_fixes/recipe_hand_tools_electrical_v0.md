# Fix Intelligence: recipe_hand_tools_electrical_v0

## Files

- **Recipe:** `kb/recipes/recipe_hand_tools_electrical_v0.yaml`
- **Target item:** `hand_tools_electrical`
  - File: `kb/items/hand_tools_electrical.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hand_tools_electrical_v0.yaml`
- **BOM available:** No
