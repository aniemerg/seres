# Fix Intelligence: recipe_battery_cell_nife_local_v0

## Files

- **Recipe:** `kb/recipes/recipe_battery_cell_nife_local_v0.yaml`
...
- `recipe_battery_cell_nife_v0` → battery_cell_nife (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_battery_cell_nife_local_v0.yaml`
- **BOM available:** No
