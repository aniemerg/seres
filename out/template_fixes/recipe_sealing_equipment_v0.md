# Fix Intelligence: recipe_sealing_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_sealing_equipment_v0.yaml`
- **Target item:** `sealing_equipment`
  - File: `kb/items/sealing_equipment.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_sealing_equipment_v0.yaml`
- **BOM available:** No
