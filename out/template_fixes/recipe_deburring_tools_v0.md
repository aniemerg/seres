# Fix Intelligence: recipe_deburring_tools_v0

## Files

- **Recipe:** `kb/recipes/recipe_deburring_tools_v0.yaml`
- **Target item:** `deburring_tools`
  - File: `kb/items/deburring_tools.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_deburring_tools_v0.yaml`
- **BOM available:** No
