# Fix Intelligence: recipe_operator_cabin_v1

## Files

- **Recipe:** `kb/recipes/recipe_operator_cabin_v1.yaml`
...
- `recipe_operator_cabin_v0` → operator_cabin (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_operator_cabin_v1.yaml`
- **BOM available:** No
