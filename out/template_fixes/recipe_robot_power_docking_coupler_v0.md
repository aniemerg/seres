# Fix Intelligence: recipe_robot_power_docking_coupler_v0

## Files

- **Recipe:** `kb/recipes/recipe_robot_power_docking_coupler_v0.yaml`
- **Target item:** `robot_power_docking_coupler_v0`
  - File: `kb/items/robot_power_docking_coupler_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_robot_power_docking_coupler_v0.yaml`
- **BOM available:** No
