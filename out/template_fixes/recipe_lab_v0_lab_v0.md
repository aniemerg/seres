# Fix Intelligence: recipe_lab_v0_lab_v0

## Files

- **Recipe:** `kb/recipes/recipe_lab_v0_lab_v0.yaml`
- **Target item:** `lab`
  - File: `kb/items/lab.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_lab_v0_lab_v0.yaml`
- **BOM available:** No
