# Fix Intelligence: recipe_power_supply_chassis_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_supply_chassis_basic_v0.yaml`
- **Target item:** `power_supply_chassis_basic`
  - File: `kb/items/power_supply_chassis_basic.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_power_supply_chassis_basic_v0.yaml`
- **BOM available:** No
