# Fix Intelligence: recipe_heating_element_set_high_temp_v0

## Files

- **Recipe:** `kb/recipes/recipe_heating_element_set_high_temp_v0.yaml`
- **Target item:** `heating_element_set_high_temp`
  - File: `kb/items/heating_element_set_high_temp.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_heating_element_set_high_temp_v0.yaml`
- **BOM available:** No
