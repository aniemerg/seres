# Fix Intelligence: recipe_pv_module_imported_v0

## Files

- **Recipe:** `kb/recipes/recipe_pv_module_imported_v0.yaml`
- **Target item:** `pv_module_imported`
  - File: `kb/items/pv_module_imported.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pv_module_imported_v0.yaml`
- **BOM available:** No
