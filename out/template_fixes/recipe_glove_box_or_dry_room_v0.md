# Fix Intelligence: recipe_glove_box_or_dry_room_v0

## Files

- **Recipe:** `kb/recipes/recipe_glove_box_or_dry_room_v0.yaml`
- **Target item:** `glove_box_or_dry_room`
  - File: `kb/items/glove_box_or_dry_room.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_glove_box_or_dry_room_v0.yaml`
- **BOM available:** No
