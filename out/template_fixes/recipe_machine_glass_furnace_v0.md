# Fix Intelligence: recipe_machine_glass_furnace_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_glass_furnace_v0.yaml`
- **Target item:** `glass_furnace_v0`
  - File: `kb/items/glass_furnace_v0.yaml`
- **BOM:** `kb/boms/bom_glass_furnace_v0.yaml` ✓
  - Components: 9
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_machine_glass_furnace_v0.yaml`
