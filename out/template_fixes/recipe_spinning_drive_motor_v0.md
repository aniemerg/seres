# Fix Intelligence: recipe_spinning_drive_motor_v0

## Files

- **Recipe:** `kb/recipes/recipe_spinning_drive_motor_v0.yaml`
- **Target item:** `spinning_drive_motor`
  - File: `kb/items/spinning_drive_motor.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 2 (process 'coil_winding_motor_v0') requires input 'aluminum_wire' which is not available
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_spinning_drive_motor_v0.yaml`
- **BOM available:** No
