# Fix Intelligence: recipe_wire_tensioning_mechanism_v0

## Files

- **Recipe:** `kb/recipes/recipe_wire_tensioning_mechanism_v0.yaml`
- **Target item:** `wire_tensioning_mechanism`
  - File: `kb/items/wire_tensioning_mechanism.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_wire_tensioning_mechanism_v0.yaml`
- **BOM available:** No
