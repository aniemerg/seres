# Fix Intelligence: recipe_ffc_reactor_unit_v0

## Files

- **Recipe:** `kb/recipes/recipe_ffc_reactor_unit_v0.yaml`
- **Target item:** `ffc_reactor_unit_v0`
  - File: `kb/items/ffc_reactor_unit_v0.yaml`
- **BOM:** `kb/boms/bom_ffc_reactor_unit_v0.yaml` ✓
  - Components: 0
- **Steps:** 7 total
...
- **Total errors:** 7
- **Recipe file:** `kb/recipes/recipe_ffc_reactor_unit_v0.yaml`
