# Fix Intelligence: recipe_crusher_frame_medium_v0

## Files

- **Recipe:** `kb/recipes/recipe_crusher_frame_medium_v0.yaml`
- **Target item:** `crusher_frame_medium`
  - File: `kb/items/crusher_frame_medium.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_crusher_frame_medium_v0.yaml`
- **BOM available:** No
