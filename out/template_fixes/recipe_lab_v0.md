# Fix Intelligence: recipe_lab_v0

## Files

- **Recipe:** `kb/recipes/recipe_lab_v0.yaml`
- **Target item:** `lab_v0`
  - File: `kb/items/lab_v0.yaml`
- **BOM:** `kb/boms/bom_lab_v0.yaml` ✓
  - Components: 3
- **Steps:** 5 total
...
- `recipe_lab_v0_lab_v0` → lab (5 steps)
- `recipe_lab_v1` → lab (5 steps)
...
- `relay_electromagnetic_v0` (qty: 1 None)
- `circuit_breaker_thermal_v0` (qty: 1 None)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_lab_v0.yaml`
