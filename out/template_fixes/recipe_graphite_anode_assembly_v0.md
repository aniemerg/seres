# Fix Intelligence: recipe_graphite_anode_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_graphite_anode_assembly_v0.yaml`
- **Target item:** `graphite_anode_assembly_v0`
  - File: `kb/items/graphite_anode_assembly_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_graphite_anode_assembly_v0.yaml`
- **BOM available:** No
