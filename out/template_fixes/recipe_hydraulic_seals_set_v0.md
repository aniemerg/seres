# Fix Intelligence: recipe_hydraulic_seals_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_hydraulic_seals_set_v0.yaml`
- **Target item:** `hydraulic_seals_set`
  - File: `kb/items/hydraulic_seals_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
**Message:** Step 0 (process 'elastomer_molding_basic_v0') requires input 'silicone_rubber' which is not available

**Location:** Step 0
**Process:** `elastomer_molding_basic_v0`
  - File: `kb/processes/elastomer_molding_basic_v0.yaml`
...
- Step 0 produces: `silicone_rubber` (1.0 kg)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_hydraulic_seals_set_v0.yaml`
- **BOM available:** No
