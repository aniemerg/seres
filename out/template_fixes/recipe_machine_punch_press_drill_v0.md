# Fix Intelligence: recipe_machine_punch_press_drill_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_punch_press_drill_v0.yaml`
- **Target item:** `punch_press_drill`
  - File: `kb/items/punch_press_drill.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_machine_punch_press_drill_v0.yaml`
- **BOM available:** No
