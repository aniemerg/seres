# Fix Intelligence: recipe_iron_sulfate_solution_v0

## Files

- **Recipe:** `kb/recipes/recipe_iron_sulfate_solution_v0.yaml`
- **Target item:** `iron_sulfate_solution`
  - File: `kb/items/iron_sulfate_solution.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_iron_sulfate_solution_v0.yaml`
- **BOM available:** No
