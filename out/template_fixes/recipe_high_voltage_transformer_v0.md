# Fix Intelligence: recipe_high_voltage_transformer_v0

## Files

- **Recipe:** `kb/recipes/recipe_high_voltage_transformer_v0.yaml`
- **Target item:** `high_voltage_transformer`
  - File: `kb/items/high_voltage_transformer.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_high_voltage_transformer_v0.yaml`
- **BOM available:** No
