# Fix Intelligence: recipe_heating_plate_or_induction_heater_v0

## Files

- **Recipe:** `kb/recipes/recipe_heating_plate_or_induction_heater_v0.yaml`
- **Target item:** `heating_plate_or_induction_heater`
  - File: `kb/items/heating_plate_or_induction_heater.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_heating_plate_or_induction_heater_v0.yaml`
- **BOM available:** No
