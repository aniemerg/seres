# Fix Intelligence: recipe_pcb_etching_tank_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_pcb_etching_tank_set_v0.yaml`
- **Target item:** `pcb_etching_tank_set`
  - File: `kb/items/pcb_etching_tank_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pcb_etching_tank_set_v0.yaml`
- **BOM available:** No
