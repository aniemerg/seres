# Fix Intelligence: recipe_xy_positioning_table_v0

## Files

- **Recipe:** `kb/recipes/recipe_xy_positioning_table_v0.yaml`
- **Target item:** `xy_positioning_table_v0`
  - File: `kb/items/xy_positioning_table_v0.yaml`
- **BOM:** None
- **Steps:** 2 total
...
- **Total errors:** 2
- **Recipe file:** `kb/recipes/recipe_xy_positioning_table_v0.yaml`
- **BOM available:** No
