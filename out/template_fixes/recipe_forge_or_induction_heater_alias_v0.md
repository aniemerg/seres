# Fix Intelligence: recipe_forge_or_induction_heater_alias_v0

## Files

- **Recipe:** `kb/recipes/recipe_forge_or_induction_heater_alias_v0.yaml`
- **Target item:** `forge_or_induction_heater`
  - File: `kb/items/forge_or_induction_heater.yaml`
- **BOM:** `kb/boms/bom_forge_or_induction_heater.yaml` ✓
  - Components: 4
- **Steps:** 5 total
...
- `recipe_forge_or_induction_heater_v0_seed_v0` → forge_or_induction_heater_v0 (5 steps)
...
- `motor_assembly` (qty: 1.0 None)
- `shaft_and_bearing_set` (qty: 1.0 None)
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_forge_or_induction_heater_alias_v0.yaml`
