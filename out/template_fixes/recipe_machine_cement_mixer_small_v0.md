# Fix Intelligence: recipe_machine_cement_mixer_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_cement_mixer_small_v0.yaml`
- **Target item:** `cement_mixer_small`
  - File: `kb/items/cement_mixer_small.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_cement_mixer_small_v0` → cement_mixer_small (4 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_cement_mixer_small_v0.yaml`
- **BOM available:** No
