# Fix Intelligence: recipe_machine_vacuum_pump_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_vacuum_pump_small_v0.yaml`
- **Target item:** `vacuum_pump_small`
  - File: `kb/items/vacuum_pump_small.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_machine_vacuum_pump_small_v0.yaml`
- **BOM available:** No
