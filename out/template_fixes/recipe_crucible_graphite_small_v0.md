# Fix Intelligence: recipe_crucible_graphite_small_v0

## Files

- **Recipe:** `kb/recipes/recipe_crucible_graphite_small_v0.yaml`
- **Target item:** `crucible_graphite_small`
  - File: `kb/items/crucible_graphite_small.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_crucible_graphite_small_v0.yaml`
- **BOM available:** No
