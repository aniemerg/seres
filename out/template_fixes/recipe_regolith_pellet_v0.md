# Fix Intelligence: recipe_regolith_pellet_v0

## Files

- **Recipe:** `kb/recipes/recipe_regolith_pellet_v0.yaml`
- **Target item:** `regolith_pellet_v0`
  - File: `kb/items/regolith_pellet_v0.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_regolith_pellet_v0.yaml`
- **BOM available:** No
