# Fix Intelligence: recipe_extruder_head_basic_v0

## Files

- **Recipe:** `kb/recipes/recipe_extruder_head_basic_v0.yaml`
- **Target item:** `extruder_head_basic`
  - File: `kb/items/extruder_head_basic.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_extruder_head_basic_v0.yaml`
- **BOM available:** No
