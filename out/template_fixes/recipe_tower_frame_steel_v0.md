# Fix Intelligence: recipe_tower_frame_steel_v0

## Files

- **Recipe:** `kb/recipes/recipe_tower_frame_steel_v0.yaml`
- **Target item:** `tower_frame_steel`
  - File: `kb/items/tower_frame_steel.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_tower_frame_steel_v0.yaml`
- **BOM available:** No
