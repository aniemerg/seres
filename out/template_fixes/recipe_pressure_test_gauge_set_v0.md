# Fix Intelligence: recipe_pressure_test_gauge_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_pressure_test_gauge_set_v0.yaml`
- **Target item:** `pressure_test_gauge_set`
  - File: `kb/items/pressure_test_gauge_set.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_pressure_test_gauge_set_v0.yaml`
- **BOM available:** No
