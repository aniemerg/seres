# Fix Intelligence: recipe_reactor_vessel_mre_v0

## Files

- **Recipe:** `kb/recipes/recipe_reactor_vessel_mre_v0.yaml`
- **Target item:** `reactor_vessel_mre`
  - File: `kb/items/reactor_vessel_mre.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_reactor_vessel_mre_v0.yaml`
- **BOM available:** No
