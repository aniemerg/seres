# Fix Intelligence: recipe_winding_machine_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_winding_machine_frame_v0.yaml`
- **Target item:** `winding_machine_frame`
  - File: `kb/items/winding_machine_frame.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_winding_machine_frame_v0.yaml`
- **BOM available:** No
