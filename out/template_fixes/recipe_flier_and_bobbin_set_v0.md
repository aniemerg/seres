# Fix Intelligence: recipe_flier_and_bobbin_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_flier_and_bobbin_set_v0.yaml`
- **Target item:** `flier_and_bobbin_set`
  - File: `kb/items/flier_and_bobbin_set.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_flier_and_bobbin_set_v0.yaml`
- **BOM available:** No
