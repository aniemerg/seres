# Fix Intelligence: recipe_battery_cell_v0

## Files

- **Recipe:** `kb/recipes/recipe_battery_cell_v0.yaml`
...
- `recipe_battery_cell_import_v0` → battery_cell (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_battery_cell_v0.yaml`
- **BOM available:** No
