# Fix Intelligence: recipe_machine_quench_tank_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_quench_tank_v0.yaml`
- **Target item:** `quench_tank`
  - File: `kb/items/quench_tank.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_quench_tank_vessel_v0` → quench_tank_vessel (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_machine_quench_tank_v0.yaml`
- **BOM available:** No
