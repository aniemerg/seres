# Fix Intelligence: recipe_heating_furnace_module_v0

## Files

- **Recipe:** `kb/recipes/recipe_heating_furnace_module_v0.yaml`
- **Target item:** `heating_furnace_module`
  - File: `kb/items/heating_furnace_module.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heating_furnace_module_v0.yaml`
- **BOM available:** No
