# Fix Intelligence: recipe_rover_chassis_structure_v0

## Files

- **Recipe:** `kb/recipes/recipe_rover_chassis_structure_v0.yaml`
- **Target item:** `rover_chassis_structure_v0`
  - File: `kb/items/rover_chassis_structure_v0.yaml`
- **BOM:** None
- **Steps:** 5 total
...
- **Total errors:** 5
- **Recipe file:** `kb/recipes/recipe_rover_chassis_structure_v0.yaml`
- **BOM available:** No
