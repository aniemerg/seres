# Fix Intelligence: recipe_cathode_basket_assembly_v0

## Files

- **Recipe:** `kb/recipes/recipe_cathode_basket_assembly_v0.yaml`
- **Target item:** `cathode_basket_assembly_v0`
  - File: `kb/items/cathode_basket_assembly_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_cathode_basket_assembly_v0.yaml`
- **BOM available:** No
