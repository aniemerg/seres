# Fix Intelligence: recipe_invar_low_expansion_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_invar_low_expansion_import_v0.yaml`
...
- `recipe_invar_low_expansion_v0` → invar_low_expansion_v0 (2 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_invar_low_expansion_import_v0.yaml`
- **BOM available:** No
