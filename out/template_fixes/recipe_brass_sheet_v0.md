# Fix Intelligence: recipe_brass_sheet_v0

## Files

- **Recipe:** `kb/recipes/recipe_brass_sheet_v0.yaml`
- **Target item:** `brass_sheet`
  - File: `kb/items/brass_sheet.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_brass_sheet_v0.yaml`
- **BOM available:** No
