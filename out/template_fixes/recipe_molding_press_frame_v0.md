# Fix Intelligence: recipe_molding_press_frame_v0

## Files

- **Recipe:** `kb/recipes/recipe_molding_press_frame_v0.yaml`
- **Target item:** `molding_press_frame`
  - File: `kb/items/molding_press_frame.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_molding_press_frame_v0.yaml`
- **BOM available:** No
