# Fix Intelligence: recipe_gasket_sheet_v0

## Files

- **Recipe:** `kb/recipes/recipe_gasket_sheet_v0.yaml`
...
- `recipe_gasket_sheet_import_v0` → gasket_sheet (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_gasket_sheet_v0.yaml`
- **BOM available:** No
