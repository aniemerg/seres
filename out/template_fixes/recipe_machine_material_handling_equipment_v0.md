# Fix Intelligence: recipe_machine_material_handling_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_machine_material_handling_equipment_v0.yaml`
- **Target item:** `material_handling_equipment`
  - File: `kb/items/material_handling_equipment.yaml`
- **BOM:** None
- **Steps:** 6 total
...
- **Total errors:** 6
- **Recipe file:** `kb/recipes/recipe_machine_material_handling_equipment_v0.yaml`
- **BOM available:** No
