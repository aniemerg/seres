# Fix Intelligence: recipe_lathe_headstock_simple_v0

## Files

- **Recipe:** `kb/recipes/recipe_lathe_headstock_simple_v0.yaml`
...
- `recipe_lathe_headstock_simple_v5` → lathe_headstock_simple (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_lathe_headstock_simple_v0.yaml`
- **BOM available:** No
