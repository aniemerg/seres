# Fix Intelligence: recipe_brazed_assembly_v2

## Files

- **Recipe:** `kb/recipes/recipe_brazed_assembly_v2.yaml`
...
- `recipe_brazed_assembly_v0` → brazed_assembly (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_brazed_assembly_v2.yaml`
- **BOM available:** No
