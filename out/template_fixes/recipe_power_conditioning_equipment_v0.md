# Fix Intelligence: recipe_power_conditioning_equipment_v0

## Files

- **Recipe:** `kb/recipes/recipe_power_conditioning_equipment_v0.yaml`
- **Target item:** `power_conditioning_equipment`
  - File: `kb/items/power_conditioning_equipment.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_power_conditioning_equipment_v0.yaml`
- **BOM available:** No
