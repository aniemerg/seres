# Fix Intelligence: recipe_pellet_press_v0

## Files

- **Recipe:** `kb/recipes/recipe_pellet_press_v0.yaml`
...
- `recipe_pellet_press_v1` → pellet_press (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_pellet_press_v0.yaml`
