# Fix Intelligence: recipe_fittings_and_valves_v0

## Files

- **Recipe:** `kb/recipes/recipe_fittings_and_valves_v0.yaml`
...
- `recipe_fittings_and_valves_import_v0` → fittings_and_valves (5 steps)
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_fittings_and_valves_v0.yaml`
- **BOM available:** No
