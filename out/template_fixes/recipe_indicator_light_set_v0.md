# Fix Intelligence: recipe_indicator_light_set_v0

## Files

- **Recipe:** `kb/recipes/recipe_indicator_light_set_v0.yaml`
- **Target item:** `indicator_light_set`
  - File: `kb/items/indicator_light_set.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_indicator_light_set_v0.yaml`
- **BOM available:** No
