# Fix Intelligence: recipe_heat_pipe_solar_receiver_v0

## Files

- **Recipe:** `kb/recipes/recipe_heat_pipe_solar_receiver_v0.yaml`
- **Target item:** `heat_pipe_solar_receiver_v0`
  - File: `kb/items/heat_pipe_solar_receiver_v0.yaml`
- **BOM:** None
- **Steps:** 4 total
...
- **Total errors:** 4
- **Recipe file:** `kb/recipes/recipe_heat_pipe_solar_receiver_v0.yaml`
- **BOM available:** No
