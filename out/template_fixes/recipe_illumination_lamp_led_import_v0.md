# Fix Intelligence: recipe_illumination_lamp_led_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_illumination_lamp_led_import_v0.yaml`
...
- `recipe_illumination_lamp_led_v0` → illumination_lamp_led (2 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_illumination_lamp_led_import_v0.yaml`
- **BOM available:** No
