# Fix Intelligence: recipe_collection_hopper_drum_v0

## Files

- **Recipe:** `kb/recipes/recipe_collection_hopper_drum_v0.yaml`
- **Target item:** `collection_hopper_drum`
  - File: `kb/items/collection_hopper_drum.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_collection_hopper_drum_v0.yaml`
- **BOM available:** No
