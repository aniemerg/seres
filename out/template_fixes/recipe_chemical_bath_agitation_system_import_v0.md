# Fix Intelligence: recipe_chemical_bath_agitation_system_import_v0

## Files

- **Recipe:** `kb/recipes/recipe_chemical_bath_agitation_system_import_v0.yaml`
- **Target item:** `chemical_bath_agitation_system`
  - File: `kb/items/chemical_bath_agitation_system.yaml`
- **BOM:** None
- **Steps:** 3 total
...
- `recipe_chemical_bath_agitation_system_v0` → chemical_bath_agitation_system (3 steps)
- `recipe_chemical_bath_agitation_system_v1` → chemical_bath_agitation_system (3 steps)
...
- **Total errors:** 3
- **Recipe file:** `kb/recipes/recipe_chemical_bath_agitation_system_import_v0.yaml`
- **BOM available:** No
