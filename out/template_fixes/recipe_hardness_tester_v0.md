# Fix Intelligence: recipe_hardness_tester_v0

## Files

- **Recipe:** `kb/recipes/recipe_hardness_tester_v0.yaml`
...
- `recipe_hardness_tester_v0_v0` → hardness_tester_v0 (1 steps)
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_hardness_tester_v0.yaml`
