# Fix Intelligence: recipe_sodium_hydroxide_v0

## Files

- **Recipe:** `kb/recipes/recipe_sodium_hydroxide_v0.yaml`
- **Target item:** `sodium_hydroxide`
  - File: `kb/items/sodium_hydroxide.yaml`
- **BOM:** None
- **Steps:** 1 total
...
- **Total errors:** 1
- **Recipe file:** `kb/recipes/recipe_sodium_hydroxide_v0.yaml`
- **BOM available:** No
