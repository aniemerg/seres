# Induction Forge v0 Runbook

Goal: Build `induction_forge_v0` using in-situ resources where possible.
...
- cmd: sim.use
  args:
    sim-id: induction_forge_v0_runbook
- cmd: sim.reset
  args:
    sim-id: induction_forge_v0_runbook
- cmd: sim.note
  args:
    style: milestone
    message: "Simulation reset. Starting induction_forge_v0 runbook."
```
...
- cmd: sim.run-recipe
  args:
    recipe: recipe_induction_forge_v0_isru
    quantity: 1
- cmd: sim.advance-time
  args:
    hours: 50
