...
| --- | --- | --- |
| anvil_or_die_set | [runbook](anvil_or_die_set_runbook.md) | 35.7% (ISRU steel from regolith via MRE → rolling; fixed rolling_mill_or_brake + furnace_basic imports) |
...
| furnace | [runbook](furnace_runbook.md) | 65.8% (local steel plate + regolith fasteners + local heating elements; insulation/wiring imported; fixed rolling_mill_or_brake import) |
...
| heat_treatment_furnace | [runbook](heat_treatment_furnace_runbook.md) | 54.1% (local quench_rack_and_baskets + furnace_shell_insulated; imported silica + insulation blanket) |
