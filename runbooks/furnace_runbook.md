...
Commentary: Import all components and assembly equipment to validate the recipe.
...
- cmd: sim.note
  args:
    style: milestone
    message: "Assemble furnace from imported parts."
- cmd: sim.run-recipe
  args:
...
- cmd: sim.note
  args:
    style: success
    message: "Baseline furnace complete."
```

## Stage 2: Local components (ISRU)

Commentary: Produce steel plate and large fasteners from regolith; keep insulation, heating elements, and wiring imported for now.
...
- cmd: sim.note
  args:
    style: milestone
    message: "Stage 2: Local steel plate + fasteners from regolith"
- cmd: sim.import
  args:
    item: labor_bot_general_v0
    quantity: 3
...
- cmd: sim.note
  args:
    style: success
    message: "Stage 2 complete: furnace with local steel plate + fasteners."
```

## Stage 3: Local heating elements (partial ISRU)

Commentary: Produce heating elements from ISRU metal feedstock and ceramic powder; keep coil insulation imported.
...
- cmd: sim.note
  args:
    style: milestone
    message: "Stage 3: Local heating element feedstock"
- cmd: sim.import
  args:
    item: labor_bot_general_v0
    quantity: 3
...
- cmd: sim.note
  args:
    style: success
    message: "Stage 3 complete: furnace with local heating elements."
```
