...
- cmd: sim.note
  args:
    style: milestone
    message: "Assemble welding_tools_set from imported parts."
- cmd: sim.run-recipe
  args:
...
- cmd: sim.note
  args:
    style: success
    message: "Baseline welding_tools_set complete."
```

## Stage 2: ISRU steel chain (regolith to plate, fasteners, machined parts)
