...
- cmd: sim.note
  args:
    style: milestone
    message: "Assemble heating_furnace from imported parts."
- cmd: sim.run-recipe
  args:
...
- cmd: sim.note
  args:
    style: success
    message: "Baseline heating_furnace complete."
```

## Stage 2: ISRU steel plate (regolith iron + carbon)

Commentary: Produce steel_plate_or_sheet locally for the furnace shell. Other components remain imported.
...
- cmd: sim.note
  args:
    style: milestone
    message: "Stage 2: Local steel plate for furnace shell."
- cmd: sim.import
  args:
    item: labor_bot_general_v0
    quantity: 2
