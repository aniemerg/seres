# Robot Bootstrap Runbook (Materials + Motor)

Foundational runbook for robot builds: import basic equipment, mine regolith types, and build the first local motor.
