...
- cmd: sim.note
  args:
    style: milestone
    message: "Assemble heat_treatment_furnace from imported parts."
- cmd: sim.run-recipe
  args:
...
- cmd: sim.note
  args:
    style: success
    message: "Baseline heat_treatment_furnace complete."
```

## Stage 2: ISRU quench rack (regolith metal)

Commentary: Produce quench_rack_and_baskets from regolith_metal_crude, keep other components imported.
...
- cmd: sim.note
  args:
    style: milestone
    message: "Stage 2: ISRU quench rack from regolith metal."
- cmd: sim.import
  args:
    item: labor_bot_general_v0
    quantity: 2
