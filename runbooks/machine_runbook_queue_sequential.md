...
| casting_mold_set | [runbook](casting_mold_set_runbook.md) | 43.1% (220 kg regolith steel/metal, 290 kg imported) |
| ceramic_press_or_mold_set | [runbook](ceramic_press_or_mold_set_runbook.md) | TBD |
| chemical_reactor_basic | [runbook](chemical_reactor_basic_runbook.md) | 32.9% (ISRU steel plate from regolith-derived iron; sensors, piping, insulation imported) |
| cnc_mill | [runbook](cnc_mill_runbook.md) | 0% (runbook completes; local components produced but not consumed by final assembly due to item_id mismatch: recipe needs structural_steel_frame but produces structural_frame_steel) |
...
| furnace | [runbook](furnace_runbook.md) | 65.8% (local steel plate, fasteners, and heating elements from regolith) |
| furnace_basic | [runbook](furnace_basic_runbook.md) | 38.0% (runbook complete; item provenance) |
| furnace_high_temp | [runbook](furnace_high_temp_runbook.md) | 82.0% |
...
| hot_press_v0 | [runbook](hot_press_v0_runbook.md) | 86.0% (runbook complete; item provenance) |
...
| hydraulic_press | [runbook](hydraulic_press_runbook.md) | 40.8% |
...
| lathe_engine_v0 | [runbook](lathe_engine_v0_runbook.md) | 15.4% (runbook complete; item provenance) |
| lifting_equipment | [runbook](lifting_equipment_runbook.md) | 75.9% (ISRU structural frame and fasteners from regolith steel; motors, gears, bearings, electronics imported) |
| measurement_equipment | [runbook](measurement_equipment_runbook.md) | 2.5% (1.43 kg regolith-derived, 55.57 kg imported precision components) |
| metal_shear_or_saw | [runbook](metal_shear_or_saw_runbook.md) | 20.5% (ISRU steel beam from regolith metal; motor and fasteners imported) |
...
| molding_press_basic | [runbook](molding_press_basic_runbook.md) | 40.9% (ISRU steel_stock for frame and fasteners from regolith; platen set imported due to provenance underflow) |
| mre_reactor_v0 | [runbook](mre_reactor_v0_runbook.md) | TBD |
| plate_rolling_mill | [runbook](plate_rolling_mill_runbook.md) | ISRU 35.8% |
| powder_mixer | [runbook](powder_mixer_runbook.md) | 91.3% |
...
| precision_lathe | [runbook](precision_lathe_runbook.md) | 41.5% (ISRU regolith metal, steel stock, fasteners, bearings; imported motors, electronics, precision tooling) |
...
| press_brake | [runbook](press_brake_runbook.md) | 88.1% (local steel stock, filler wire, machined parts, fasteners, and hydraulic system from regolith) |
| pressing_mold_set | [runbook](pressing_mold_set_runbook.md) | TBD |
| pyrolysis_chamber_v0 | [runbook](pyrolysis_chamber_v0_runbook.md) | 0% (runbook completes; builds 2 units - baseline with imported fasteners and ISRU with local fasteners, but provenance tracking shows 0% for aggregate) |
| quench_tank | [runbook](quench_tank_runbook.md) | 79.5% (runbook complete; item provenance) |
...
| rock_crusher_basic | [runbook](rock_crusher_basic_runbook.md) | 80.0% (404 kg regolith steel plate, 101 kg imported components) |
| rolling_mill_v0 | [runbook](rolling_mill_v0_runbook.md) | TBD |
| saw_or_cutting_tool | [runbook](saw_or_cutting_tool_runbook.md) | TBD |
| screening_equipment | [runbook](screening_equipment_runbook.md) | 82.4% (runbook complete; item provenance) |
| sintering_furnace_v0 | [runbook](sintering_furnace_v0_runbook.md) | TBD |
| soldering_station | [runbook](soldering_station_runbook.md) | KB issue: assembled_equipment item has mass=50kg but recipe only produces 4.5kg from inputs (provenance underflow error) |
| stamping_press_basic | [runbook](stamping_press_basic_runbook.md) | 0% (per-item provenance shows 1 kg total mass) |
| surface_grinder | [runbook](surface_grinder_runbook.md) | 3.9% (runbook completes; machine_base_large, grinding_spindle_assembly, table_drive_assembly, and magnetic_chuck produced from regolith metal) |
| surface_treatment_station | [runbook](surface_treatment_station_runbook.md) | 80.5% (211.68 kg regolith metal and steel, 51.32 kg imported) |
| test_bench_electrical | [runbook](test_bench_electrical_runbook.md) | 90.3% (runbook complete; item provenance) |
| vibrating_screen_v0 | [runbook](vibrating_screen_v0_runbook.md) | TBD |
| welding_consumables | [runbook](welding_consumables_runbook.md) | 80.8% (local aluminum wire, steel welding rods, and storage enclosure from regolith) |
| welding_power_supply_v0 | [runbook](welding_power_supply_v0_runbook.md) | TBD |
| welding_tools_set | [runbook](welding_tools_set_runbook.md) | 93.3% (ISRU steel plate, fasteners, and machined parts from regolith metal; only textile_fabric imported) |
