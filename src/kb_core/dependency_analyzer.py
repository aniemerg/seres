...
Migrated from kbtool/circular_dependency_fixer.py to src/kb_core/dependency_analyzer.py
"""
...
class CircularDependencyAnalyzer:
    """Identifies and analyzes circular dependencies in the knowledge base."""
    ...
    def _get_loop_id(loop: List[str]) -> str:
        ...
        normalized = CircularDependencyAnalyzer._normalize_loop(loop)
...
def main():
    ...
    if args.fix:
        ...
        modified = analyzer.auto_fix_recipes(dry_run=False)
